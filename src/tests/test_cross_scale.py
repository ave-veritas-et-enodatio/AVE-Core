...
from ave.solvers.coupled_resonator import (
    nuclear_mass, ionization_energy, atom_port_impedance,
    molecular_bond_distance, molecular_bond_energy,
    K_COUPLING, Z_RESONANCE_MEV, _RY_EV, _A0, _PROJECTION,
)
...
print("\n--- Level 1: NUCLEAR ---")
nuc = [('He-4',2,4,3727.379),('C-12',6,12,11174.863),
       ('Fe-56',26,56,52089.837)]
...
CODATA = {1:13.598, 2:24.587, 3:5.392, 4:9.323,
          5:8.298, 6:11.260, 7:14.534, 8:13.618,
          9:17.422, 10:21.565}
names = {1:'H', 2:'He', 3:'Li', 4:'Be', 5:'B',
