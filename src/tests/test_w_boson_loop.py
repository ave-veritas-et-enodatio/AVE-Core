...
class TestGradedSolverStructure:
    ...
    def test_depth1_matches_hard_saturation(self) -> None:
    ...
    def test_depth1_uniform_matches_standard(self) -> None:
    ...
    def test_matrix_shape_grows_correctly(self) -> None:
    ...
    def test_default_profile_is_axiom4_envelope(self) -> None:
    ...
    def test_wrong_profile_length_raises(self) -> None:
...
class TestGradedSolverPhysics:
    ...
    def test_s11_at_shell1_hard_is_negative(self) -> None:
    ...
    def test_harder_boundary_gives_larger_mismatch_loss(self) -> None:
    ...
    def test_depth1_s11_numerical_value(self) -> None:
...
class TestSelfConsistentCorrection:
    ...
    def test_sc_mw_greater_than_d1_mw(self) -> None:
    ...
    def test_sc_mw_within_0p25_percent_of_pdg(self) -> None:
    ...
    def test_sc_mw_closer_to_pdg_than_d1(self) -> None:
    ...
    def test_delta_y_origin_is_positive_and_small(self) -> None:
    ...
    def test_s11_sc_larger_than_s11_d1(self) -> None:
    ...
    def test_tree_level_value(self) -> None:
...
class TestModuleConstants:
    ...
    def test_module_mw_equals_sc_result(self) -> None:
    ...
    def test_module_mw_not_equal_to_d1(self) -> None:
    ...
    def test_mz_pdg_deviation_within_0p3pct(self) -> None:
    ...
    def test_mw_mz_ratio(self) -> None:
    ...
    def test_tree_level_independent_of_sc_loop(self) -> None:
