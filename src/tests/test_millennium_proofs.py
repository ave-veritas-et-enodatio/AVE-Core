...
class TestYangMillsHamiltonian:
    ...
    def test_bounded_above_per_cell(self) -> None:
        from ave.axioms.yang_mills import lattice_hamiltonian_properties
    ...
    def test_vacuum_energy_zero(self) -> None:
    ...
    def test_cell_energy_positive_definite(self) -> None:
        from ave.axioms.yang_mills import lattice_cell_energy
...
class TestYangMillsSpectralGap:
    ...
    def test_gap_equals_electron_mass(self) -> None:
        from ave.axioms.yang_mills import spectral_gap_theorem
    ...
    def test_bogomolnyi_bounds_satisfied(self) -> None:
        from ave.axioms.yang_mills import spectral_gap_theorem
    ...
    def test_gauge_rank_formula(self) -> None:
    ...
    def test_confinement_radius_decreases_with_crossing(self) -> None:
...
class TestYangMillsInfiniteVolume:
    ...
    def test_max_spread_below_threshold(self) -> None:
        from ave.axioms.yang_mills import defect_energy_vs_volume
...
class TestOsterwalderSchrader:
    ...
    def test_os4_symmetry(self, os_result: dict) -> None:
        assert os_result["OS4_symmetry"][
            "satisfied"
        ], "OS4 (symmetry) must be satisfied: vacuum translational invariance"

    def test_os4_fermion_antisymmetry(self, os_result: dict) -> None:
    ...
    def test_full_mass_gap_proof_flag(self) -> None:
...
class TestNSLatticeRegularization:
    ...
    def test_laplacian_norm_formula(self) -> None:
        from ave.axioms.navier_stokes import lattice_laplacian_operator_norm
    ...
    def test_laplacian_1d_boundary_nodes(self) -> None:
...
class TestNSVelocityBound:
    ...
    def test_enstrophy_finite(self) -> None:
...
class TestNSGlobalExistence:
    ...
    def test_global_existence_proven(self) -> None:
        from ave.axioms.navier_stokes import lattice_ns_global_existence
...
class TestNSSobolevBound:
    ...
    def test_h1_norm_zero_for_zero_field(self) -> None:
        from ave.axioms.navier_stokes import sobolev_h1_norm
    ...
    def test_uniform_sobolev_bound(self) -> None:
    ...
    def test_h1_total_bound_holds_for_all_N(self) -> None:
        from ave.axioms.navier_stokes import sobolev_bound_theorem
    ...
    def test_ns_smoothness_proven_flag(self) -> None:
...
class TestRiemannSpectralBoundary:
    ...
    def test_functional_equation_reciprocity(self) -> None:
    ...
    def test_zero_free_region_physical_establishment(self) -> None:
    ...
    def test_power_diverges_below_critical(self) -> None:
        from ave.axioms.spectral_gap import zero_free_region_equivalence
    ...
    def test_power_converges_above_critical(self) -> None:
        from ave.axioms.spectral_gap import zero_free_region_equivalence
...
class TestFormalProofOrchestration:
    ...
    def test_clay_gaps_not_empty(self, summary: dict) -> None:
    ...
    def test_all_os_in_ym_summary(self, summary: dict) -> None:
    ...
    def test_full_millennium_includes_formal(self) -> None:
