...
class TestEpsilonEff:
    ...
    def test_zero_strain_recovers_maxwell(self) -> None:
    ...
    def test_rupture_raises(self) -> None:
...
class TestImpedanceAtStrain:
    ...
    def test_zero_strain_is_z0(self) -> None:
        """At V = 0, Z_eff = Z₀."""
        assert impedance_at_strain(0.0) == pytest.approx(Z_0, rel=1e-12)

    def test_rises_with_strain(self) -> None:
...
class TestEnergyDensityNonlinear:
    ...
    def test_zero_field_is_zero(self) -> None:
        """No field → no energy."""
        assert energy_density_nonlinear(0.0) == pytest.approx(0.0, abs=1e-30)

    def test_small_field_is_linear(self) -> None:
    ...
    def test_large_field_exceeds_linear(self) -> None:
