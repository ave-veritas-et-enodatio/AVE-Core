...
def test_intensity_bounded():
    ...
    res = solver.resolve_focal_intensity(
        initial_power=initial_power, numerical_aperture=NA, z_start=0.1, z_end=1e-15, num_steps=1000
    )
...
def test_caustic_waist():
    ...
    res = solver.resolve_focal_intensity(
        initial_power=initial_power, numerical_aperture=NA, z_start=0.01, z_end=1e-20, num_steps=500
    )
