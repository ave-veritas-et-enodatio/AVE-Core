...
class TestImpedance:
    ...
    def test_high_epsilon_lowers_impedance(self) -> None:
        """Higher ε (more compliance) → lower Z."""
        Z_high_eps = impedance(MU_0, 10 * EPSILON_0)
        assert Z_high_eps < Z_0

    def test_high_mu_raises_impedance(self) -> None:
...
class TestSaturationFactor:
    ...
    def test_arbitrary_yield_limit(self) -> None:
...
class TestReflectionCoefficient:
    ...
    def test_open_circuit_is_plus_one(self) -> None:
        """Z₂ >> Z₁ → Γ → +1."""
        assert float(reflection_coefficient(0.01, 1e12)) == pytest.approx(1.0, rel=1e-6)

    def test_moho_reflection(self) -> None:
    ...
    def test_default_Z2_is_Z0(self) -> None:
...
class TestCrossScaleIdentity:
    ...
    def test_epsilon_eff_matches_saturation_module(self) -> None:
    ...
    def test_reflection_matches_saturation_module(self) -> None:
    ...
    def test_impedance_at_strain_matches(self) -> None:
    ...
    def test_local_wave_speed_matches(self) -> None:
    ...
    def test_seismic_uses_universal_gamma(self) -> None:
