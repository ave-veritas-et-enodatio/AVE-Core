...
class TestDipoleField:
    ...
    def test_field_at_surface(self) -> None:
    ...
    def test_field_falls_as_r3(self) -> None:
        """Field ∝ 1/r³."""
    ...
    def test_polar_stronger_than_equatorial(self) -> None:
    ...
    def test_jupiter_strongest(self) -> None:
...
class TestMagneticPressure:
    ...
    def test_pressure_scales_as_B2(self) -> None:
...
class TestMagnetopause:
    ...
    def test_all_standoffs_positive(self) -> None:
...
class TestUranusAsymmetry:
    ...
    def test_uranus_is_asymmetric(self) -> None:
    ...
    def test_standoff_varies_with_longitude(self) -> None:
...
class TestComparative:
    ...
    def test_table_has_all_planets(self) -> None:
    ...
    def test_uranus_flagged_asymmetric(self) -> None:
        t = comparative_magnetosphere_table()
        uranus = [r for r in t if r["name"] == "Uranus"][0]
        assert uranus["symmetry"] == "asymmetric"

    def test_saturn_flagged_symmetric(self) -> None:
        t = comparative_magnetosphere_table()
