...
``src/tests/kb/fixtures/mini_index/`` and assert exact, stable values against
it. The fixture was generated by running the real
...
class TestCli(unittest.TestCase):
    ...
    def _run(self, *args: str, expect_exit: int = 0) -> subprocess.CompletedProcess:
        ...
        proc = subprocess.run(
            [sys.executable, "-m", "ave.kb", *args, "--index-dir", str(FIXTURE_DIR)],
            cwd=REPO_ROOT,
            env=env,
            capture_output=True,
            text=True,
