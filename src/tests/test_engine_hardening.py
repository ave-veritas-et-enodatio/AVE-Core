...
class TestPMLBoundaries:
    ...
    def test_pml_engine_creates(self) -> None:
    ...
    def test_pml_monotonic_energy_decay(self) -> None:
    ...
    def test_pml_vs_mur_stability(self) -> None:
    ...
    def test_pml_sigma_profile_shape(self) -> None:
...
class TestLBM3D:
    ...
    def test_lbm_body_force_drives_flow(self) -> None:
    ...
    def test_lbm_force_direction(self) -> None:
    ...
    def test_lbm_mass_conservation(self) -> None:
    ...
    def test_lbm_momentum_extraction(self) -> None:
    ...
    def test_lbm_bounce_back_walls(self) -> None:
...
class TestSpatialMaterials:
    ...
    def test_default_vacuum(self) -> None:
    ...
    def test_material_assignment(self) -> None:
    ...
    def test_wave_slows_in_dielectric_linear(self) -> None:
    ...
    def test_total_energy_with_material(self) -> None:
...
class TestForceExtraction:
    ...
    def test_energy_density_returns_3d(self) -> None:
    ...
    def test_energy_density_nonzero_only_at_field(self) -> None:
    ...
    def test_ponderomotive_force_shape(self) -> None:
    ...
    def test_force_at_gradient(self) -> None:
...
class TestGravityModule:
    ...
    def test_schwarzschild_radius_earth(self) -> None:
    ...
    def test_refractive_index_positive(self) -> None:
    ...
    def test_impedance_invariant(self) -> None:
    ...
    def test_gravitational_potential_negative(self) -> None:
...
class TestCoupledEMCFD:
    ...
    def test_fdtd_to_lbm_coupling(self) -> None:
