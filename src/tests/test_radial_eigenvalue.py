...
class TestTopologicalBindingLimits:
    ...
    def test_helium_cavity_limit(self) -> None:
    ...
    def test_light_element_carbon_baseline(self) -> None:
    ...
    def test_heavy_element_mirrored_ge(self) -> None:
    ...
    def test_z_net_origin(self) -> None:
