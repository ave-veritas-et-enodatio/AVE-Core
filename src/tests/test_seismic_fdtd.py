...
class TestSeismicFDTDBridge:
    ...
    def test_engine_builds(self) -> None:
    ...
    def test_material_maps_loaded(self) -> None:
    ...
    def test_reflection_consistency(self) -> None:
    ...
    def test_boundary_reflections(self) -> None:
    ...
    def test_pulse_propagates(self) -> None:
    ...
    def test_universal_gamma_matches(self) -> None:
