...
if __name__ == "__main__":
    ...
    ax1.axhline(y=bhs.r_sat/1000.0, color='r', linestyle='--', linewidth=2, label=r'Topological Saturation Boundary ($r_{sat}$)')
    ...
    plt.savefig('manuscript/vol_3_macroscopic/chapters/bh_topological_halt.pdf', dpi=300, bbox_inches='tight')
