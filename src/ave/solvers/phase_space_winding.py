...
═══════════════════════════════════════════════════════════════════════════════
  ...
  ch8-alpha-golden-torus.md / torus-knot-uniqueness.md:31-35):
    toroidal φ(t) = arg( Σ_x a_A1(x,t) )   — the A1 (mass-sector) global phase;  [DEMOTED 2026-08-11 - R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]
                                              counts the "2".
...
#        #417 BREAK carrier-ratio ω_b:ω_s discriminator, :162) treats the A1 slot as an independent
#        oscillator with its own carrier frequency — a state variable the carve removes; the BREAK
#        direction survives as diagnosis. Uncertain: on-site oscillation, not spatial propagation.
