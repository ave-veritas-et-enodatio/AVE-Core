...
The PINCER (both loci already read AGAINST Reading B, grep-confirmed):
  • REAL-SPACE winding HOLDS but is INERT (research/2026-06-24_engine-s1-winding-
    dof_result.md:25) — same arc's S3 is DISPERSE-FALSIFIED (research/2026-06-24_  [DEMOTED 2026-08-11 - R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]
...
#        the imported-reading dispersal verdict (register-row class); the module's own ω-sector barrier
#        physics is T2 and untouched. Uncertain: included per err-toward-inclusion — the record could be
#        read as pure history mention.
