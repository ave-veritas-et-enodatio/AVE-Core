...
═══════════════════════════════════════════════════════════════════════════════
  ...
  * phase vs real: the scatter lives in n-PORT amplitude space = the (V_inc,V_ref)  [DEMOTED 2026-08-11 - R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]
...
#        presumes incident/reflected wave amplitudes ON the A1/longitudinal channel (:69 'reads the A1
#        DILATATION saturation … bulk / longitudinal sector'); the C_eff=C0/S bond-compliance reactance
#        (:85) is the surviving object; the bulk-wave carrier owes re-derivation.
