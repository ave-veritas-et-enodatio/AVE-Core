...
localize, research/2026-06-24_engine-stage2-native-cage_result.md).  DEMOTED 2026-08-11 — R40-B1 (dated demotion note at end of file). S3 tests the
...
on-node 2×2 block, lifted to a per-site real-space block:
  ...
  i ∂_t a_A1   = ω_b·a_A1                              (A1 breather frequency)
               − c_A1²·L_native·a_A1                   (A1 disperses on K4)  [DEMOTED 2026-08-11 - R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]
...
#   :21 — "Stage-2 FALSIFIED the bulk self-trap: a seeded A1 precursor DISPERSES (Mode-III, energy-conservation-certified)"
#       stamped in place at :23
#       why it dies (audited row rationale, verbatim): Free-running dispersal of an autonomous A1
#       precursor IS R38's named casualty (the free-running P-branch); under the carve the dispersal
#       dynamics is void — the negative verdict DIRECTION survives a fortiori as diagnosis (no bulk
#       DOF ⇒ no bulk self-trap). Uncertain: could bin NEEDS as a record-of-imported-reading row.
#
...
#        operator; G-ENGINE-FLAG class — constraint-form (∇·u as multiplier) owed.
