...
═══════════════════════════════════════════════════════════════════════════════
  ...
  * Objective (CP3): the AVE-native objective is the GAPPED bound EIGENMODE of the  [DEMOTED 2026-08-11 - R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]
...
#        structure (:55-59 'the band TOP', omega_cutoff~2.87 cold-cage breather): a per-node A1 wave
#        operator with a propagating continuum band; wall-Gamma content (gamma_from_S_floor :99-104)
#        survives separately.
