...
#        family re-homed on the srs z=3 net: a_A1 as an independent dynamical breather with
#        graph-Laplacian dispersal; MASS accounting survives (re-homed per R38), the state-variable
#        treatment owes re-derivation.
