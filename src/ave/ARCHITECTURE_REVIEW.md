...
> **Framing note (2026-05-28 + 2026-05-29 update; 2026-05-31 Q-EMBED-SEL-1 resolution).**
> This is an audit-snapshot document. Its body uses the historical "three
> calibration inputs (M_E, ALPHA, G)" framing that was current at audit time.
> The corpus framing was reconciled 2026-05-28 (Option 2 — "Zero-parameter,
> gated") to "ONE SCALE + GATED CONSTANTS", gated on the open Clifford-torus
> embedding-selection step. **As of 2026-05-31 (Q-EMBED-SEL-1 Phase 1+2+3
> closure), the gating clause is RESOLVED and the framing is now "ONE SCALE
> + SUBSTRATE-MECHANISM-VALIDATED CONSTANTS"** at Class B substrate-mechanism
> manifestation level — substrate-mechanism for R·r = 1/4 derives via
> Axiom-4 self-saturation + Op14 Meissner-asymmetric + named phasor-area-
> equals-Nyquist-cell-area identification per Q-EMBED-SEL-1 (canonical at
> `research/2026-05-31_Q-EMBED-SEL-1_step_c_result.md` §2.3); cross-particle
> universal at Phase 2; cross-domain universal at Phase 3. For the current
> canonical framing see `src/ave/AGENTS.md` §1 (ONE SCALE + SUBSTRATE-
> MECHANISM-VALIDATED CONSTANTS), `src/ave/core/constants.py` §ONE SCALE +
> SUBSTRATE-MECHANISM-VALIDATED CONSTANTS header, and `manuscript/ave-kb/
> vol1/ch8-alpha-golden-torus.md` §"Substrate-mechanism provenance of
> regime (c)". Body preserved verbatim per Rule 12 (audit-snapshot
> historical-record discipline); the headline framing claim in C1 below
> ("three calibration inputs") should be read against the current Q-EMBED-
> SEL-1 framing at Class B substrate-mechanism manifestation level, not as
