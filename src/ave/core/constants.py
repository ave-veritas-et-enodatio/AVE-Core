...
#
# MODE DISTINCTION (KEEP-BOTH; no value change). V_LONG below is the BULK-SOUND speed  [DEMOTED 2026-08-11 - R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]
...
#   longitudinal modes, both retained; V_LONG stays the √2·c A1-scalar bulk value.  DEMOTED 2026-08-11 — R40-B1 (dated demotion note at end of file).
...
#   :778 — "the full compressional (P) wave is  c_L = √((K + 4G/3)/ρ) = √(10/3)·c ≈ 1.83c"
#       stamped in place at :780
#       why it dies (audited row rationale, verbatim): Asserts the solid P-wave as physically real
#       (:779-780 'two are distinct physical longitudinal modes, both retained') — the free-running
#       P-branch is exactly what R38 voids; prereg §6 names constants.py:778 in the radiative
#       family.
#       also covered (named in the audited row, not separately stamped): :779
#
...
#        as a wall/reflection parameter (LC-1 3a NOT-A-WAVE; coldq :262), but the labels 'Longitudinal
#        wave speed' (:768) and 'port-mode' consume a bulk propagation speed and a port — under the carve
#        the bulk is never a port; re-label/re-derive owed.
