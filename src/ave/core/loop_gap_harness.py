...
def _op2_bin(
    *,
    ...
    f1 = bulk_on and gamma_bulk_min <= OP2_GAMMA_BULK_MAX  # [DEMOTED 2026-08-11 - R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]
...
#        and c_bulk² liveness (:54, :364) — the register-row-recording-the-imported-reading class; the
#        harness's EM+shear/rank content survives, the bulk arm's criteria are owed re-derivation or
#        retirement.
