...
def micropolar_longwave(qhat, pos, bonds, *, k_axial=1.0, k_shear=1.0, gamma=0.0,
    ...
    Returns a dict with:
      Gamma_cauchy (3x3)  : the effective TRANSLATIONAL acoustic matrix rho*c^2 with  [DEMOTED 2026-08-11 - R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]
...
#        ball-and-spring instrument whose translational acoustic matrix carries the longitudinal
#        eigenvalue as a propagating lattice branch — the class that mints the P-branch (prereg route
#        (a): the srs lattice-computed branch is the import's echo); the chiral-B extraction and shear
#        slopes survive; the longitudinal member needs re-scoping under the constraint.
