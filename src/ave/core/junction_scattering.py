...
# The vertex-as-1-port reflection is the 1x1 matrix [S11]; the other (z-1) arms  [DEMOTED 2026-08-11 - R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]
...
#        S11/bore-selection analysis treats the scalar-channel wave as propagating through the vertex
#        with power division among arms (same X37 program; imports the :84 vertex circuit); S-matrix
#        algebra survives, its scalar-channel referent consumes the phantom passband. Same
#        channel-attribution caveat as X37.
