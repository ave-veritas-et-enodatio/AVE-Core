...
def create_dispersion_plot() -> None:
    ...
    ax.plot(
        ...
        color="#00ffff",
        lw=3,
        label=r"Right-Handed Branch ($\omega^2 = c^2k^2 + \gamma_c k$)",
    )
    ...
    ax.plot(
        k[mask_propagating],
        omega_L_real[mask_propagating],
        "-",
        color="#ff00aa",
        lw=3,
        label="Left-Handed Branch (Propagating)",
    )
    ...
    ax.plot(
        k[mask_evanescent],
        omega_L_imag[mask_evanescent],
        ":",
        color="#ff88cc",
        lw=3,
        label="Left-Handed Branch (Evanescent/Imaginary)",
    )
    ...
    ax.set_title(
        "Chiral Dispersion Relation (Cosserat Vacuum)",
        color="white",
        fontsize=16,
        fontweight="bold",
        pad=20,
