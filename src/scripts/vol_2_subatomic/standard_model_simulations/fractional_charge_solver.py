...
def main():
    ...
    ax.text(
        ...
        0,
        2.6,
        "Deep Inelastic Scattering Probe\n(High-Energy Electron)",
        color="white",
        ha="center",
    )
    ...
    plt.title(
        r"Topological Fractional Charge: Vector Projections of the $6^3_2$ Proton",
        color="white",
        fontsize=14,
        pad=20,
    )
    ...
    ax.text2D(
        0.05,
        0.90,
        "Net Macroscopic Integral = +1e (Stable Proton)",
    ...
    ax.text2D(
        0.05,
        0.85,
        "Individual Orthogonal Trace = +2/3e",
        transform=ax.transAxes,
        color="orange",
        fontsize=12,
    )
