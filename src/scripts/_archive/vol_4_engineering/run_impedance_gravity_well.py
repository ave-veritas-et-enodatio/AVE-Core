...
Proves that because gravity compresses the substrate volume, it increases
...
def simulate_impedance_matched_gravity() -> None:
    ...
    ax1.set_title(
        "Gravity as an Impedance-Matched Transmission Line",
        color="white",
        fontsize=14,
        weight="bold",
    )
    ...
    ax2.set_title(
        "Gravitational Wavelength Compression (Zero Reflection)",
        color="white",
        fontsize=14,
        weight="bold",
    )
    ...
    ax2.text(
        ...
        color="white",
        fontsize=11,
        bbox=dict(facecolor="#111111", edgecolor="white", alpha=0.8, pad=8),
    )
...
if __name__ == "__main__":
    simulate_impedance_matched_gravity()
