...
def simulate_bullet_cluster_fdtd():
    ...
    for i, (p_main, p_bullet, gN, drag) in enumerate(snapshots):
        ...
        ax.plot(x_axis_kpc, drag / norm_factor, color='purple', linewidth=2.5, 
        ...
        if i == 0:
            ax.set_title("First-Principles Bullet Cluster Topo-Lensing Crossing\nDriven entirely by absolute constants (G, m_e, ALPHA)", pad=15)
