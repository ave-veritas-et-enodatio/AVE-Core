...
def main():
    ...
    for idx, (ax, field, title, beam_y) in enumerate(zip(axes, fields, titles, y_lines)):
        im = ax.imshow(field.T, cmap='hot', origin='lower', extent=[0, NX, 0, NY],
    ...
    fig.suptitle('Kerr Frame Dragging — Acoustic Bernoulli Asymmetry (D-Shape Effect)', 
