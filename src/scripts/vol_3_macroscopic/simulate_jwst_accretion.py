...
def run_comparative_accretion():
    ...
    ax1.set_title("Standard $\\Lambda$CDM (Collisionless $1/r^2$)\nSlow Hierarchical Merging", color='white', pad=15)
    ax2.set_title("AVE Cosmology (Macroscopic Inductive Net)\nExponential 'JWST' Accretion", color='#00ffcc', pad=15)
