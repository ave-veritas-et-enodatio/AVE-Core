...
PLANETS = [
    ...
    {"name": "Mercury", "mass": 3.30e23, "r_eq": 2.44e6, "omega": 1.24e-6,  "J": 9.15e28,  "orbit_r": 5.79e10},
    {"name": "Venus",   "mass": 4.87e24, "r_eq": 6.05e6, "omega": -2.99e-7, "J": -7.06e29, "orbit_r": 1.08e11},
    {"name": "Earth",   "mass": 5.97e24, "r_eq": 6.37e6, "omega": 7.27e-5,  "J": 5.86e33,  "orbit_r": 1.50e11},
    {"name": "Mars",    "mass": 6.39e23, "r_eq": 3.39e6, "omega": 7.09e-5,  "J": 2.03e32,  "orbit_r": 2.28e11},
    {"name": "Jupiter", "mass": 1.90e27, "r_eq": 7.14e7, "omega": 1.76e-4,  "J": 6.90e38,  "orbit_r": 7.78e11},
    {"name": "Saturn",  "mass": 5.68e26, "r_eq": 6.03e7, "omega": 1.64e-4,  "J": 7.85e37,  "orbit_r": 1.43e12},
    {"name": "Uranus",  "mass": 8.68e25, "r_eq": 2.56e7, "omega": -1.01e-4, "J": -1.69e36, "orbit_r": 2.87e12},
    {"name": "Neptune", "mass": 1.02e26, "r_eq": 2.48e7, "omega": 1.08e-4,  "J": 2.53e36,  "orbit_r": 4.50e12},
]
...
def print_tables(results):
    ...
    header_str = (f"{headers[0]:<10} | {headers[1]:<12} | {headers[2]:<10} | "
                  f"{headers[3]:<14} | {headers[4]:<16} | {headers[5]:<12}")
    print(header_str)
    print("-" * len(header_str))
    for r in results:
        print(f"{r['name']:<10} | {r['p_gw_w']:.2e}   | {r['p_gw_norm']:.2e}   | "
...
def plot_impedance_map(results, output_dir):
    ...
    ax.plot(0, 0, 'yo', markersize=20, alpha=0.8,
            label=f'Sun (P_gw: {sun["p_gw_norm"]:.1e} x Earth)')
