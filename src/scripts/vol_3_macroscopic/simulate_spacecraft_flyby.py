...
print(f"    AVE Sagnac Solver:  +{near_topo_dv_mms:.2f} mm/s  (Error: {abs(near_topo_dv_mms-near_empirical_anomaly)/near_empirical_anomaly:.2%})")

print(f"\n  Galileo (1990):")
print(f"    Empirical Target:   +{gal_empirical_anomaly:.2f} mm/s")
gal_topo_dv_mms = gal_topo_dv * 1000.0
print(f"    AVE Sagnac Solver:  +{gal_topo_dv_mms:.2f} mm/s  (Error: {abs(gal_topo_dv_mms-gal_empirical_anomaly)/gal_empirical_anomaly:.2%})")
