        ...
        if step < SNAP_FRAME:
            ...
            for a in range(N_ANGULAR):
                ...
                if dist < flare_width:
                    ...
                    current_theta[a, :] = current_theta[a, :] * (1.0 - 0.5*intensity) + THETA[a, :] * (0.5*intensity)
...
def animate_flare(R, history_theta, flare_wave):
    ...
    title = ax.set_title("Macroscopic Topological Flare (CME)\nDifferential Rotation vs. 1/d Lattice Tension", 
