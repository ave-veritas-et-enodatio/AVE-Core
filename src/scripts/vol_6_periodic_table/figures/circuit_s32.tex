...
\node[small alpha, draw=neonorange, fill=darkbg!80!neonorange] (b0) at ({-4.5+-2.2}, {-10.0+2.2}) {$\alpha$};
\node[small alpha, draw=neonorange, fill=darkbg!80!neonorange] (b1) at ({-4.5+2.2}, {-10.0+2.2}) {$\alpha$};
\node[small alpha, draw=neonorange, fill=darkbg!80!neonorange] (b2) at ({-4.5+2.2}, {-10.0+-2.2}) {$\alpha$};
\node[small alpha, draw=neonorange, fill=darkbg!80!neonorange] (b3) at ({-4.5+-2.2}, {-10.0+-2.2}) {$\alpha$};
...
\node[text=white, font=\small, text width=7cm, align=left,
    ...
    \textcolor{neonorange}{Miller:} $M = 32.800$ ($V_R/V_{BR} = 0.994$)\\[4pt]
