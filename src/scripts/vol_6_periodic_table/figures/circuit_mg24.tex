...
\node[small alpha, draw=neonpurple, fill=darkbg!80!neonpurple] (p1) at (-4.5+0.3, -10.0+2.5) {$\alpha_N$};
\node[small alpha, draw=neonpurple, fill=darkbg!80!neonpurple] (p2) at (-4.5-0.3, -10.0-2.5) {$\alpha_S$};
