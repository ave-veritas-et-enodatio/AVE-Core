...
def compute_binding_energy_saturated(nodes_np, V_ref):
    ...
    strain_contributions = jnp.where(
        mask_bg,
        K_MUTUAL / jnp.maximum(mid_to_node_dist, 1e-10),
        0.0
    )
    ...
    be_per_pair = jnp.where(
        mask_upper,
        K_MUTUAL * f_sat / jnp.maximum(dist, 1e-10),
        0.0
    )
...
ELEMENT_NAMES = {
    (1,1): "H-1", (2,4): "He-4", (3,7): "Li-7", (4,9): "Be-9",
    (5,11): "B-11", (6,12): "C-12", (7,14): "N-14", (8,16): "O-16",
    (9,19): "F-19", (10,20): "Ne-20", (11,23): "Na-23", (12,24): "Mg-24",
    (13,27): "Al-27", (14,28): "Si-28", (15,31): "P-31", (16,32): "S-32",
}
