...
def run_leaky_cavity_sim():
    ...
    axes[1].annotate('Metric Ruptures\nEnergy bleeds into vacuum', xy=(10, 100), xytext=(40, 120),
                     arrowprops=dict(facecolor='white', shrink=0.05), color='white', fontsize=10)
    axes[1].annotate('Decay Halts\nStable ground state reached', xy=(150, 60), xytext=(120, 100),
                     arrowprops=dict(facecolor='white', shrink=0.05), color='white', fontsize=10)
