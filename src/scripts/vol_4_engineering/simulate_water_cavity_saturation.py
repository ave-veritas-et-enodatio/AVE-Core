...
axes[2].axhline(V_YIELD / 1e3, color='red', linestyle='--', lw=2, label=f"AVE Yield Limit ({V_YIELD/1e3:.2f} kV)")
...
plt.tight_layout()
plt.savefig(f"{str(pathlib.Path(__file__).parent.parent.parent.parent.absolute())}/manuscript/vol_4_engineering/figures/sonoluminescence_challenge.png", dpi=150)
