...
def run_autoresonance_sim():
    ...
    # Annotate plateau
    axes[0].annotate('Laser Detunes\nPower is Reflected', xy=(100, 20), xytext=(50, 40),
    ...
    axes[1].annotate('PLL Tracks Shift\nConstructive Interference Maintained', xy=(150, 50), xytext=(50, -40),
                     arrowprops=dict(facecolor='white', shrink=0.05), color='white', fontsize=10)
