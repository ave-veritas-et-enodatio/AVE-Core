...
def simulate_precession():
    ...
    solution = solve_ivp(orbital_derivatives, t_span, initial_state, 
                         method='DOP853', t_eval=t_eval, rtol=1e-9, atol=1e-9)
    ...
    ax.set_title("Anomalous Perihelion Precession\n(Topological $1/r^3$ Implicit Drag)", 
