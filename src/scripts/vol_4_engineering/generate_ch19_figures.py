...
def generate_thermal_rigidity():
    ...
    plt.plot(temperatures, c_vbi, 'r--', linewidth=2, label="Classical Model (Fermi-Dirac Statistical Gas)")
...
def generate_spice_override():
    ...
    plt.plot(voltage, I_classical, 'r--', linewidth=2, label="Classical Thermal Gas (Exponential Math Failure)")
