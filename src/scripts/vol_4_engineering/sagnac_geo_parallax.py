...
def simulate_sagnac_geo_parallax():
    ...
    print("=> RESULT: The 24-hr Earth rotation vectors this drift into a massive, detectable sinusoidal daily oscillation.")
    ...
    print("=> RESULT: The static G-field structurally stretches the telecom laser time-of-flight by ~17 millimeters, proving gravitational LC dispersion.")
