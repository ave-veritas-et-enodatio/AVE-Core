...
def main():
    ...
    # Summary
    print("\n  ═══════════════════════════════════════════════════════════════")
    print("  AVE INTERPRETATION")
    print("  ═══════════════════════════════════════════════════════════════")
    print("  The 'measurement problem' in QM is not a problem.")
    print("  It is a straightforward impedance mismatch.")
    print("")
    print("  WITHOUT observer: the soliton's radial wake passes through")
    print("  both slits with phase coherence intact → standing wave fringes.")
    print("")
    print("  WITH observer: a physical impedance perturbation (detector)")
    print("  at one slit introduces localized damping. This disrupts the")
    print("  phase relationship between the two wavefronts → no fringes.")
    print("")
    print("  The 'collapse' is nothing more than the acoustic engineering")
    print("  principle that you cannot tap a transmission line without")
    print("  disturbing the signal. There is no mystery.")
    print("  ═══════════════════════════════════════════════════════════════")
