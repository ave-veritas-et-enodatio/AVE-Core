...
def generate_scientific_visuals() -> None:
    ...
    ax.set_title(
        r"Macroscopic Ponderomotive Interference ($\nabla |\Psi_{mech}|^2$)",
        color="white",
        pad=20,
        fontsize=20,
        weight="bold",
    ...
    ax.text(
        wall_x + 40,
        NY - 40,
        r"Standing Wave Interference Fringes",
        color="#ffaa00",
        fontsize=14,
        weight="bold",
        bbox=props2,
    ...
    plt.colorbar(im, ax=ax, label="Normalized Intensity Time-Average", fraction=0.03, pad=0.04).set_label(
