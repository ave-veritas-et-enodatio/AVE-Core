...
%   2026-08-03, verified `gh pr view 839 --json mergedAt`). It is reused verbatim so the
...
%   2026-08-03). Reused with ONE adaptation, disclosed in the "Scope" sentence: ch03's de-claim
...
%   reused verbatim so the mirror pair cannot drift.
