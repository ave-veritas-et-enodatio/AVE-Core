...
\begin{equation}
    ...
    \label{eq:lagrangian}
\end{equation}
is the \emph{temporal-gauge} (Weyl-gauge, $A_0$-free) form of the Maxwell Lagrangian in vector-potential form --- standard Maxwell dynamics are recovered on the Gauss-constrained initial-data surface, the constraint being supplied by BC-SRC clause \textbf{S} (\texttt{eq\_axiom\_bc\_src.tex}) rather than by an equation of motion of this action (rescoped 2026-08-10, R43) --- recovered as the
