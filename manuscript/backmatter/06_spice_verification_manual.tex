...
\noindent The physical values $V_{snap} = m_e c^2/e = 510998.95$ V,
$V_{yield} = \sqrt{\alpha}\,V_{snap} = 43651.851844\ldots$ V and
$I_{max} = \xi_{topo}\,c = 124.384$ A are the canonical
\texttt{ave.core.constants} values. \textbf{The A1 metric varactor keys on
...
(charter design-(d)) lands, they are a maintained copy of the
\texttt{constants.py} values, not an auto-substituted one.
