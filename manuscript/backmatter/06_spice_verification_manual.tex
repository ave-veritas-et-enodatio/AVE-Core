...
\texttt{V\_YLD}  & $V_{yield}$ & 43651.85 V         & Dielectric yield voltage \\
\texttt{I\_YMAX} & $I_{max}$  & 124.384 A           & Current saturation limit \\
\bottomrule
\end{tabular}
\end{center}

\noindent The physical values $V_{yield} = \sqrt{\alpha}\,V_{snap} = 43651.851844\ldots$ V and
$I_{max} = \xi_{topo}\,c = 124.384$ A are the canonical
\texttt{ave.core.constants} values.
