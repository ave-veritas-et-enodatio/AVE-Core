...
%        QUOTE (byte-exact at HEAD): scalar / longitudinal\\$\leftrightarrow$ translational $u$;\;\;
...
%        QUOTE (byte-exact at HEAD): the $A_1$ \emph{mode} empties into the $T_2$ irreps by lossless
