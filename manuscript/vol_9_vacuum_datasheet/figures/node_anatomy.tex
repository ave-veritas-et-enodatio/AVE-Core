...
\begin{tikzpicture}[scale=1.0, transform shape,
    ...
    % --- 4-fold K4 nearest-neighbour bond stubs (tetrahedral connectivity) ---
    \foreach \ang/\lab in {35/{}, 145/{}, 215/{}, 325/{}} {
    ...
    \node[gray!60, font=\scriptsize, align=center] at (0,-2.55)
        {4-fold K4 connectivity; each bond a $Z_0=\sqrt{\mu_0/\varepsilon_0}$ transmission line};

    % --- intrinsic LC tank (drawn to the right as the node's internal reactance) ---
    \begin{scope}[shift={(5.3,0)}]
        \node[font=\footnotesize\bfseries] at (0,1.75) {Intrinsic LC tank};
        ...
        \node at (0,1.45) {$L_{cell}=\mu_0\,\ell_{node}$};
        ...
        \node at (0,-1.7) {$C_{cell}=\varepsilon_0\,\ell_{node}$};
...
\end{tikzpicture}
\caption{K4 node anatomy. Each node of the chiral Laves K4 Cosserat lattice carries one intrinsic electromagnetic LC tank ($L_{cell}=\mu_0\ell_{node}$, $C_{cell}=\varepsilon_0\ell_{node}$, resonating at $\omega_0=c_0/\ell_{node}$), connects to four nearest neighbours through $Z_0=\sqrt{\mu_0/\varepsilon_0}\approx376.73\,\Omega$ bond transmission lines, and hosts six Cosserat degrees of freedom: three translational (capacitive $\varepsilon_0$, identified with $\mathbf{E}$) and three microrotational (inductive $\mu_0$, identified with $\mathbf{B}$; the substrate-native origin of intrinsic spin). Axioms~1 (substrate topology). Schematic; not driver-generated.}
