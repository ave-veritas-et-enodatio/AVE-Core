...
The canonical operating-point statement is at KB leaf \kbleaf{ave-kb/vol4/falsification/ch11-experimental-bench/measurement-hierarchy-snr.md}:66; the substrate-physics derivation at \kbleaf{ave-kb/vol4/circuit-theory/ch1-vacuum-circuit-analysis/parametric-coupling-kernel.md}; the divergence-test-matrix row at \kbleaf{ave-kb/common/divergence-test-substrate-map.md} row \texttt{B7-PONDER-05}; the hardware programme at sibling repo \texttt{AVE-PONDER} (manuscript chapter \kbleaf{vol\_ponder/chapters/04\_ponder\_05\_dc\_biased\_quartz.tex}).
