...
12 & Cosmological Characteristics       & $R_H/\ell_{node} \sim 10^{39}$ ($\approx 3.455\times10^{38}$); Machian $G$ (mixed); $u_0^* \approx 0.187$ (calibrated value, not substrate-selected) \\
