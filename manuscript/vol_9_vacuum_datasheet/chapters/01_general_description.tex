...
The substrate's structure is fixed by the four AVE axioms (Vol~I Ch.~\ref{ch:fundamental_axioms}; canonical equation files \texttt{common\_equations/eq\_axiom\_[1-4].tex}). Datasheet entries that depend on a specific axiom cite the axiom inline.
...
\begin{itemize}
    ...
    \item \textbf{Bond transmission lines.} Bonds connecting nearest-neighbour nodes carry distributed transmission-line topology (TLM), with characteristic impedance $Z_0 = \sqrt{\mu_0/\varepsilon_0} \approx 376.73\,\Omega$ scale-invariant in the lattice pitch.
...
4  & DC Electrical Characteristics      & \texttt{src/ave/core/constants.py}; natural-units cheatsheet \\
