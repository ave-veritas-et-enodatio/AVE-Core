...
\noindent Integrating these geometric constraints---the topological cutoff, the dielectric yield capacity ($V_{yield}$), and the bulk strain inertia (statistical $G$ limit)---collapses the transport law into a single non-linear d'Alembertian impedance operator bounding the entire the substrate metric:
