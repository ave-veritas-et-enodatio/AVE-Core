...
\vspace{1.5em}
\noindent \textbf{The Formal Axioms}

\noindent For complete mathematical precision across all volumes, these boundaries are formally defined by the following four axioms, their derived calibration constants, and universal operators:
