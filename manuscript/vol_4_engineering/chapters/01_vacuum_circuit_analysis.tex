...
\textbf{Substrate-native vocabulary convention (canonical 2026-05-14, structural-closure
...
\item \textbf{Universal Saturation-Kernel Catalog:} Backmatter
  ...
  smaller scales (BCS, NOAA solar flares, BH ring-down, Schwarzschild exact).
\end{itemize}
