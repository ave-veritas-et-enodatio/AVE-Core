...
\item \textbf{Canonical picture-first reference:}
  \texttt{manuscript/ave-kb/common/trampoline-framework.md} (ground-up build +
  three storage modes + substrate-observability rule + multi-scale boundaries)
