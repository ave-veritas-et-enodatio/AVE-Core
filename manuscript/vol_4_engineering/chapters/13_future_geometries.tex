...
\subsection*{Thruster Topology Comparison}
\begin{center}
\small
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{lccc}
\toprule
\textbf{Property} & \textbf{PCBA (1D)} & \textbf{Hopf Coil (3D)} & \textbf{Phased Array} \\
\midrule
Coupling          & $\nabla|\mathbf{E}|^2$ (gradient) & $\mathbf{E}\cdot\mathbf{B}$ (helicity) & Synthetic OAM \\
