...
\begin{enumerate}
    \item \textbf{Project HOPF-01:} A wire-stitched $(p,q)$ torus knot antenna on FR-4, measured via VNA S$_{11}$ sweep. Tests the chiral coupling prediction $\Delta f/f = \alpha \cdot pq/(p+q)$.
