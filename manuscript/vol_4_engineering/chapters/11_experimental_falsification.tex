...
% Original sections extracted to AVE-Propulsion and AVE-PONDER repositories:
...
\begin{enumerate}
    ...
    \item \textbf{Project PONDER-01:} An asymmetric high-voltage dielectric array using BaTiO$_3$ MLCCs, testing the macroscopic non-linear stress rectification prediction.
\end{enumerate}
...
% Original detailed build guides extracted to AVE-PONDER repository
