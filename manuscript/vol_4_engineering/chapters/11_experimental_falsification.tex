...
\textit{The complete spinning-disk test protocol, PCBA layout, and lock-in amplifier falsification criteria are detailed in the companion AVE Hardware Testing Manual.}
...
The theoretical framework derived above---the 1.846-gram static levitation limit, the Dielectric Death Spiral, and the $\sqrt{\alpha}$ kinetic yield---opens several macroscopic engineering pathways. These include horizontal torsion-balance thrust rectification, phased micro-inductor arrays for extensive force multiplication, high-$k$ dielectric metric refraction capacitors, and acoustic phonon centrifuges for artificial gravity synthesis.

\textit{The complete engineering implementations, PCBA specifications, spacecraft hull designs, and operational telemetry (including boundary-layer sensors and pair-production ``Redline'' monitors) are documented in the companion AVE Hardware Testing Manual.}
...
\begin{enumerate}
    ...
    \item \textbf{High-Voltage Dielectric Rectification:} An asymmetric high-voltage dielectric array using BaTiO$_3$ MLCCs, testing the macroscopic non-linear stress rectification prediction.
\end{enumerate}

\textit{Complete fabrication instructions, PCBA layouts, bills of materials, and falsification protocols are provided in the companion AVE Hardware Testing Manual.}
