...
\end{equation}
where $V_{yield}$ is the absolute dynamic point-yield threshold of the condensate (derived in Section \% missing reference sec:point_yield as $\sqrt{\alpha} \cdot m_e c^2 \approx 43.65\text{ kV}$).
