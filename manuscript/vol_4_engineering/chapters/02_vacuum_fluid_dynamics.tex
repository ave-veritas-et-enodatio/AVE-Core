...
\begin{itemize}
    ...
    \item Map aerodynamic parameters (Navier-Stokes) strictly to the electro-fluidic observables of the substrate.
...
\input{../common/translation_fluidics.tex}
