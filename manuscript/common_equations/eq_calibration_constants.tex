...
\noindent\textbf{Dielectric Yield Voltage} (per Axiom 4; the \textbf{transverse Cosserat $T_2$ self-trap wall} --- the electron's confining $\Gamma = -1$\gammaundeclared{}; \texttt{def-vyvsn1} adjudicated = $T_2$, PR\,\#260):
\begin{equation}
