...
% The ratified ":22" text carries the placeholder "[BC-LAW leaf]"; under R43 the
% bound-sector constitutive law is ratified as BC-SRC, so the placeholder is
% resolved to eq_axiom_bc_src.tex + the KB axiom-register BC-SRC entry.
%
