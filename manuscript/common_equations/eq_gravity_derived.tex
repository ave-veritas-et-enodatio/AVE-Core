...
% Vol 1 Ch 1's canonical Scheme A: Axiom 3 is the Effective Action Principle
% (eq_axiom_3.tex); the gravitational refractive index n(r) and Symmetric Gravity
% scaling are derived consequences of Axiom 1 (LC network) + Axiom 4 (dielectric
% saturation applied symmetrically to mu and epsilon). Newton's constant G is a
% calibration constant emerging from Machian thermodynamic equilibrium of the LC
% lattice (per Vol 1 Ch 1:14-21 and Vol 1 Ch 1 Section 3.2).
%
