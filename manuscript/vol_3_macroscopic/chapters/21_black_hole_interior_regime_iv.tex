...
\textbf{Cross-cutting note (canonical 2026-05-15).}
...
\item \textbf{Our cosmic interior $\to$ pre-genesis state:} we sit inside
  ...
  four other scales (atomic dielectric breakdown; substrate K4 magic-angle;
...
(Universal Saturation-Kernel Catalog with all 19 cross-scale instances).
