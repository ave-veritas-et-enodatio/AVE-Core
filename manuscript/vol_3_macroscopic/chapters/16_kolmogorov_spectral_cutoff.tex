...
\end{equation}
For $k \ll k_{\max}$, $S \to 1.0$ and the relationship converges precisely to K41 scaling. As $k \to k_{\max}$, the available degrees of freedom for coherent vorticity vanish ($S \to 0$) terminating the cascade rigorously (Figure~\ref{fig:kolmogorov_cascade}).
