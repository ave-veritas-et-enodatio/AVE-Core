...
\textbf{A-034 planetary-scale instance (canonical 2026-05-15 evening).}
This chapter describes Earth's geomagnetic dynamo and planetary internal
structure. The geomagnetic reversal phenomenon (Earth pole flip on
...
Notable framework prediction: Venus's slower spin keeps it below threshold,
producing essentially zero magnetic field (canonical AVE prediction).
See Vol 3 Ch~4 \S\ref{sec:tki_strain_snap} + Backmatter
Ch~\ref{app:universal_saturation_kernel} for the full 19-instance catalog.
