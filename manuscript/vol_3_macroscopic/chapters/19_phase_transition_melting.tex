...
\begin{itemize}
    ...
    \item Understand how all seven bulk water properties emerge from a single proton $LC$ eigenmode with no fitted parameters---every input is engine-derived or a fundamental constant ($m_\text{H}$, $\hbar$, $k_B$, $\alpha$).
