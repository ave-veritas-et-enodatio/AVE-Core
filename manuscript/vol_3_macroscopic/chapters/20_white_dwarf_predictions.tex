...
the WD surface acts as a near-perfect reflector ($\Gamma \approx -1$\gammaundeclared{}).
...
\begin{enumerate}
    \item \textbf{Boundary:} WD surface at $R$ (shear reflector, $\Gamma \approx -1$\gammaundeclared{}).
