...
\begin{objectivebox}
\begin{itemize}
    \item Derive seven macroscopic water observables from a single Op4 spring constant $k_{\text{hb}} = 2.247$~N/m with no per-observable fitting; the bond geometry and eigenmode are cross-volume derived primaries, and the $+4$\textdegree{}C density maximum is a numerically-demonstrated cooperative-lattice result rather than a closed-form output.
