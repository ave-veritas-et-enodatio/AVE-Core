...
\textit{Note: This section covers the Regime I $\to$ II transition (onset). For the Regime III boundary and the resolution of the Kolmogorov cascade singularity, see Volume 3, Chapter \ref{ch:kolmogorov_spectral_cutoff}.}
