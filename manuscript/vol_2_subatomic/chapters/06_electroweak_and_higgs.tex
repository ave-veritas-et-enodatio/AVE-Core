...
Using the canonical `AVE_VACUUM_CELL` solver framework (\texttt{src/ave/solvers/g\_minus\_2\_lattice.py}), the $S_{11}$ structural limit is computed physically from a terminating Bethe tree bounded by the macroscopic transition limit (Regime I/II boundary, $Y_0=1$).
