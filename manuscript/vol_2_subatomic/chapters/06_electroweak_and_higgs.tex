...
\end{equation}
This helical impedance spiral is visible in the 3D-printable STL model (\texttt{assets/3d\_models/muon\_twisted\_unknot.stl}).
...
Table~\ref{tab:trans_particle} consolidates the ontological mapping between Standard Model concepts and their AVE structural equivalents.
