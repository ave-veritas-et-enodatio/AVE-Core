...
Big Bang (cosmic IC) & A-034 cosmic-scale strain-snap & Parent-BH strain on pre-geodesic plasma triggers K4 crystallization seed event (Backmatter Ch~\ref{app:universal_saturation_kernel}; Vol~3 Ch~4 \S\ref{sec:tki_strain_snap}). \\
