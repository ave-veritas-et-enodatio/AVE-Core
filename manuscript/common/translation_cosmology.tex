...
Big Bang (cosmic IC) & A-034 cosmic-scale strain-snap & Parent-BH strain on the pre-bond state (gloss \emph{pre-geodesic}; R9 rename 2026-08-06) triggers K4 crystallization seed event (Backmatter Ch~\ref{app:universal_saturation_kernel}; Vol~3 Ch~4 \S\ref{sec:tki_strain_snap}). \\
MOND $a_0$ & A-034 ASYM-N row (single-sector) & Same kernel as BCS, BH ring-down. \\
\bottomrule
\end{tabularx}
\end{table}
