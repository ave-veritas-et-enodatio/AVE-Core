...
\begin{summarybox}
\begin{itemize}
    \item Applied Vacuum Engineering models the vacuum as a physical, solid-state LC condensate (the substrate) governed by continuum elastodynamics and non-linear dielectric saturation.
