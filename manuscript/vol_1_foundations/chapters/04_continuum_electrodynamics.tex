...
$K_{vac} = 2G_{vac}$ (\S\% missing reference sec:cauchy_paradox).
...
\textit{Detailed Sagnac rotor geometries, optical telemetry bounds, and entrainment calibrations are documented in the companion AVE Hardware Testing Manual.}
