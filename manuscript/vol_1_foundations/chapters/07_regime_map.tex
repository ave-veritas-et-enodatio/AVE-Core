...
\begin{exercisebox}
\begin{enumerate}
    \item Using the first-order Taylor expansion of $S(r)$ (Eq. \ref{eq:S_taylor}), calculate the percentage magnitude error introduced by using the linear low-energy Maxwell equations to model a $30\,\text{kV}$ PONDER-05 thruster where $r \approx 0.687$.
