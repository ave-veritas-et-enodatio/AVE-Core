...
\hline
\textbf{Regime} & \textbf{Name} & \textbf{$r$ range} & \textbf{$S$ range} & \textbf{Physics} & \textbf{EE Analog} \\ \hline
...
IV  & Ruptured   & $r \geq 1.0$       & $S = 0$           & Topology destroyed  & Breakdown ($M \to \infty$) \\ \hline
\end{tabular}
\end{center}
