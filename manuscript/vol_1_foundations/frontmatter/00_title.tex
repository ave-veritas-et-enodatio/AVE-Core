...
This volume establishes the mechanical and mathematical axioms of the substrate LC Network framework, derives the universal operators ($Z$, $S$, $\Gamma$), and defines the four-regime map that governs all subsequent volumes.
