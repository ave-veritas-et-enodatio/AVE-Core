...
%  SCOPE: this note fences all five "$K=2G$" sites in the volume -- 00_introduction.tex :7, :91
%  (naming epithets) and :100 (the exercise, corrected inline below), plus the two companion
...
%  per-element chapters -- 08_carbon.tex:80, 10_oxygen.tex:65, 12_neon.tex:73 -- so this is an
