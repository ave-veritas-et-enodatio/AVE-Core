...
\node[text=aveink, font=\bfseries\Large] at (0, 8.2)
    {Ar-40 \quad Semiconductor Equivalent Circuit};
\node[text=avemuted, font=\small] at (0, 7.5)
    {$10\alpha$ Bicapped Antiprism \quad|\quad $V_R/V_{BR} = 0.030$ \quad|\quad $M = 1.000$ (Small Signal)};
...
\node[text=aveink, font=\small, draw=avemuted, dashed, rounded corners=3pt, inner sep=5pt]
    at (0, -5.6) {Ar-40: $V_R/V_{BR} = 0.030 \implies M = 1.0$ \quad (Deep Small Signal)};
...
\node[text=aveink, font=\small, text width=7cm, align=left,
    ...
    \textbf{Result:} $37,202.222$ MeV ($0.0002\%$ error)
};
