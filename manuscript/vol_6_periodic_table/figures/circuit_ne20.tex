...
\node[text=aveink, font=\bfseries\Large] at (0, 8.2)
    {Ne-20 \quad Semiconductor Equivalent Circuit};
\node[text=avemuted, font=\small] at (0, 7.5)
    {$5\alpha$ Triangular Bipyramid \quad|\quad $V_R/V_{BR} = 0.032$ \quad|\quad $M = 1.000$ (Small Signal)};
...
\node[text=aveink, font=\small, draw=avemuted, dashed, rounded corners=3pt, inner sep=5pt]
    at (0, -5.6) {Ne-20: $V_R/V_{BR} = 0.032 \implies M = 1.0$ \quad (Deep Small Signal)};
...
\node[small alpha] (e1) at ({-4.5 + 2.0*cos(210)}, {-10.0 + 2.0*sin(210)}) {$\alpha$};
\node[small alpha] (e2) at ({-4.5 + 2.0*cos(330)}, {-10.0 + 2.0*sin(330)}) {$\alpha$};
...
\draw[aveaccent, thick] (e0) -- (e1); \draw[aveaccent, thick] (e1) -- (e2); \draw[aveaccent, thick] (e2) -- (e0);
...
\node[text=avemuted, font=\tiny, text width=2.6cm, align=left, anchor=west] at (-1.5, -9.5)
    {3 ring + 6 pole-eq\\1 pole-pole\\\textbf{10 junctions}};
...
\node[text=aveink, font=\small, text width=7cm, align=left,
      ...
      at (2.5, -7.6) {
    $M_{\text{nuc}} = 5\, M_\alpha - BE_{\text{net}}$\\[6pt]
    $BE_{\text{net}} = \underbrace{\displaystyle\sum_{i<j}^{10} 16 \cdot \frac{K}{R_{ij}}}_{\ text{Strong (attractive)}}
    ...
    \textcolor{avevermillion}{Miller:} $M = 1.000$ ($V_R/V_{BR} = 0.032$)\\[4pt]
    \textbf{Result:} $18,617.730$ MeV ($0.0000\%$ error)
};
