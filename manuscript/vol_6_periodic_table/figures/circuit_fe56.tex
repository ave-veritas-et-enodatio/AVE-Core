...
\node[text=aveink, font=\bfseries\Large] at (0, 8.2)
    {Fe-56 \quad Semiconductor Equivalent Circuit};
\node[text=avemuted, font=\small] at (0, 7.5)
    {$14\alpha$ FCC-14 \quad|\quad $V_R/V_{BR} = 0.030$ \quad|\quad $M = 1.000$ (Small Signal)};
...
\node[text=aveink, font=\small, draw=avemuted, dashed, rounded corners=3pt, inner sep=5pt]
    at (0, -5.6) {Fe-56: $V_R/V_{BR} = 0.030 \implies M = 1.0$ \quad (Deep Small Signal)};
...
\node[small alpha] (c0) at ({-4.5+-1.5}, {-10.0+1.5}) {$\alpha_c$};
\node[small alpha] (c1) at ({-4.5+1.5}, {-10.0+1.5}) {$\alpha_c$};
\node[small alpha] (c2) at ({-4.5+1.5}, {-10.0+-1.5}) {$\alpha_c$};
\node[small alpha] (c3) at ({-4.5+-1.5}, {-10.0+-1.5}) {$\alpha_c$};
\node[small alpha] (c4) at ({-4.5+-2.3}, {-10.0+0.3}) {$\alpha_c$};
\node[small alpha] (c5) at ({-4.5+2.3}, {-10.0+-0.3}) {$\alpha_c$};
\node[small alpha] (c6) at ({-4.5+0.3}, {-10.0+2.3}) {$\alpha_c$};
\node[small alpha] (c7) at ({-4.5+-0.3}, {-10.0+-2.3}) {$\alpha_c$};
\node[small alpha, draw=avevermillion, fill=white!85!avevermillion] (f0) at ({-4.5+0}, {-10.0+1.5}) {$\alpha_f$};
\node[small alpha, draw=avevermillion, fill=white!85!avevermillion] (f1) at ({-4.5+0}, {-10.0+-1.5}) {$\alpha_f$};
\node[small alpha, draw=avevermillion, fill=white!85!avevermillion] (f2) at ({-4.5+-1.5}, {-10.0+0}) {$\alpha_f$};
\node[small alpha, draw=avevermillion, fill=white!85!avevermillion] (f3) at ({-4.5+1.5}, {-10.0+0}) {$\alpha_f$};
\node[small alpha, draw=avevermillion, fill=white!85!avevermillion] (f4) at ({-4.5+0}, {-10.0+0.3}) {$\alpha_f$};
\node[small alpha, draw=avevermillion, fill=white!85!avevermillion] (f5) at ({-4.5+0}, {-10.0+-0.3}) {$\alpha_f$};
...
\node[text=avemuted, font=\tiny, text width=2.6cm, align=left, anchor=west] at (-1.5, -9.5)
    {12 cube + 24 face\\+55 non-adjacent\\\textbf{91 junctions}};
...
\node[text=aveink, font=\small, text width=7cm, align=left,
      ...
      at (2.5, -7.6) {
    $M_{\text{nuc}} = 14\, M_\alpha - BE_{\text{net}}$\\[6pt]
    $BE_{\text{net}} = \underbrace{\displaystyle\sum_{i<j}^{91} 16 \cdot \frac{K}{R_{ij}}}_{\ text{Strong (attractive)}}
    ...
    \textbf{Result:} $52,103.027$ MeV ($0.0001\%$ error)
};
