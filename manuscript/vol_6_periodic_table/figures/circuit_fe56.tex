...
\node[small alpha, draw=neonorange, fill=darkbg!80!neonorange] (f0) at ({-4.5+0}, {-10.0+1.5}) {$\alpha_f$};
\node[small alpha, draw=neonorange, fill=darkbg!80!neonorange] (f1) at ({-4.5+0}, {-10.0+-1.5}) {$\alpha_f$};
\node[small alpha, draw=neonorange, fill=darkbg!80!neonorange] (f2) at ({-4.5+-1.5}, {-10.0+0}) {$\alpha_f$};
\node[small alpha, draw=neonorange, fill=darkbg!80!neonorange] (f3) at ({-4.5+1.5}, {-10.0+0}) {$\alpha_f$};
\node[small alpha, draw=neonorange, fill=darkbg!80!neonorange] (f4) at ({-4.5+0}, {-10.0+0.3}) {$\alpha_f$};
\node[small alpha, draw=neonorange, fill=darkbg!80!neonorange] (f5) at ({-4.5+0}, {-10.0+-0.3}) {$\alpha_f$};
