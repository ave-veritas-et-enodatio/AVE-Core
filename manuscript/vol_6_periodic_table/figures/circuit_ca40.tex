...
\node[text=neonorange, font=\small, draw=white, dashed, rounded corners=3pt, inner sep=5pt]
...
\node[small alpha, draw=neonpurple, fill=darkbg!80!neonpurple] (p1) at (-4.5, -10.0+2.5) {$\alpha_N$};
\node[small alpha, draw=neonpurple, fill=darkbg!80!neonpurple] (p2) at (-4.5, -10.0-2.5) {$\alpha_S$};
...
\node[text=white, font=\small, text width=7cm, align=left,
    ...
    \textcolor{neonorange}{Miller:} $M = 32.900$ ($V_R/V_{BR} = 0.994$)\\[4pt]
