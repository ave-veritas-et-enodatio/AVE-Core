...
\node[text=aveink, font=\bfseries\Large] at (0, 8.2)
    {Ca-40 \quad Semiconductor Equivalent Circuit};
\node[text=avemuted, font=\small] at (0, 7.5)
    {$10\alpha$ Bicapped Antiprism \quad|\quad $V_R/V_{BR} = 0.994$ \quad|\quad $M = 32.900$ (Large Signal)};
...
\node[text=avevermillion, font=\small, draw=avemuted, dashed, rounded corners=3pt, inner sep=5pt]
    at (0, -5.6) {Ca-40: $V_R/V_{BR} = 0.994 \implies M = 32.9$ \quad (\textbf{AVALANCHE})};
...
\node[small alpha] (l0) at ({-4.5 + 1.5*cos(0)}, {-10.0 + 1.5*sin(0) - 0.5}) {$\alpha$};
\node[small alpha] (l1) at ({-4.5 + 1.5*cos(90)}, {-10.0 + 1.5*sin(90) - 0.5}) {$\alpha$};
\node[small alpha] (l2) at ({-4.5 + 1.5*cos(180)}, {-10.0 + 1.5*sin(180) - 0.5}) {$\alpha$};
\node[small alpha] (l3) at ({-4.5 + 1.5*cos(270)}, {-10.0 + 1.5*sin(270) - 0.5}) {$\alpha$};
\node[small alpha] (u0) at ({-4.5 + 1.5*cos(45)}, {-10.0 + 1.5*sin(45) + 0.5}) {$\alpha$};
\node[small alpha] (u1) at ({-4.5 + 1.5*cos(135)}, {-10.0 + 1.5*sin(135) + 0.5}) {$\alpha$};
\node[small alpha] (u2) at ({-4.5 + 1.5*cos(225)}, {-10.0 + 1.5*sin(225) + 0.5}) {$\alpha$};
\node[small alpha] (u3) at ({-4.5 + 1.5*cos(315)}, {-10.0 + 1.5*sin(315) + 0.5}) {$\alpha$};
\node[small alpha, draw=aveink, fill=white!85!aveink] (p1) at (-4.5, -10.0+2.5) {$\alpha_N$};
\node[small alpha, draw=aveink, fill=white!85!aveink] (p2) at (-4.5, -10.0-2.5) {$\alpha_S$};
...
\node[text=avemuted, font=\tiny, text width=2.6cm, align=left, anchor=west] at (-1.5, -9.5)
    {8 ring + 6 cap\\+31 cross-links\\\textbf{45 junctions}};
...
\node[text=aveink, font=\small, text width=7cm, align=left,
      ...
      at (2.5, -7.6) {
    $M_{\text{nuc}} = 10\, M_\alpha - BE_{\text{net}}$\\[6pt]
    $BE_{\text{net}} = \underbrace{\displaystyle\sum_{i<j}^{45} 16 \cdot \frac{K}{R_{ij}}}_{\ text{Strong (attractive)}}
    ...
    \textcolor{avevermillion}{Miller:} $M = 32.900$ ($V_R/V_{BR} = 0.994$)\\[4pt]
    \textbf{Result:} $37,322.573$ MeV ($0.0000\%$ error)
};
