...
\node[text=aveink, font=\bfseries\Large] at (0, 8.2)
    {Si-28 \quad Semiconductor Equivalent Circuit};
\node[text=avemuted, font=\small] at (0, 7.5)
    {$7\alpha$ Pentagonal Bipyramid \quad|\quad $V_R/V_{BR} = 0.047$ \quad|\quad $M = 1.000$ (Small Signal)};
...
\node[text=aveink, font=\small, draw=avemuted, dashed, rounded corners=3pt, inner sep=5pt]
    at (0, -5.6) {Si-28: $V_R/V_{BR} = 0.047 \implies M = 1.0$ \quad (Deep Small Signal)};
...
\node[small alpha] (e0) at ({-4.5 + 2.0*cos(90)}, {-10.0 + 2.0*sin(90)}) {$\alpha$};
\node[small alpha] (e1) at ({-4.5 + 2.0*cos(162)}, {-10.0 + 2.0*sin(162)}) {$\alpha$};
\node[small alpha] (e2) at ({-4.5 + 2.0*cos(234)}, {-10.0 + 2.0*sin(234)}) {$\alpha$};
\node[small alpha] (e3) at ({-4.5 + 2.0*cos(306)}, {-10.0 + 2.0*sin(306)}) {$\alpha$};
\node[small alpha] (e4) at ({-4.5 + 2.0*cos(378)}, {-10.0 + 2.0*sin(378)}) {$\alpha$};
\node[small alpha, draw=aveink, fill=white!85!aveink] (p1) at (-4.5, -10.0+2.7) {$\alpha_N$};
\node[small alpha, draw=aveink, fill=white!85!aveink] (p2) at (-4.5, -10.0-2.7) {$\alpha_S$};

\draw[aveaccent, thick] (e0)--(e1); \draw[aveaccent, thick] (e1)--(e2);
\draw[aveaccent, thick] (e2)--(e3); \draw[aveaccent, thick] (e3)--(e4); \draw[aveaccent, thick] (e4)--(e0);
...
\draw[aveink, thin] (e2)--(e4); \draw[aveink, thin] (e3)--(e0); \draw[aveink, thin] (e4)--(e1);


\node[text=avemuted, font=\tiny, text width=2.6cm, align=left, anchor=west] at (-1.5, -9.5)
    {5 ring + 10 pole-eq\\5 cross + 1 pp\\\textbf{21 junctions}};
...
\node[text=aveink, font=\small, text width=7cm, align=left,
      ...
      at (2.5, -7.6) {
    $M_{\text{nuc}} = 7\, M_\alpha - BE_{\text{net}}$\\[6pt]
    $BE_{\text{net}} = \underbrace{\displaystyle\sum_{i<j}^{21} 16 \cdot \frac{K}{R_{ij}}}_{\ text{Strong (attractive)}}
    ...
    \textcolor{avevermillion}{Miller:} $M = 1.000$ ($V_R/V_{BR} = 0.047$)\\[4pt]
    \textbf{Result:} $26,053.188$ MeV ($0.0002\%$ error)
};
