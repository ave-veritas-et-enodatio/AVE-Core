...
\node[small alpha, draw=neonpurple, fill=darkbg!80!neonpurple] (p1) at (-4.5, -10.0+2.7) {$\alpha_N$};
\node[small alpha, draw=neonpurple, fill=darkbg!80!neonpurple] (p2) at (-4.5, -10.0-2.7) {$\alpha_S$};
...
\node[text=white, font=\small, text width=7cm, align=left,
    ...
    \textcolor{neonorange}{Miller:} $M = 1.000$ ($V_R/V_{BR} = 0.047$)\\[4pt]
