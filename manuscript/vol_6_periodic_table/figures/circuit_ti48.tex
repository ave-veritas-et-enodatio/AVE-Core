...
\node[text=aveink, font=\bfseries\Large] at (0, 8.2)
    {Ti-48 \quad Semiconductor Equivalent Circuit};
\node[text=avemuted, font=\small] at (0, 7.5)
    {$12\alpha$ Cuboctahedron \quad|\quad $V_R/V_{BR} = 0.030$ \quad|\quad $M = 1.000$ (Small Signal)};
...
\node[text=avepurple, font=\small, anchor=north] at (0, -2.2) {$V_{BR} = 6\alpha\hbar c / D_{\text{intra}} = 3.631$ MeV};
...
\node[text=aveink, font=\small, draw=avemuted, dashed, rounded corners=3pt, inner sep=5pt]
    at (0, -5.6) {Ti-48: $V_R/V_{BR} = 0.030 \implies M = 1.0$ \quad (Deep Small Signal)};
...
\node[small alpha] (e0) at ({-4.5 + 2.0*cos(0)}, {-10.0 + 2.0*sin(0)}) {$\alpha$};
\node[small alpha] (e1) at ({-4.5 + 2.0*cos(90)}, {-10.0 + 2.0*sin(90)}) {$\alpha$};
\node[small alpha] (e2) at ({-4.5 + 2.0*cos(180)}, {-10.0 + 2.0*sin(180)}) {$\alpha$};
\node[small alpha] (e3) at ({-4.5 + 2.0*cos(270)}, {-10.0 + 2.0*sin(270)}) {$\alpha$};
\node[small alpha, draw=aveink, fill=white!85!aveink] (u0) at ({-4.5 + 1.3*cos(45)}, {-10.0 + 1.3*sin(45) + 1.2}) {$\alpha$};
\node[small alpha, draw=aveink, fill=white!85!aveink] (u1) at ({-4.5 + 1.3*cos(135)}, {-10.0 + 1.3*sin(135) + 1.2}) {$\alpha$};
\node[small alpha, draw=aveink, fill=white!85!aveink] (u2) at ({-4.5 + 1.3*cos(225)}, {-10.0 + 1.3*sin(225) + 1.2}) {$\alpha$};
\node[small alpha, draw=aveink, fill=white!85!aveink] (u3) at ({-4.5 + 1.3*cos(315)}, {-10.0 + 1.3*sin(315) + 1.2}) {$\alpha$};
\node[small alpha, draw=avevermillion, fill=white!85!avevermillion] (l0) at ({-4.5 + 1.3*cos(45)}, {-10.0 + 1.3*sin(45) - 1.2}) {$\alpha$};
\node[small alpha, draw=avevermillion, fill=white!85!avevermillion] (l1) at ({-4.5 + 1.3*cos(135)}, {-10.0 + 1.3*sin(135) - 1.2}) {$\alpha$};
\node[small alpha, draw=avevermillion, fill=white!85!avevermillion] (l2) at ({-4.5 + 1.3*cos(225)}, {-10.0 + 1.3*sin(225) - 1.2}) {$\alpha$};
\node[small alpha, draw=avevermillion, fill=white!85!avevermillion] (l3) at ({-4.5 + 1.3*cos(315)}, {-10.0 + 1.3*sin(315) - 1.2}) {$\alpha$};

\draw[aveaccent, thick] (e0)--(e1)--(e2)--(e3)--cycle;
\draw[aveink] (u0)--(u1)--(u2)--(u3)--cycle;
\draw[avevermillion] (l0)--(l1)--(l2)--(l3)--cycle;
\draw[aveaccent] (e0)--(u0); \draw[aveaccent] (e1)--(u1); \draw[aveaccent] (e2)--(u2); \draw[aveaccent] (e3)--(u3);
\draw[aveaccent] (e0)--(l0); \draw[aveaccent] (e1)--(l1);


\node[text=avemuted, font=\tiny, text width=2.6cm, align=left, anchor=west] at (-1.5, -9.5)
    {12 ring + 8 cross\\+46 non-adjacent\\\textbf{66 junctions}};
...
\node[text=aveink, font=\small, text width=7cm, align=left,
      ...
      at (2.5, -7.6) {
    $M_{\text{nuc}} = 12\, M_\alpha - BE_{\text{net}}$\\[6pt]
    $BE_{\text{net}} = \underbrace{\displaystyle\sum_{i<j}^{66} 16 \cdot \frac{K}{R_{ij}}}_{\ text{Strong (attractive)}}
    ...
    \textbf{Result:} $44,636.570$ MeV ($0.0001\%$ error)
};
