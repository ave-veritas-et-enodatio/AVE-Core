...
\node[small alpha, draw=neonorange, fill=darkbg!80!neonorange] (h0) at (-4.5, -11.5) {$n$};

\draw[neongreen, thick] (c0) -- (c1);
\draw[neonorange, thick, dashed] (c0) -- (h0); \draw[neonorange, thick, dashed] (c1) -- (h0);
...
\node[text=white, font=\small, text width=7cm, align=left,
    ...
    $BE_{\text{net}} = \underbrace{\displaystyle\sum_{i<j}^{1} 16 \cdot \frac{K}{R_{ij}}}_{\ text{Strong (attractive)}}
    ...
    \textcolor{neonorange}{Miller:} $M = N/A$ ($V_R/V_{BR} = N/A$)\\[4pt]
