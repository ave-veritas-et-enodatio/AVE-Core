...
% [2026-06-14 KB-reconciliation (vol_0 brief A.2) -- prior wording preserved per Rule 12]: read "...bounded the geometric packing fraction of the vacuum to $p_c \approx 0.1834$, forcing the emergence of $\alpha$." SUPERSEDED: alpha is a retained input, not an emergent output; canonical directionality is p_c = 8*pi*alpha (ch8-alpha-golden-torus.md:11). No value change.
