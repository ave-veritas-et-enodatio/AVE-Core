...
\begin{enumerate}
    ...
    \end{equation}
    where $E_{HB} = 0.2158$~eV (the hydrogen bond energy, derived from Op4 $\times$ void fraction in \S\% missing reference sec:ave_water_hb) and $n_{coop} = 9$ is the cooperative amplification constant.
