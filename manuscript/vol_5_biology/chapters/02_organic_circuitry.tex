...
\begin{enumerate}
    ...
    \end{itemize}
    \item The minimum-$|S_{11}|^2$ configuration is the \textbf{native fold} --- there is no search; the chain mechanically snaps to its impedance-matched geometry, and the snap IS the protein-folding saturation-kernel instance.
\end{enumerate}
