...
**Gating item 2 (downstream — δ_strain magnitude, thermal closure).** With Gating item 1 resolved at Class B substrate-mechanism manifestation level via Q-EMBED-SEL-1, the cold-lattice asymptote $\alpha^{-1}_{\text{ideal}} = 4\pi^3 + \pi^2 + \pi$ requires the CMB-strain bridge $\delta_{\text{strain}}$ to recover CODATA at $T_{\text{CMB}}$. The structure (existence + sign) is substrate-predicted; the magnitude is one back-substituted scalar pending Q-DELTA-MAP-1-quant (see below). The δ_strain thermal closure + Class 2 lift candidate workstream (Phase 1 result §7.3) are the two residual workstreams to lift the framework from "Class B substrate-mechanism manifestation zero-parameter" to "Class 2 axiom-emergence absolutely zero-parameter".
...
- _Specific Claims_
  ...
  - **Fitted (one scalar at $T_{\text{CMB}}$):** the numerical magnitude $\delta_{strain} \approx 2.225 \times 10^{-6}$ is back-subtracted from CODATA, definitional given the engine's `DELTA_STRAIN = 1 - (1/ALPHA)/ALPHA_COLD_INV`. The substrate-mechanism class for this loading is **identified** as Cosserat-rotation-sector mass-gap thermal-mode-population ASYM (Q-DELTA-MAP-1 closed at mechanism-class identification 2026-05-28; canonical leaf [`delta-strain-cosmic-tcc.md`](../vol3/cosmology/ch05-dark-sector/delta-strain-cosmic-tcc.md), clm-hp7nlm). The remaining open item is **Q-DELTA-MAP-1-quant**: quantitative substrate-statistical-mechanics derivation of $\eta_\varepsilon$ within the now-identified mechanism class — not a derivation of magnitude yet.
...
- _Specific Non-Claims and Caveats_
  - Does NOT claim full ab-initio derivation of the CODATA $\alpha$ from axioms alone in the current edition. The claim is "structurally zero-parameter conditional on thermal closure of $\delta_{strain}$ at $T_{\text{CMB}}$" — the magnitude of $\delta_{strain}$ is an open substrate-physics derivation. Q-DELTA-MAP-1 (substrate-saturation-class identification for low-amplitude electromagnetic thermal-bath loading) is **closed at mechanism-class identification** 2026-05-28 via the Cosserat-rotation-sector mass-gap thermal-mode-population ASYM mechanism canonical at [`delta-strain-cosmic-tcc.md`](../vol3/cosmology/ch05-dark-sector/delta-strain-cosmic-tcc.md) (clm-hp7nlm). The remaining open item is **Q-DELTA-MAP-1-quant**: quantitative substrate-statistical-mechanics derivation of $\eta_\varepsilon$ from substrate E-mode dispersion + Bose-Einstein occupation at $T_{CMB}$ within the now-identified Cosserat-Curie ASYM mechanism class. (See [`research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md`](../../../research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md) §3 for the three original candidate paths P1/P2/P3 surfaced via the WALK-BACK; clm-hp7nlm hosts the fourth path P4 emerged via Grant adjudication.)
...
- strengthen-by:
  ...
  - **Q-DELTA-MAP-1-quant** (NEW post-2026-05-28): close the quantitative substrate-statistical-mechanics derivation of δ_strain magnitude at $T_{CMB}$ within the now-identified Cosserat-rotation-sector mass-gap thermal-mode-population ASYM mechanism (canonical at [`delta-strain-cosmic-tcc.md`](../vol3/cosmology/ch05-dark-sector/delta-strain-cosmic-tcc.md), clm-hp7nlm) — supersedes the prior Q-DELTA-MAP-1 mechanism-class-adjudication item now closed at mechanism-class identification level 2026-05-28 via `ave-ee-first-mapping` v1.0 + Grant adjudication. The remaining gap is the substrate-statistical-mechanics computation of $\eta_\varepsilon$ from substrate E-mode dispersion at $T_{CMB}$; closing the magnitude derivation lifts δ_strain from back-subtracted-fitted to substrate-derived, closing the cold-lattice → CODATA bridge.
