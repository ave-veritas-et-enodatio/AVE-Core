...
- The framework is zero-parameter at **Class B substrate-mechanism manifestation level per Q-EMBED-SEL-1 Phase 1+2+3 (2026-05-31)** (see [Ch.8 §"Substrate-mechanism provenance of regime (c)"](./ch8-alpha-golden-torus.md)): $\alpha^{-1}_{\text{ideal}} = 4\pi^3 + \pi^2 + \pi$ derives from Golden Torus geometry (Ch.8) via Axiom-4 self-saturation + Op14 Meissner-asymmetric + named phasor-area-equals-Nyquist-cell-area identification (cross-particle and cross-domain universal), and $\ell_{node}$ and $G$ are also derived; one currently-fitted thermal scalar bridges the cold-lattice asymptote to CODATA. Two residual workstreams remain: (1) Class 2 lift candidate workstream (derive the phasor↔real-space area bijection from K4 + Cosserat primitives alone, per Phase 1 result §7.3) + (2) quantitative thermal closure of $\delta_{strain}$ at $T_{CMB}$. The thermal-bath substrate-mechanism class is identified as Cosserat-rotation-sector mass-gap thermal-mode-population ASYM (Q-DELTA-MAP-1 closed at mechanism-class identification 2026-05-28; canonical at [`delta-strain-cosmic-tcc.md`](../vol3/cosmology/ch05-dark-sector/delta-strain-cosmic-tcc.md), clm-hp7nlm); **Q-DELTA-MAP-1-quant** (quantitative substrate-statistical-mechanics derivation of $\eta_\varepsilon$) remains open — see [`research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md`](../../../research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md) §3 for the 2026-05-27 Phase 3-A3 WALK-BACK history. One-cosmological-parameter framework ($\Omega_{\text{freeze}}$) with three-route framework commitment ($\alpha + G + \mathcal{J}_{\text{cosmic}}$ converging on $u_0^*$).
