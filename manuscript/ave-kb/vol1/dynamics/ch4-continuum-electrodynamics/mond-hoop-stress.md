...
- Substrate: $v_{substrate} = \alpha c/(2\pi)$ is the **approximate magnitude prediction** (NOT a strict floor — FLOOR interpretation tested 2026-05-17 late evening and falsified by Toomre-stratified halo data, see [`preferred-frame-and-emergent-lorentz.md` §5](preferred-frame-and-emergent-lorentz.md) "Magnitude interpretation iteration"). Gaia DR3 thin-disk cluster at 375 km/s (9% above prediction, direction 2.75° from CMB-dipole — STRONG positive directional signature stands). Magnitude gap reflects LSR-class cosmic-flow participation, not scale-invariance violation.
