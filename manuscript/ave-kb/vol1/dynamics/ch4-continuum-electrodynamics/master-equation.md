...
> **↗ G2 DISSOLUTION — the mass-gap hedge and the rest-mass store are DIFFERENT questions; no conflict post-relabel (2026-07-03, KEEP-BOTH — all notes above PRESERVED unedited; ruling `research/2026-07-03_g2-photon-relabel_note.md`, Grant-adjudicated).** The DRIVER-VALIDATION CAVEAT (cross-linked at [`cosserat-mass-gap.md:149,151`](../../axioms-and-lattice/ch1-fundamental-axioms/cosserat-mass-gap.md)) hedged that "mass = A1" is a grade-assignment while the Verlet driver *attributes the mass-gap to the $T_2$/$\omega$ rotational sector" — reading as if the driver's $\omega$ mass-gap challenged the A1-mass assignment. **Post-G2-relabel this apparent tension DISSOLVES:** the ruling separates the two objects the symbol "mass" was straddling —
...
> - the **electron's REST-ENERGY store** is the **A1 breather / dilatation depression** (this leaf line 20; `mass = A1`, PR#260) — the trapped acoustic compression energy. Orthogonal ($A_1 \perp T_2$) to the rotational band gap.
> These are **different physical questions** (a mechanical band-gap frequency of the $\omega$ sector vs the A1 energy store), not two answers to one question — so the Verlet driver measuring the $\omega$ band gap does **not** challenge the A1-mass assignment. **`mass = A1` (PR#260) stands unchallenged.** The relabel *sharpens* the hedge rather than overturning it: the driver measures the mechanical Cosserat gap (real, on the $\omega$ sector); the rest-mass store is the A1 breather (grade-assigned). The photon, per the same ruling, is neither — it is the massless transverse-*translational* $u$ pair (decisive numbers at `g2_photon_eigvec_composition.json`: massless $u$-frac $=1.000000$).
...
2. **Particle Assembly ($V \to 43.65\text{ kV}$):** The non-linear regime divides into two distinct saturation symmetries (per Axiom 4 confinement theorem):
   ...
   > **🔴 LOCALIZATION SCOPING (2026-06-24, Rule 12 — body above PRESERVED unedited).** The clause "the accelerating wave **reflects off its own self-induced impedance boundary, trapping into a … knot … generating invariant rest mass**" must be read as **boundary/topological localization** (the surviving route), **NOT** as an autonomous **bulk self-focusing well**. The Stage-2 native-cage make-or-break ([`research/2026-06-24_engine-stage2-native-cage_result.md`](../../../../../research/2026-06-24_engine-stage2-native-cage_result.md)) returned energy-certified **MODE-III DISPERSE**: a seeded sech does NOT self-focus into a persistent bound core on the native K4 stencil (WITH c_eff(V)). So the **bulk-self-focus LOCALIZATION is FALSIFIED** (Cartesian-grid artifact, RULED OUT); the A1 cage is pinned by the **(2,3) winding + H_couple + the Γ=−1 boundary cavity**, not by autonomous bulk self-focus. **mass = A1 (lines 20/25, PR#260) is UNTOUCHED** — only the WHAT-LOCALIZES clause reframes; the mc² = E_reactive identity stands.  <!-- rule12-freeze: base=4f8721e456712b08a62153151dc3ee78fd787a56 region=above offset=0 lines=1 bytes=495 sha256=a8aa4a8fde58147951fa27dac1e9e6370e5dd71f9c5b973c4f397a03106923b0 -->
   >
   > 🔴 **LOCALIZER RELABEL (2026-06-24 second pass, Rule 12 — supersedes "the A1 cage is pinned by the (2,3) winding + H_couple" above; body preserved).** The "winding + H_couple pin the A1 cage" attribution predates the **S3 cavity-pinning result (DISPERSE-FALSIFIED) + the coupled eigensolve (#415)** and the **phase-space coupling-winding BREAK (#417)**. Both internal dynamical loci now NEGATIVE: winding + H_couple + the Γ=−1 cavity does **NOT** pin the dispersing A1 core (centroid spread grows ON and OFF; the phase-space orbit carries the carrier ratio, not the (2,3)). The surviving **localizer is the Γ=−1 boundary CAVITY-eigenmode** (fork-b A1 mass cavity EXISTS); the **(2,3) winding RIDES the cage as STATIC charge** (`Link(∂Ω,F)∈ℤ`, un-walked-back), it does not pin the mass. The locus ruling: **A1 mass = DYNAMICAL @ V_snap; (2,3) = Link STATIC charge @ V_yield** (two orthogonal sectors, :20 anchor). **mass = A1 (#260) UNTOUCHED.** See the epic summary `research/2026-06-24_engine-reroute-epic-summary.md`.  <!-- rule12-freeze: base=4c5a2201c275c10eda3459628ce6fe1f0239b89d region=above offset=0 lines=1 bytes=5 sha256=920f4208f328092edd0b1113ab3e95242cd2cda1cc85d8e439edaca2ac28cc0a -->

   > 🟡 **EVIDENTIARY-EXPOSURE POINTER (2026-07-03, verdict-exposure sweep — status-demotion, NOT retraction).** The Stage-2 / S3 / #415 / #417 evidence the two localization banners above lean on is now **HIGH/MEDIUM-exposed** (diamond `TETRA_OFFSETS` `L_D` nullspace-heavy / sublattice-decoupled; DISPERSE positive control on the *Cartesian* engine; #417 (2,3) verdict on an achiral host) and **UNDER RE-ADJUDICATION**. This affects only the empirical basis for the *localizer relabel*; the **mc² = E_reactive identity and mass = A1 (#260) remain UNTOUCHED**. See [`research/2026-07-03_engine-verdict-exposure-sweep_result.md`](../../../../../research/2026-07-03_engine-verdict-exposure-sweep_result.md).
...
- **`:20`** — **NOT STAMPED — R39 BYTE-FENCE ROUTED** (the anchor sits inside a Rule-12 preserved body — `:40` declares *"all notes above PRESERVED unedited"* and `:36` *"bullets above PRESERVED unedited"*, so this dated note is itself fenced; this entry IS the routed ledger note and the span is byte-untouched). *(family: electron-interior-label)*  ⚑ **BIAS-DEBT** · ⚑ **PAST-WALL**  <!-- rule12-freeze: base=67c146bad89d3259c0832709c9478fd4569469f7 region=above offset=5 lines=50 bytes=4482 sha256=9141b7e3dba0cc4b3b999543682d71fcdd942eed737380378dbb0070c5a8da9c -->
...
- **`:26`** — **NOT STAMPED — R39 BYTE-FENCE ROUTED** (the anchor sits inside a Rule-12 preserved body — `:40` declares *"all notes above PRESERVED unedited"* and `:36` *"bullets above PRESERVED unedited"*, so this dated note is itself fenced; this entry IS the routed ledger note and the span is byte-untouched). *(family: P-branch-propagates)*  ⚑ **BIAS-DEBT**  <!-- rule12-freeze: base=67c146bad89d3259c0832709c9478fd4569469f7 region=above offset=0 lines=10 bytes=1405 sha256=88c36e87a03596a7e01c9ee1b57181002d303a38d44429c31ed616727b2ddb32 -->
  Quoted claim (content verified at HEAD; markup-reduced from the banked audit):
  ```text
