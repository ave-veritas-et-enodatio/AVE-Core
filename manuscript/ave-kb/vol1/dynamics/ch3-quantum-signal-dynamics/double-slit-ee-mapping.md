...
- **Soliton self-lock / autoresonance at $\Gamma=-1$ is underived** (✗ GAP, [translation-circuit.md](../../../common/translation-tables/translation-circuit.md):207 (Autoresonance row, "GAP — not mapped"), :222 (gap-finding §)). The defect's stable confinement is asserted from the saturation mechanism, not yet derived from an autoresonance / self-lock argument.
