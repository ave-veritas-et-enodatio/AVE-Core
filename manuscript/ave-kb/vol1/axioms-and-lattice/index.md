...
<!-- kb-frontmatter
kind: index
subtree-claims: [clm-15nwqy, clm-219e8j, clm-2dwzib, clm-3kzmt9, clm-4mmwb6, clm-5xon03, clm-7pvh9i, clm-9gh0a1, clm-9s9apq, clm-dfaiwj, clm-dhvhwi, clm-g0mkne, clm-gx1mpl, clm-jz0xaw, clm-kmliqx, clm-q39qct, clm-rkisb8, clm-sw5oao, clm-u1o2lo, clm-unk0bd, clm-ys0xl1]
subtree-experiments: []
-->
...
| Macroscopic Hardware Action | $\mathcal{L}_{node} = \frac{1}{2}\epsilon_0 \|\partial_t \mathbf{A}_n\|^2 - \frac{1}{2\mu_0} \|\nabla \times \mathbf{A}_n\|^2$ |
...
| True Planck Length | $\ell_{P,true} = \hbar/(m_e c) = \ell_{node}$ |
