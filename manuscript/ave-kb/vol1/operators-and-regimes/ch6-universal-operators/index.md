...
| [K4 4-Port Irrep Decomposition ($A_1 \oplus T_2$)](./k4-port-irrep-decomposition.md) | K4 4-port amplitude space under $T_d$: $A_1$ (1D scalar/longitudinal, $+1$ eigenvalue, dissipates via Gauss's law) $\oplus$ $T_2$ (3D transverse/microrotational, $-1$ triply degenerate, survives as photon); empirical $\{1.65, 1.22, 1.13, 0.00\}$ port-correlation eigenvalues; $A_1$/$T_2$ ↔ Cosserat $u$/$\omega$ sector mapping |
