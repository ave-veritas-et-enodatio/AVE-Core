...
> **Kernel vs Op19 (2026-08-28; [`def-ln3str`](../../../common/vocabulary-register.md)).** Solar and white-dwarf rows are Regime I for the **Ax4 kernel** (hop $L,C$ from the kernel are constant). The gravitational index still grades as $n=1+\nu_{\mathrm{vac}}\varepsilon_{11}$ (Op19) inside that same band. Do not read "Regime I" as "$L,C\propto\varepsilon_{11}$." Assembly: [`hop-lc-constitutive-grading.md`](../../../vol3/gravity/ch03-macroscopic-relativity/hop-lc-constitutive-grading.md).
