...
SUPPLEMENT: list[tuple[str, int, str]] = [
    ...
    ("../vol3/cosmology/ch15-black-hole-orbitals/bulk-impedance-at-saturation-boundary.md", 48,
     "row 1: ', :48-55 (the four-channel table)' continues the :51 link"),
    ("../vol3/cosmology/ch15-black-hole-orbitals/bulk-impedance-at-saturation-boundary.md", 55,
     "row 1: range endpoint of ':48-55' (was ':48-54' before the 2026-08-05 row-4 insert)"),
...
QUOTES: list[Quote] = [
    ...
    Quote("Q13", KB + "vol3/cosmology/ch15-black-hole-orbitals/bulk-impedance-at-saturation-boundary.md", 55,
          r"""**BH-echo yes/no is therefore a channel question.**""",
          r"""**BH-echo yes/no is therefore a channel question.**""",
          "EXACT"),

    Quote("Q14", KB + "vol3/cosmology/ch15-black-hole-orbitals/bulk-impedance-at-saturation-boundary.md", 55,
