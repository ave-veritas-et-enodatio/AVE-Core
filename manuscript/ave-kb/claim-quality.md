...
- confidence: 0.85
- depends-on:
  - clm-0ktpcn — Golden Torus α Derivation (solidity 0.50) [for $H_\infty$'s $\alpha^{-2}$ factor]
  - clm-5xon03 — Zero-Parameter Closure Status (solidity 0.50) [for the consistency-proof framing of $H_\infty$ vs $G$]
