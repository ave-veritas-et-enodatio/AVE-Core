...
- **1 observable (leading $g = 2$ value)** is **POSITED** (the imported Dirac value), not axiom-derived. The double-cover forces spin-½; it does not fix $\mu/S$. See the $g = 2$ row above for the proton/neutron decisive falsifier.
