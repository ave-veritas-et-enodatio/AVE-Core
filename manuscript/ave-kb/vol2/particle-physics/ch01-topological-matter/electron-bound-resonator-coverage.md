...
$\gamma$-imported-by-construction).
...
| $g=2$ (gyromagnetic) | **B** (winding-sector) | clm-uatcql | FORM=chord (double-cover ratio) / VALUE=N/A | NOT cage-testable — magnetic moment = Cosserat-B winding sector |
