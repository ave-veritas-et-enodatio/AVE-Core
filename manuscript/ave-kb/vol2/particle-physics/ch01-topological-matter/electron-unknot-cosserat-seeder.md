...
| Master Equation FDTD | **Mode I PASS** — engine autonomously hosts breathing soliton (4/4 acceptance criteria on breathing-appropriate Test 1b per [Breathing Soliton v14 Mode I PASS](../../../vol1/dynamics/ch4-continuum-electrodynamics/breathing-soliton-v14-mode-i.md)) 🔴 **[DEMOTED 2026-08-11 — R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]** |
...
- **`:113`** — stamped at `:113`. *(family: engine bulk-cage receipt; banked `uncertain`)*
  Quoted claim (content verified at HEAD; markup-reduced from the banked audit):
  ```text
  **Mode I PASS** — engine autonomously hosts breathing soliton (4/4 acceptance criteria on breathing-appropriate Test 1b
  ```
  Audited rationale, verbatim from the banked worklist:
  ```text
  A BREATHING (dilatational-oscillation) soliton hosted by the Master-Equation FDTD engine, whose restoring force is the coded compressibility — engine receipt rides the phantom; the seeder protocol and topology-preservation content survive. Uncertain: label-level vs receipt-void routing for a superseded historical result.
  ```
