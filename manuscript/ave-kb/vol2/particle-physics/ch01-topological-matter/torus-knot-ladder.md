...
**Stale-value fix (2026-06-19):** the $9_1$ ($c=9$) row above was updated $\Delta(1620) \to \Delta(1600)$ to match the adjudicated 2026-05-18 walk-back on the canonical ch02 baryon leaf ([`../ch02-baryon-sector/torus-knot-ladder-baryons.md`](../ch02-baryon-sector/torus-knot-ladder-baryons.md), "Stale-framing correction (2026-05-18 walk-back)"; both carry `clm-k6olj8`). The driver `baryon_ladder_pdg_2024_anchor.py` confirms $(2,9)\to\Delta(1600)$ at $+0.779\%$. *(Note for adjudication, flag-not-fix: the $c=11$ / $c=13$ rows here read $\Delta(1950)$ / $N(2250)$ whereas the ch02 canonical table + driver give $\Delta(1900)$ / $N(2190)$ — surfaced, not silently rewritten, pending review.)*
