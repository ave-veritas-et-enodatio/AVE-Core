...
| Spin-½ | Same Cosserat microrotation + Finkelstein-Misner mechanism as electron and proton (Ax1); composite spin = $\frac{1}{2}_p + \frac{1}{2}_e$ angular-momentum-coupled to net ½ | ⚠ STRUCTURE axiom-derived / SELECTION posited (inherits electron structure/selection split, clm-rkisb8) | Inherits from `proton-identification.md` and electron-identification structural inheritance pattern |
