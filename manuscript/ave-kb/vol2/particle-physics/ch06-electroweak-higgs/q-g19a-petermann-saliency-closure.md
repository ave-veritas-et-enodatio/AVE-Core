...
>
> - **Its three ppm labels are STRUCK.** Quoted verbatim so the strike is auditable: *"$\approx \mathbf{61\ ppm}$, not 50 ppm"*; *"**~158 ppm** vs PDG"*; *"the printed digits give 61 ppm; the headline says 50 ppm; the live driver gives ~158 ppm"*. **None is replaced by another ppm number** — see the ppm-strike block below for the ruling and the two limiters.
