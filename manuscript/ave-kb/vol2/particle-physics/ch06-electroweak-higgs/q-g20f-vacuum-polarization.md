...
- **Sibling leafs:**
  - [Q-G19α Petermann (printed-precision, postulate-conditional)](q-g19a-petermann-saliency-closure.md) — electron anomalous moment matches QED to printed precision **[ppm label struck 2026-08-03 per Grant ruling; no ppm number substituted]** **only conditional on the $n_q$-additivity postulate**; the parameter-free symmetric Route B forward is $+4.0\%$ off PDG (sister loop-level closure)
