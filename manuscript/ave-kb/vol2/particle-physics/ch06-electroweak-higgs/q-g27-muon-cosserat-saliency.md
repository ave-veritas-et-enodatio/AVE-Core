...
- **Sibling leafs (same chapter):**
  - [Q-G19α Petermann + saliency closure (electron; $+4.0\%$ parameter-free, printed-precision postulate-conditional)](q-g19a-petermann-saliency-closure.md) — the universal Petermann derivation that this leaf extends with Cosserat torsion (Stage 1 symmetric Route B forward is $+4.0\%$ off PDG; the Stage-2 figure is conditional on the $n_q$-additivity postulate, and carries no defensible ppm label **[ppm label struck 2026-08-03 per Grant ruling; no ppm number substituted]**)
