...
**Provenance pin (A47 v11c):** values above generated by `ave.solvers.radial_eigenvalue.ionization_energy_e2k(Z)` at parent-repo SHA `0401388` (2026-04-09). Reproduced at AVE-Core HEAD to ≤0.21% via Q1+Q3+Q4+Q5+Q6 surgical restoration arc (commits `4c5035d`, `6783711`, `01f4f90`). CI gate at ±0.5% via [`src/scripts/vol_1_foundations/verify_atomic_ie_manuscript_table.py`](../../../../../src/scripts/vol_1_foundations/verify_atomic_ie_manuscript_table.py) + [`src/tests/test_radial_eigenvalue.py::TestManuscriptTableReproducibility`](../../../../../src/tests/test_radial_eigenvalue.py). Full provenance chain at [`numerical-provenance-manifest.md`](../../../common/numerical-provenance-manifest.md).
