...
- **Macroscopic Bulk Density:** 🔴 *[engine-lockstep re-pin 2026-08-03, Rule 12; prior value preserved]* $\rho_{bulk} = \frac{\xi_{topo}^2 \mu_0}{p_c \, l_{node}^2} \approx$ ~~$7.92 \times 10^6$~~ **$7.91 \times 10^6$** kg/m$^3$ **(re-pinned to `constants.py` `RHO_BULK` $= 7{,}909{,}692.74$ kg/m³; the formula is unchanged and recomputes bit-identical, so the drift was transcription-only — receipt at [`vol1/dynamics/ch4-continuum-electrodynamics/lc-electrodynamics.md`](../../../vol1/dynamics/ch4-continuum-electrodynamics/lc-electrodynamics.md):35)**
