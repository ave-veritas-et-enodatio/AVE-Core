...
| Result | Expression |
|---|---|
| Golden Ratio | $\varphi = (1+\sqrt{5})/2$: forced by Thomson problem at $N=12$ (icosahedron) |
| Fibonacci proxy | Converges to $\varphi$; achieves $<0.5\%$ mass accuracy across 105 elements |
...
| Document | Contents |
|---|---|
| [The Golden Ratio: Minimum Impedance at 12 Nodes](golden-ratio-min-impedance.md) | Thomson problem, icosahedral Cr-52 solution at $R_{\text{ico}} = 166.5\,d$ |
| [The Fibonacci Sequence: Convergent Ratio as Packing Proxy](fibonacci-packing-proxy.md) | Fibonacci lattice as icosahedral approximation; $<0.5\%$ accuracy across 105 elements |
| [Pi and the Topological Horizon](pi-topological-horizon.md) | Boron-11 halo at $4\pi - \sqrt{2}/2$; Gauss's law origin |
