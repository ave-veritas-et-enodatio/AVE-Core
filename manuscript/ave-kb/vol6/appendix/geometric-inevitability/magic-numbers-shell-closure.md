...
> ↗ See also: [Universal Packing Reflection](../../../vol1/operators-and-regimes/ch6-universal-operators/packing-reflection.md) — impedance matching operator driving shell closure

## Nuclear Magic Numbers: Shell Closure as Impedance Matching
...
| Magic $Z$ | $N_\alpha$ | Geometry | Structural Meaning |
|---|---|---|---|
