...
## The Core Proximity Effect ($398d$ vs $50d$)
...
By mapping the empirical CODATA nuclear mass of Sodium-23 ($21409.214$ MeV) across the semiconductor junction model, the optimization engine locates $R_{halo} = 50.2d$ as the single fitted inter-cluster scalar that reproduces the mass under the $(Z,A)$-forced Neon-20 + Tritium topology, placing the Tritium triangle directly above the Neon-20 Bipyramid's North Pole.

- **Fluorine-19 ($R_{halo} = 398d$):** The $4\alpha$ core is relatively small and weakly inductive. The Tritium halo is violently repelled far out into space, creating a massive, unstable $\sim335$ fm reactive whip. Thus, Fluorine acts as a profound receiver.
