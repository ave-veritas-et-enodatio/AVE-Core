...
Because the four discrete $6^3_2$ topological defects lock into a perfectly symmetrical tetrahedron, Helium-4 acts conceptually identically to a **Polyphase Resonant Transformer** in classic Electrical Engineering.
...
[Figure: circuit_he4.pdf — see manuscript/vol_6_periodic_table/figures/]

**Equivalent EE Circuit for Helium-4.** A symmetrically balanced, 4-node fully-coupled polyphase inductive network. The identical mutual coupling $M$ minimizes the total network impedance, resulting in extreme stability.
