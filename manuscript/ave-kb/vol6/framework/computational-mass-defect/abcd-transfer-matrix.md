...
<!-- claim-quality: clm-nk6c43 (this $Z \ge 15$ heavy-element regime is precisely the catalog-tier where the Fibonacci-proxy / per-nucleus-$R$-fit machinery is in use; the ABCD cascade is the targeted replacement) -->
