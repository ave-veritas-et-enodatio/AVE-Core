...
<!-- claim-quality (subtree): enjq28, r6uef4 -->
...
| Document | Contents |
|---|---|
| [Protein Folding Terminology](./translation-protein.md) | tab:trans_protein; 16-row mapping: structural biology $\leftrightarrow$ transmission line / circuit theory $\leftrightarrow$ AVE derivation |
| [Protein Solver Domain Translation](./translation-protein-solver.md) | tab:trans_protein_solver; biology $\to$ EE/RF $\to$ AVE Axiom $\to$ script reference; includes solver methods |
