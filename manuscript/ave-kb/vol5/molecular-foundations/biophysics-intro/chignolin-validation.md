...
<!-- claim-quality: clm-a3rby3 (this engine validation runs the protein-folding $S_{11}$ free-energy functional — Vol 5's namespace-collision use of $S_{11}$ vs the EE reflection-coefficient meaning is flagged in the cross-cutting notation-hazard entry) -->
