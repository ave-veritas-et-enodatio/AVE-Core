...
<!-- claim-quality: 4jy0t8 (the "fixed frequency scale" used here is the batch-SPICE backbone result — primary 1192 cm$^{-1}$ notch shared across 18/20 amino acids — that this falsification test relies on as its underlying reference) -->
