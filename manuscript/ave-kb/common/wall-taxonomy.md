...
> [`2026-08-06-ruling-kernel-collapse-rescope-v2.md`](../../../_orchestration/docket-entries/2026-08-06-ruling-kernel-collapse-rescope-v2.md):13–29,
...
> **⚑ What this repair does NOT do.** It adjudicates no member, prefers no member, and promotes the
> engine's coded choice to nothing. The operational rule below is unchanged: *"Row 4 is unwalled at
> $r_{sat}$"* remains a claim conditional on the separate-kernel member. The fence moving from this leaf
> into the ruling changes WHERE the condition is carried, not WHETHER it applies.
>
