...
- **NEW 2026-05-17 evening — Substrate kinematic viscosity contradiction (corpus bug, flag-worthy regardless of DAMA):** [`src/ave/core/lbm_3d.py:10,91`](../../../src/ave/core/lbm_3d.py) defines `ν_kin = (1/(4π)) × ℓ_node × c` while [`src/ave/core/constants.py:554-555`](../../../src/ave/core/constants.py) + [`manuscript/backmatter/02_full_derivation_chain.tex:673-678`](../../../manuscript/backmatter/02_full_derivation_chain.tex) define `ν_kin = α × c × ℓ_node`. These differ by factor `1/(4πα) = 137/(4π) ≈ 10.9×`. Two of three canonical files agree on αcℓ; lbm_3d.py disagrees. **Open audit**: which is canonical? Affects substrate-fluid-dynamics derivations downstream of lbm_3d. Surfaced via corpus-grep during DAMA α-slew (1+1/(4π)) speculation verification.
