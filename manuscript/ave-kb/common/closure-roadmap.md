...
- **DAMA amplitude formula derivation** — TWO foundational physics-judgment calls block solo derivation per [`research/2026-05-17_C14-DAMA_amplitude_prereg.md`](../../../research/2026-05-17_C14-DAMA_amplitude_prereg.md): (Q1) operator choice — bulk density vs transverse shear modulus (corpus inconsistent across vlbi-impedance vs bullet-cluster framings; predicts materially different DAMA-vs-CDMS-vs-COSINE ratios); (Q2) frame choice — 232 km/s galactic vs 370 km/s CMB-dipole (corpus inconsistent across bullet-cluster vs preferred-frame-and-emergent-lorentz framings). Awaits Grant adjudication.
