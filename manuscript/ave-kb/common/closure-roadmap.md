...
- **Bullet-cluster offset distance derivation** (C13b row): FDTD driver shows $g_{eff} - g_N$ wake but no quantitative offset magnitude; needs derivation from TT-tensor shockwave on Gordon metric.
