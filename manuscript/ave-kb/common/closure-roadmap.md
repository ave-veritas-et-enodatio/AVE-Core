...
| 2 | **Q-G47 Session 6+ keystone u_0* derivation** | **Session 6 LANDED 2026-05-15** + **A-032 + A-033 structural-hypotheses** (χ_K = 12; (p,q)↔K4 irreps); **ave-prereg corpus-grep audit 2026-05-15 evening** found ~60-70% already-closed in corpus (docs 22, 25, 30, 03 verify K4 group theory, A_1⊕T_2 decomposition, (2,3) knot uniqueness, α^-1 = 4π³+π²+π full derivation). Sessions 7-10 SCOPE REDUCED to ~3-5 sessions; remaining work bounded to: Cosserat μ_c derivation (Session 3 §8 honest-scope statement), per-path γ_per-path, electron in E⊗T_2 verification, α^-1 irrep mapping, T vs T_d ambiguity resolution. | Q-G47 / A-027 / A-029 / A-030 / A-032 / A-033 | (this commit) |
