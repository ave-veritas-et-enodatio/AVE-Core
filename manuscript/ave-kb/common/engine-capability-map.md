...
### §8c.8 — RULING 22 (Grant in-chat 2026-07-19): KEEP THE INSTRUMENT (Grant-ruled); DOS-BALANCE = recommended direction, design-walk IN PROGRESS
...
| **DOS-balance on the existing instrument** | **RECOMMENDED DIRECTION** (orchestrator; Grant engaged the design walk — **upgrade-to-RULED pending the walk's outcome**; attack the equipartition root by balancing mode counts) |
