...
- **status:** proposed — inherits the def-tk1xfm status. Verbatim ([`substrate-native-terminology.md`](substrate-native-terminology.md):17): *"the `def-tk1xfm` node is **proposed**, PR #265"*; the TKI transducer carries an *"identity-by-translation, NOT a derivation"* ceiling (ceiling from `def-tk1xfm` (:430, fuller form "identity-by-translation, NOT emerges-from / NOT a derivation"); exact short-form at `def-portmp` (:496)). **NOT canon.**
