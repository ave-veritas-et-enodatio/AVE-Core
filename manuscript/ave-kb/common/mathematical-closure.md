...
- $\delta_{strain} \approx 2.225\times 10^{-6}$ — **status: structure predicted (existence + sign of α thermal running below cold-lattice asymptote); magnitude at $T_{CMB}$ is one currently-fitted scalar** (back-subtracted from CODATA, pending quantitative substrate-physics derivation). Q-DELTA-MAP-1 (substrate-mechanism class identification) **closed at mechanism-class identification** 2026-05-28 via Cosserat-rotation-sector mass-gap thermal-mode-population ASYM (canonical at [`vol3/cosmology/ch05-dark-sector/delta-strain-cosmic-tcc.md`](../vol3/cosmology/ch05-dark-sector/delta-strain-cosmic-tcc.md), clm-hp7nlm); the remaining open item is **Q-DELTA-MAP-1-quant** (quantitative substrate-statistical-mechanics derivation of $\eta_\varepsilon$ within the now-identified mechanism class). See [`research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md`](../../../research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md) §3 for the 2026-05-27 Phase 3-A3 WALK-BACK + original three candidate substrate-mechanism paths P1/P2/P3. Same predicted/fitted pattern as Vol 6's R per nucleus. See [Vol 1 Ch 8](../vol1/ch8-alpha-golden-torus.md) disclosure.
...
- **$\alpha$ closure (Vol 1 Ch 8 Golden Torus):** $\alpha^{-1}_{ideal} = 4\pi^3 + \pi^2 + \pi$ at the cold-lattice asymptote, from the trefoil's three-regime decomposition. Acyclic if the Golden Torus geometry is established independently of $\alpha$'s measured value (the three regimes are individually grounded in the chapter; this can be checked separately). The thermal running $\alpha^{-1}(T) < \alpha^{-1}_{ideal}$ at $T > 0$ is a structural prediction (sign and existence). *Magnitude-derivation gap:* $\delta_{strain}$ at $T_{CMB}$ is currently back-subtracted from CODATA, definitional given the engine's `DELTA_STRAIN = 1 - (1/ALPHA)/ALPHA_COLD_INV`. The cold-lattice $\alpha$ closure itself is acyclic; the magnitude of the thermal correction is fitted (one scalar) pending quantitative substrate-physics derivation. Q-DELTA-MAP-1 (substrate-mechanism class identification) closed at mechanism-class identification 2026-05-28 via Cosserat-rotation-sector mass-gap thermal-mode-population ASYM ([`vol3/cosmology/ch05-dark-sector/delta-strain-cosmic-tcc.md`](../vol3/cosmology/ch05-dark-sector/delta-strain-cosmic-tcc.md), clm-hp7nlm); the remaining open item is **Q-DELTA-MAP-1-quant** (quantitative substrate-statistical-mechanics derivation of $\eta_\varepsilon$ within the mechanism class) — see [`research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md`](../../../research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md) §3 for the WALK-BACK history. Same predicted/fitted pattern as Vol 6 (predicted: structure; fitted: one scalar) — different physics, same disclosure shape.
...
|---|---|---|---|
| **δ_strain magnitude at T_CMB** | One fitted scalar (≈ 2.225×10⁻⁶) currently back-subtracted from CODATA. Structure predicted (existence + sign of substrate spatial-metric response to finite-$T$ photon-bath loading); magnitude pending. | Upgrades the α closure from "structure predicted, magnitude fit" to absolutely zero-parameter. Q-DELTA-MAP-1 (substrate-mechanism class identification) closed at mechanism-class identification 2026-05-28 via Cosserat-rotation-sector mass-gap thermal-mode-population ASYM ([`vol3/cosmology/ch05-dark-sector/delta-strain-cosmic-tcc.md`](../vol3/cosmology/ch05-dark-sector/delta-strain-cosmic-tcc.md), clm-hp7nlm); the remaining open item is **Q-DELTA-MAP-1-quant** (quantitative substrate-statistical-mechanics derivation of $\eta_\varepsilon$ within the now-identified mechanism class — compute substrate E-mode dispersion + thermal occupation at $T_{CMB}$, couple to substrate dielectric response, match to canonical $\eta_\varepsilon \approx 4.45 \times 10^{-6}$). The 2026-05-27 Phase 3-A3 WALK-BACK established that the prior "G_vac + equipartition" SM-vocabulary framing leaks classical thermal-expansion + heat-capacity equipartition mechanism onto a substrate-physics problem; the 2026-05-28 Grant adjudication via `ave-ee-first-mapping` v1.0 identified the Cosserat-Curie mechanism class. | [Vol 1 Ch 8](../vol1/ch8-alpha-golden-torus.md) §Status disclosure; this document §Back-edges; [`research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md`](../../../research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md) §3 |
