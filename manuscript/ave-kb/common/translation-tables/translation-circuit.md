...
| **Double-slit: transverse ponderomotive wake** ⚠ regime-tag | **near-field ponderomotive gradient $\propto\nabla\lvert\Psi\rvert^2$** (navigates the defect; through BOTH slits) — **NOT** the far-field thrust dark-wake $\tau^{\text{far}}_{zx}$ (line 139); same word "wake", different physics (near-field ponderomotive vs far-field reaction-momentum) | [`double-slit-ee-mapping.md`](../../vol1/dynamics/ch3-quantum-signal-dynamics/double-slit-ee-mapping.md) §3,§6 + [`ohmic-decoherence-born.md`](../../vol1/dynamics/ch3-quantum-signal-dynamics/ohmic-decoherence-born.md):11 |
