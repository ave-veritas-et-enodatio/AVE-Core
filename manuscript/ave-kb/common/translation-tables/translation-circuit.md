...
## §4.8 — Transmission-line MODE tier: the shear/bulk carve read as differential/common mode (2026-08-07 GW-formation walk + correspondence audit)
<!-- claim-quality: clm-eemap1 -->

**END-APPEND to the §4 tier stack; line-pin-safe (nothing above §4.8 is edited by this subsection).**
...
### §4.8.1 — Sweep first: the carve is PRIOR ART (do NOT re-mint; these rows re-express it)
...
### §4.8.2 — The means-tested rows (G1–G6; every row channel-subscripted)
...
- **No drive claim on the common-mode line, in either direction** — §4.8.3. This subsection does not soften, and does not re-open, the Q1 revert.
...
- **The R30 bench candidate is NOT landed as a row.** A dedicated bulk-channel receiver is a registered *bench candidate*, not a correspondence; it belongs to the bench-documentation pattern, not this catalog.
