...
| 23 | Dark resonance (near-field reaction) $\Sigma_{\text{near}}$ / $-\dot\Sigma_{\text{near}}$ | Armature-reaction-induced d/q saliency (QED self-energy analogue) → electron $g$-2 anomalous moment | $\checkmark$ **Route B forward $+4.0\%$ parameter-free**; the $g$-2 **printed-precision** closure is **postulate-dependent** **[ppm label struck 2026-08-03 per Grant ruling; no ppm number substituted]** (n_q-additivity = 1-point fit, not derivable — FT-b 2026-05-31) | [`q-g19a-petermann-saliency-closure.md`](../../vol2/particle-physics/ch06-electroweak-higgs/q-g19a-petermann-saliency-closure.md):221 verbatim: *"RESOLVED NEGATIVE (2026-05-31, FT-b saliency-derivability)"* (clm-v2sg8z) + [`dark-back-reaction-taxonomy.md`](../dark-back-reaction-taxonomy.md) |
