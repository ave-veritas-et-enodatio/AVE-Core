...
| **Uniform external field** | **Common-mode bias** — a uniform DC offset on the whole ladder (shifts every varactor's operating point together) | [`envelope-anatomy.md`](../envelope-anatomy.md); the §4 operating-point row above |
