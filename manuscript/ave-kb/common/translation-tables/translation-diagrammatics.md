...
- **α per vertex**: $Q_{tank} = 1/\alpha$ is a **definitional identity, never a derivation**
  (`physics-lineage-map.md:394`; the baked constant ruled culpable for the #41 circularity
