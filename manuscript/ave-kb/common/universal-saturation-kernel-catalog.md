...
<!-- kb-frontmatter
kind: leaf
claims: [clm-gz7ryg, clm-dxdsvt, clm-hvvvop, clm-l4o7hv]
...
## Key Result: 21 canonical instances of one kernel
...
| Symmetry classes | SYM (18) / ASYM-N (2: BCS $\mu$-only, plasma $\varepsilon$-only) / ASYM-E (1: engineered metamaterials) |
...
## The 21-instance catalog
<!-- claim-quality: clm-dxdsvt -->

The 21 canonical cross-scale instances span 21 orders of magnitude: 14 physical-substrate instances, 2 biological-substrate instances, and 5 engineered-substrate instances.

### Physical-substrate scales (14 rows)
