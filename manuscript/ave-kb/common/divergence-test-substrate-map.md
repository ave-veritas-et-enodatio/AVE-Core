...
| C13-VLBI-DARK | VLBI Gravitational Impedance Parallax (Jupiter-grazing radio for $377\Omega$ DM stretching) | C / existing-data | I | Dark matter IS continuous geometric stretching of $377\Omega$ vacuum impedance baseline. **FLAG (2026-05-16 audit during C18 cascade walk):** "$Z_0$ stretching" mechanism appears to contradict the achromatic-impedance-matching theorem at [`achromatic-impedance-matching.md:24`](../vol3/gravity/ch03-macroscopic-relativity/achromatic-impedance-matching.md) + [`z0-derivation.md:79`](../vol4/circuit-theory/ch1-vacuum-circuit-analysis/z0-derivation.md) which prove $Z_{local}(r) \equiv Z_0$ exactly (since $\varepsilon(r)$ and $\mu(r)$ both scale with $n(r)$ symmetrically). **Separate adjudication required:** is DM-as-Z_0-stretching the actual AVE mechanism, or is the C13 framing stale prose that needs replacement? If yes, what IS the AVE DM mechanism if not $Z_0$ stretching? | Ax1+Ax4 (**M**) — macroscopic-gravity-as-impedance dies; particulate DM survives axioms | Cascade: tight pair with C14-DAMA; co-load with A2-SAGNAC, C18-PROTOCOL-12 (now retired); **C13 itself has internal inconsistency with Vol 3 + Vol 4 invariant — needs adjudication before any forward-prediction status.** NULL = VLBI noise dominates → particulate DM unaffected. | U-D pending adjudication | **TBD pin $\Delta t$ magnitude** (KB leaf gives no numeric); also pending Z_0-stretching adjudication | [`../vol3/cosmology/ch05-dark-sector/multi-galaxy-validation.md` lines 24-28](../vol3/cosmology/ch05-dark-sector/multi-galaxy-validation.md); inconsistency flagged with [`../vol3/gravity/ch03-macroscopic-relativity/achromatic-impedance-matching.md:24`](../vol3/gravity/ch03-macroscopic-relativity/achromatic-impedance-matching.md) and [`../vol4/circuit-theory/ch1-vacuum-circuit-analysis/z0-derivation.md:79`](../vol4/circuit-theory/ch1-vacuum-circuit-analysis/z0-derivation.md) |
| C14-DAMA-MATERIAL | DAMA Parallax & Crystal Phonon Modulation (NaI vs Sapphire vs Ge $\kappa_{crystal}$) | C / both | I | DM wind modulates DAMA via bulk dielectric $\kappa_{crystal}$ coupling | Ax1+Ax4 (**C**) — Vol III dark-sector chapter dies; WIMP particulate resurrects | Cascade: tight pair with C13-VLBI-DARK; D4-A034 (Ax4 kernel). NULL = swapped-crystal amplitude scales with WIMP cross-section. | U-D | NaI / Sapphire / Ge densities cited; **no explicit amplitude formula — TBD pin** | [`../vol3/cosmology/ch05-dark-sector/multi-galaxy-validation.md` lines 30-34](../vol3/cosmology/ch05-dark-sector/multi-galaxy-validation.md) |
...
| Regime | Count | Tests |
|---|---|---|
| **I** (linear sub-yield) | 17 | A1, A2, B4, C3, C6, C7, C10, C11, C12, C13, C14, C15, C17, C18, C19, D1, D5 |
