...
| C18-PROTOCOL-12-GEO-SYNC | Protocol 12 — GEO-Sync Impedance Differential (16.7 mm laser TOF stretch) | C / new-exp | I | Vertical $\int n(r)/c \, dr$ impedance integration stretches ground↔GEO TOF beyond Shapiro | Ax1+Ax3 (**F**) — "definitively breaking Lorentz symmetry in favor of structural waveguide electrodynamics" | Cascade: tight pair with C11-MACH-ZEHNDER, C13-VLBI-DARK; touches C4-THREE-ROUTE (Route 2 = G via Machian impedance integral). **TBD-audit per cohesive-narrative §5 (2026-05-16):** does vertical-impedance-integration mechanism survive K4 cubic-symmetry suppression that retired C17? Vertical-integration is geometrically distinct from horizontal-anisotropy probe, but at optical wavelength $(q\ell_{node})^4 \sim 10^{-22}$ may still apply — open question. NULL = standard GR Shapiro holds (or AVE-predicted-null per pending audit). | U-D vs strict GR (pending cubic-symmetry-suppression audit) | **~16.7 mm** TOF stretch at $h = 35{,}786$ km (pending audit confirmation; may be suppressed by $\sim 10^{-22}$) | [`../vol4/falsification/ch11-experimental-bench-falsification/geo-synchronous-impedance.md` lines 4-8](../vol4/falsification/ch11-experimental-bench-falsification/geo-synchronous-impedance.md); cohesive narrative at [`../vol1/dynamics/ch4-continuum-electrodynamics/preferred-frame-and-emergent-lorentz.md`](../vol1/dynamics/ch4-continuum-electrodynamics/preferred-frame-and-emergent-lorentz.md) |
...
4. **Regime I cluster is heavy on Ax1-F kill-switches** — C6, C7, C15, C18 are single-shot framework-killers in the linear regime, meaning a single linear-regime null can take down major Ax1 derivations. **These are cheap to run and decisive — Regime I is the highest-leverage triage queue.** (C17 previously listed here but retired to corroborative-null status 2026-05-16 per cohesive-narrative audit — see [`../vol1/dynamics/ch4-continuum-electrodynamics/preferred-frame-and-emergent-lorentz.md`](../vol1/dynamics/ch4-continuum-electrodynamics/preferred-frame-and-emergent-lorentz.md).)
