...
4. **Regime I cluster is heavy on Ax1-F kill-switches** — C6, C7, C15, C17, C18 are all single-shot framework-killers in the linear regime, meaning a single linear-regime null can take down major Ax1 derivations. **These are cheap to run and decisive — Regime I is the highest-leverage triage queue.**
