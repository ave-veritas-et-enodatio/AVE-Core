...
| C3-MUON-DELTA | **SCOPE CORRECTION 2026-05-18 (Type D mechanism re-scope, full 6-skill audit)**: Muon $\delta$ has TWO COMPETING corpus derivations giving incompatible numerical predictions, gated on Foundation Item 13 (2,5)-ambiguity. Cannot drive until adjudicated. Specifically: (i) **Q-G19α** $\delta_\mu = -5\alpha/2 = -0.01824$ via $(2,5)$ topology + $n_q$-additive ladder (per [`q-g19a-petermann-saliency-closure.md:108`](../vol2/particle-physics/ch06-electroweak-higgs/q-g19a-petermann-saliency-closure.md:108)) — BUT Q-G19α itself disclaims this governs the Fermilab observable: *"muon g-2 dominated by Q-G27 Cosserat torsion saliency, different mechanism"*. (ii) **Q-G27** $\delta_\mu = -3\alpha/2 - \alpha\sqrt{3/7}/(2\pi) = -0.01171$ via $(2,3)$ trefoil preserved + Cosserat torsion excitation (per [`q-g27-muon-cosserat-saliency.md:48`](../vol2/particle-physics/ch06-electroweak-higgs/q-g27-muon-cosserat-saliency.md:48)). (iii) **Δ(1232)** $\delta = -7\alpha/2$ remains a Q-G19α prediction pending Foundation Item 13. **Electron $\delta_e = -3\alpha/2$ with $n_q = 3$ retains its 50 ppm PDG match** per Q-G19α (separate from this row's muon ambiguity). | C / **GATED (Foundation Item 13)** | I | Family-wide $n_q$-additivity claim under audit due to (2,5) topological assignment ambiguity (per [`torus-knot-uniqueness.md:106`](../vol2/particle-physics/ch01-topological-matter/torus-knot-uniqueness.md:106): three distinct corpus interpretations of (2,5) — muon vs proton vs neutrino mode-space) | Ax2+Ax3 (**C**) — $n_q$-additivity assumption AND/OR Cosserat-torsion alternative; Foundation Item 13 must resolve which mechanism is canonical | Cascade: C8 baryon ladder, A1 chiral antenna (both depend on $(2,q)$ classification). **C3 row CANNOT discriminate until FI-13 adjudication lands** — driver would produce ambiguous result (Q-G19α "match" at -0.018 vs Q-G27 "match" at -0.012 vs Fermilab consistency band). NULL = inconclusive without FI-13. | U-D for whichever mechanism survives FI-13; currently U-C between mechanisms | 50 ppm precision required to discriminate IF mechanism resolved; Fermilab Run-3 tension $+245(56) \times 10^{-11}$ matches Q-G27 prediction $+247 \times 10^{-11}$ to 0.8% but within ±23% measurement uncertainty (Run-4/5 ±10 ppm needed for true discrimination per [`q-g27:62-76`](../vol2/particle-physics/ch06-electroweak-higgs/q-g27-muon-cosserat-saliency.md:62)) | [`../vol2/particle-physics/ch06-electroweak-higgs/q-g19a-petermann-saliency-closure.md`](../vol2/particle-physics/ch06-electroweak-higgs/q-g19a-petermann-saliency-closure.md) + [`../vol2/particle-physics/ch06-electroweak-higgs/q-g27-muon-cosserat-saliency.md`](../vol2/particle-physics/ch06-electroweak-higgs/q-g27-muon-cosserat-saliency.md) + [`closure-roadmap.md:93`](closure-roadmap.md) (Foundation Item 13 entry, gating) |
...
| C3-MUON-DELTA | **GATED on Foundation Item 13** (2,5)-ambiguity resolution; preregistration cannot proceed until corpus disambiguates Q-G19α (2,5)-muon vs Q-G27 (2,3)+Cosserat-muon | spec-blocked pending FI-13 | no driver (would produce ambiguous result until FI-13 resolves which mechanism is canonical) | **PENDING ADJUDICATION** — both corpus derivations claim Fermilab consistency at current ±23% measurement uncertainty; cannot discriminate at this row until FI-13 resolves which AVE mechanism applies | open (FI-13 gated) |
...
| C3-MUON-DELTA | **GATED on FI-13** | free (Fermilab data public) | **MISSING + GATED** — no Fermilab-data driver AND cannot meaningfully build one until Foundation Item 13 resolves which AVE mechanism is canonical (Q-G19α n_q-additive at -5α/2 OR Q-G27 Cosserat torsion at -3α/2 - α√(3/7)/(2π)) | **Fermilab Muon g-2 Run-1+Run-2** — Phys. Rev. Lett. 131:161802 (2023); $a_\mu = 0.00116592055(24)$; world average via PDG. **Plus Run-3 tension** $+245(56) \times 10^{-11}$ at ±23% measurement uncertainty (claimed match to Q-G27 prediction $+247 \times 10^{-11}$ per [`q-g27:62`](../../vol2/particle-physics/ch06-electroweak-higgs/q-g27-muon-cosserat-saliency.md:62)) | N until FI-13 resolves (both AVE derivations consistent with Fermilab within current ±23% precision; Run-4/5 at ±10 ppm needed) | (i) FI-13 (2,5)-ambiguity is gating blocker; (ii) BMW lattice vs $e^+e^-$ SM-baseline dispute could mask AVE delta either way; (iii) Q-G27 "match" is SM-baseline-conditional (matches e+e- tension, not BMW null) | **GATED**: (a) Foundation Item 13 (2,5)-ambiguity adjudication first; (b) corpus-level Q-G19α vs Q-G27 reconciliation; (c) then if either survives, build driver; (d) parallel watch for Fermilab Run-4/5 data release (~2026-2027 per q-g27:76) | 2026-05-18 (walked back per 6-skill audit; FI-13 gated) |
...
flowchart TD
    ...
    ALPHA -->|"δ = -α·n_q/2 (Q-G19α)<br/>OR δ = -3α/2 - α√(3/7)/(2π) (Q-G27)<br/>GATED on FI-13 (2,5)-ambiguity<br/>2026-05-18 walk-back"| C3["C3-MUON-DELTA<br/>family saliency — GATED<br/>both AVE derivations consistent<br/>with Fermilab at current ±23% precision<br/>Run-4/5 + FI-13 resolution needed"]
