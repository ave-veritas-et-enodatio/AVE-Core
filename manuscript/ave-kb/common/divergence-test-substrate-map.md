...
| C3-MUON-DELTA | **UN-GATED 2026-05-18 evening — FI-13 RESOLVED via loop-count taxonomy**. Canonical AVE prediction for muon Fermilab observable: Q-G27 Cosserat torsion saliency $\delta_\mu = -3\alpha/2 - \alpha\sqrt{3/7}/(2\pi) = -0.01171$, producing $\Delta a_\mu^{(2)} = +247 \times 10^{-11}$ (matches Fermilab Run-3 tension $+245(56) \times 10^{-11}$ at 0.8% within ±23% measurement uncertainty). The "muon = (2,5)" Q-G19α framing is RETRACTED per FI-13 walk-back (loop-count taxonomy: muon is single-loop N=1 lepton on (2,3) trefoil + Cosserat torsion; (2,5) cinquefoil topology belongs exclusively to N=3 Borromean baryon = proton; structural mismatch). $\Delta(1232)$ remains via Q-G19α n_q ladder framing as per-loop winding on Borromean N=3, NOT single-loop (2,7). Electron $\delta_e = -3\alpha/2$ at 50 ppm PDG match retained (single-loop lepton at (2,3) base). | C / existing-data + new-run-data | I | Canonical: Q-G27 Cosserat torsion on (2,3) trefoil single-loop. $\delta_\mu$ via $-3\alpha/2$ Petermann base + $-\alpha\sqrt{3/7}/(2\pi)$ torsion increment | Ax2+Ax3+Cosserat (**M**) — Q-G27 Cosserat-saliency mechanism with explicit substrate physics; n_q-additivity is alternative-hypothesis-not-canonical for muon | Cascade: C8 baryon ladder (now full PASS at -0.002% proton); A1-HOPF + C3 (2,q) family triangulation pair RE-ENABLED. Loop-count taxonomy resolves cross-leaf ambiguity. | U-D vs SM (BMW lattice closes tension OR e+e- data shows tension) | Driver build with $\delta_\mu = -0.01171$ Cosserat saliency; compare to Fermilab Run-3 +245(56)×10⁻¹¹ tension (0.8% match) + watch Run-4/5 at ±10 ppm (~2026-2027) for true discrimination | [`../vol2/particle-physics/ch06-electroweak-higgs/q-g27-muon-cosserat-saliency.md`](../vol2/particle-physics/ch06-electroweak-higgs/q-g27-muon-cosserat-saliency.md) (CANONICAL) + [`../vol2/particle-physics/ch06-electroweak-higgs/q-g19a-petermann-saliency-closure.md`](../vol2/particle-physics/ch06-electroweak-higgs/q-g19a-petermann-saliency-closure.md) (electron Petermann; muon row scope-corrected per FI-13) + [`closure-roadmap.md`](closure-roadmap.md) (2026-05-18 FI-13 RESOLVED entry) |
...
| C3-MUON-DELTA | **UN-GATED 2026-05-18 evening** per FI-13 RESOLVED — Q-G27 Cosserat torsion canonical; driver can build with $\delta_\mu = -0.01171$ | complete (FI-13 walked back) | no driver yet (queued) | partial-PASS (Q-G27 prediction +247×10⁻¹¹ matches Fermilab Run-3 +245(56)×10⁻¹¹ tension at 0.8% within ±23% measurement uncertainty; Run-4/5 at ±10 ppm needed for true discrimination) | open (driver queued; full discrimination awaits Fermilab Run-4/5 ~2026-2027) |
...
| C3-MUON-DELTA | open (driver queued) | free (Fermilab data public) | **UN-GATED** — driver can build with Q-G27 Cosserat-torsion canonical prediction $\delta_\mu = -3\alpha/2 - \alpha\sqrt{3/7}/(2\pi) = -0.01171$ producing $\Delta a_\mu^{(2)} = +247 \times 10^{-11}$; queued for next session per analogous pattern to C8-BARYON-LADDER PDG-anchor driver | **Fermilab Muon g-2 Run-1+Run-2+Run-3** — Phys. Rev. Lett. 131:161802 (2023) for Run-1+Run-2 baseline ($a_\mu = 0.00116592055(24)$); Run-3 tension +245(56)×10⁻¹¹ for AVE comparison vs SM | Y at current Run-3 precision (Q-G27 prediction within ±23% measurement uncertainty); Run-4/5 needed for sub-1% true discrimination | (i) BMW lattice vs e+e- SM-baseline dispute (Q-G27 "match" is e+e--conditional; BMW would close the tension and AVE distinct claim weakens); (ii) Run-4/5 timeline ~2026-2027 expected | Build Fermilab-data driver with Q-G27 canonical formula + J^P / observable discriminator (analogous to C8-BARYON-LADDER pattern); watch Fermilab Run-4/5 release; if BMW lattice prevails over e+e-, walk back to "AVE consistent with SM-with-BMW-baseline at current measurement precision" | 2026-05-18 (FI-13 RESOLVED via loop-count taxonomy; C3 UN-GATED; driver build queued) |
...
flowchart TD
    ...
    ALPHA -->|"δ_μ = -3α/2 - α√(3/7)/(2π) = -0.01171<br/>(Q-G27 Cosserat canonical post-FI-13 resolution)<br/>UN-GATED 2026-05-18 evening"| C3["C3-MUON-DELTA<br/>Q-G27 Cosserat saliency canonical<br/>Δa_μ⁽²⁾ = +247×10⁻¹¹ matches Fermilab Run-3<br/>+245(56)×10⁻¹¹ at 0.8% within ±23% precision<br/>driver queued; Run-4/5 ~2026-2027 for sub-1%"]
