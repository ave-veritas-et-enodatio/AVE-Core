...
| Op21 | Quality Factor Phase Transition | $Q = \ell$ (substrate-foundational mode-counting at $\Gamma = -1$); $Q \sim 1/\ln(Z_1/Z_0)$ (Cooper-pair-phase-transition specialization) | 321 | CANONICAL — Vol 1 Ch 6 §1.21 canonical name *"Quality Factor Phase Transition"* + canonical-source formula $Q \sim 1/\ln(Z_1/Z_0)$. **DUAL-IDENTIFICATION RECONCILED (2026-05-27, Phase 3-A4)**: substrate-foundational form is $Q = \ell$ per Nyquist-cell-resolved confined mode at $\Gamma = -1$ saturation/TIR boundary (cross-scale canonical at 4 substrate scales: electron LC tank, BH ringdown, universal substrate-Q derivation procedure, knot-mode isomorphism). The $Q \sim 1/\ln(Z_1/Z_0)$ formula (originally annotated "Bardeen BCS mapping") is the Cooper-pair-phase-transition scale-instance specialization — the substrate Op21 evaluated at the superconductivity-threshold substrate-impedance integration. Structurally parallel to Op14 / Op17 / Op19 (one substrate-foundational form, multiple cross-scale specializations). Full derivation at **[KB canonical: Op21 Multi-Mode Mode-Counting at the $\Gamma = -1$ Saturation/TIR Boundary](../vol4/circuit-theory/ch1-vacuum-circuit-analysis/op21-multi-mode-mode-counting.md)** — five-step substrate-mechanism chain derives $Q_i = \Lambda_i$ identification from substrate Nyquist-cell-counting in lattice-natural units. |
