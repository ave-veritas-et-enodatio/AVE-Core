...
<!-- leaf: verbatim -->
<!-- path-stable: referenced from research/L3_electron_soliton as universal-operator catalog -->
...
| Op10 | Junction Projection Loss | Y_loss ≈ sin²(θ)/π² | 300 | CANONICAL — explicit equation Vol 1 Ch 6 §1.10; predicts c=3 invariant for (2,3) torus knot per [research/L3 doc 25 §6](../../../research/L3_electron_soliton/25_step4_23_winding_selection.md) + extract_crossing_count implementation in [`src/ave/topological/cosserat_field_3d.py:1468-1550`](../../../src/ave/topological/cosserat_field_3d.py) |
...
| Op14 | Dynamic Impedance | Z_eff = Z₀/√S | 311 | CANONICAL — explicit equation Vol 1 Ch 6 §1.13 + multiple cross-citations: [vol_4 ch 13:338](../../vol_4_engineering/chapters/13_future_geometries.tex), [vol4 KB caustic-resolution lines 15+32](../vol4/advanced-applications/ch20-optical-caustic-resolution/index.md), [doc 30:106](../../../research/L3_electron_soliton/30_photon_identification.md), [doc 54:197+265+363](../../../research/L3_electron_soliton/54_pair_production_axiom_derivation.md), [doc 75 §3.2](../../../research/L3_electron_soliton/75_cosserat_energy_conservation_violation.md) (empirical: ρ(H_cos, Σ\|Φ_link\|²) = -0.990 at Move 11b — Op14 trading channel active in Move 5 attractor). Asymmetric Meissner case: `Z_eff = Z₀·√(S_μ/S_ε)` per [doc 54:363](../../../research/L3_electron_soliton/54_pair_production_axiom_derivation.md) — different observable when S_μ ≠ S_ε (Phase 4 §6.7 Meissner-asymmetric mechanism) |
| Op15 | Virtual Strain Radius | r_virtual = √(1 - σ(x)²) | 312 | CANONICAL by description — Vol 1 Ch 6 §1.13 names; "links topological node count to spatial metric volumes"; explicit formula in [doc 81 §2.2](../../../research/L3_electron_soliton/81_l3_followup_questions.md) — but only single citation. **SYNTHESIS-LABELED until ≥3 cross-citations land.** |
| Op16 | Universal Wave Speed | c_shear = c₀·√S | 317 | CANONICAL — Vol 1 Ch 6 §1.14 narrative ("Freezes wave propagation dynamically as S → 0") + grep-verified explicit formula at ≥3 cross-citations: [vol_2 ch 7 line 1032 + lines 985-993](../../vol_2_subatomic/chapters/07_quantum_mechanics_and_orbitals.tex) (label `eq:c_shear`), [axiom-homologation.md §208](axiom-homologation.md) (Ax 4 derived effects table: c_eff = c₀·S^(1/2)), [doc 75 §158](../../../research/L3_electron_soliton/75_cosserat_energy_conservation_violation.md) cites Vol 2 Ch 7, [doc 74 §A52](../../../research/L3_electron_soliton/74_r7_k4tlm_lctank_run_result.md) cites as "gravitational time dilation analog c·√(1-A²) ≡ Schwarzschild c·√(1-r_s/r) in r_s/r ≪ 1 limit" |
| Op17 | Power Transmission | T² = 1 - Γ² | 318 | CANONICAL — explicit equation Vol 1 Ch 6 §1.16; active energy transfer coefficient |
| Op18 | Coupled Frequency | ω_c = ω₀/√(1 - λk) | 319 | CANONICAL by description — Vol 1 Ch 6 §1.18 names; explicit formula in [doc 81 §2.2](../../../research/L3_electron_soliton/81_l3_followup_questions.md) but SYNTHESIS-LABELED until ≥3 cross-citations |
...
This catalog is the canonical Phase 0.2 deliverable per [Round 10+ plan](../../../research/L3_electron_soliton/round_10_plan.md) commit `48ee43d` + amendment `d8ca5b9`. Catalog enables:
...
- [`research/L3_electron_soliton/81_l3_followup_questions.md` §2.2](../../../research/L3_electron_soliton/81_l3_followup_questions.md) — doc 81 synthesis catalog (with A43 v10/v11 corrections noted in §5; doc 81 also has Rule-12-style addendum referencing this catalog as canonical)
- [`research/L3_electron_soliton/round_10_plan.md`](../../../research/L3_electron_soliton/round_10_plan.md) — Round 10+ plan (Phase 1 Direction 3 cites operators directly)
