...
| Op2 | Universal Saturation Operator | S(A, A_c) = √(1 - (A/A_c)²) | 101 | CANONICAL — explicit equation Vol 1 Ch 6 §1.2 + four scale instances (lines 107-115: dielectric saturation, BCS B_c(T), galactic rotation, relativistic mass) |
