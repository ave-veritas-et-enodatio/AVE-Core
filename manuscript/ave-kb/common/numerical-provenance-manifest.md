...
- **Canonical source**: `manuscript/vol_2_subatomic/chapters/06_electroweak_and_higgs.tex` §6.2 lines 429-457. Corpus position: AVE $C_2 \approx -0.0094$ is the prediction; QED's $-0.328$ is the corpus-claimed-wrong continuum-extrapolation value where "continuous QED mathematics breaks down against the discrete vacuum hardware."
