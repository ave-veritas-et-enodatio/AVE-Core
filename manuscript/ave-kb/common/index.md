...
| [Grants Random Tangents](grants-random-tangents.md) | Rolling capture leaf for mid-session physical intuitions that don't yet have a home elsewhere in the KB. Append-only; entries marked [FOLDED → leaf] or [REJECTED] after adjudication. |
