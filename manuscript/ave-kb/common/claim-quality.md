...
### Quality
- confidence: 0.20
<!-- confidence demoted 2026-07-19 from 0.50 → 0.20 (CONTESTED; moving-front freeze-in engine result gave ≤3.04 Cp vs ≥100 Cp asserted, + direction backwards-as-stated; see the 🔴 note above). Drives derived solidity 0.30 → 0.20 — held at the BOTTOM of the "do not build on, rework needed" band (≥0.20), deliberately NOT dropped into the <0.20 "refuted" band, because the finding is CONTESTED not refuted (OPEN A44 fork; N=12–16 resolution-limited). -->
- depends-on:
...
- solidity: 0.20 (do not build on, rework needed) [= min(0.20, 0.30)]
