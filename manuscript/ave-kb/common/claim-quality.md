...
- _Specific Non-Claims and Caveats_
  - Does NOT claim the framework is *absolutely* zero-parameter today. The thermal-running magnitude $\delta_{strain} \approx 2.225 \times 10^{-6}$ at $T = T_{CMB}$ is **one currently-fitted scalar** back-subtracted from CODATA via `DELTA_STRAIN = 1 - (1/ALPHA)/ALPHA_COLD_INV`. The structure (existence + sign of substrate spatial-metric response to finite-$T$ photon-bath loading) is predicted; the magnitude is pending substrate-physics derivation gated on **Q-DELTA-MAP-1** substrate-saturation-class adjudication for low-amplitude electromagnetic thermal-bath loading (see [`research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md`](../../../research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md) §3 for the 2026-05-27 Phase 3-A3 WALK-BACK).
...
- strengthen-by:
  - Adjudicate **Q-DELTA-MAP-1** substrate-saturation-class for low-amplitude electromagnetic thermal-bath loading, then derive δ_strain magnitude from the chosen class (currently the one fitted scalar; see [`research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md`](../../../research/2026-05-28_phase-3-a3-delta-strain-machian-projection-result.md) §3 for candidate paths P1/P2/P3)
