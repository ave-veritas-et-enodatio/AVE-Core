...
|---|---|---|---|---|---|
| **Iron-Kα disk-edge** r_in = 7GM/c² (= 3.5 r_s) | BANKABLE (forced ratio, ν_vac=2/7) | GR ISCO at 6GM/c² | inner-accretion-disk edge via X-ray Fe-Kα reflection / kHz QPOs (matter observable, NOT the GR-standard photon ring) | untested; surviving discriminator per 2026-05-16 scope audit | [`divergence-test-substrate-map.md`:165,:167,:532](../../common/divergence-test-substrate-map.md) (C1-BH-RING — §C1 heading, the AVE-predicts $r_{sat} = 7GM/c^2 = 3.5\,r_s$ line, and the Matrix-1 row; ★cite-rot repair 2026-08-03: this read `:143,145` + `":452"`, and **all three were wrong-target** — `:143`/`:145` are the **B6-PONDER-02** 10 GHz microwave-probe rows (a different test entirely), and `:452` is the *"Explicitly NOT ranked (retired / regime-artifact)"* paragraph, not a C1 row. Content-located at HEAD, not bumped); [`ave-merger-ringdown-eigenvalue.md`](../../vol3/cosmology/ch15-black-hole-orbitals/ave-merger-ringdown-eigenvalue.md) |
| **g\* = 7³/4 = 85.75** effective DOF cutoff | BANKABLE (forced ratio, ν_vac=2/7) | SM g\*,SM = 106.75 at EW scale (24 more fermionic DOF) | Ω_GW +7.6% (LISA/DECIGO); EW expansion −10.4% (CMB-S4); EW latent heat −20% (FCC-ee/CEPC) | untested; awaits LISA / CMB Stage-4 / FCC-ee | [`divergence-test-substrate-map.md`:269,:271,:273,:550](../../common/divergence-test-substrate-map.md) (C12-G-STAR — §C12 heading, the AVE-predicts $g_* = 7^3/4 = 85.75$ line, the discriminator line, and the Matrix-1 row; ★cite-rot repair 2026-08-03: this read `:245,247` + `":470"`, and **all three were wrong-target** — `:245`/`:247` are the electrostatic-levitation discriminator and a *"**Substrate:** **MISSING.**"* line from a different section, and `:470` is a **blank line**. ★Disclosed: `:470` was *visible prose* on `origin/main` before this PR; **ITEM A of this same PR** collapsed that block into a `<details>`, so the cite degraded from wrong-target-but-readable to wrong-target-and-blank. Same defect class as the two rows this lane caught at `:35`/`:37`, one degree worse, and caught by the #838 audit rather than by the lane. Content-located at HEAD, not bumped); [`g-star-derivation.md`:14-16](../../vol2/nuclear-field/ch10-open-problems/g-star-derivation.md) |
| **Vacuum birefringence COEFFICIENT** ~10⁵× QED (matched differential) | FORM-EXISTENCE-FALSIFIER (saturation; echo-magnitude) | QED differenced Euler–Heisenberg 2α/15π (instantaneous), α²-loop-suppressed coefficient (both E²-leading) | the matched par−perp differential ratio δn_AVE/δn_QED = 3.75π/α² ≈ 2.2×10⁵ at any field on a single instantaneous footing (AVE −½A² vs QED instantaneous 2α/15π; OPTION-B re-freeze 2026-07-07 — the mixed footing over cycle-averaged α/15π doubles it to 7.5π/α² ≈ 4.42×10⁵, convention history, no OOM/verdict change); a QED-sized coefficient falsifies AVE | not resolved at current high-intensity-laser / PVLAS bounds | [`divergence-test-substrate-map.md`:87,:89,:91,:528](../../common/divergence-test-substrate-map.md) (B1-VAC-BIREFRINGE — §B1 heading, the AVE-predicts index shift, the COEFFICIENT discriminator, and the Matrix-1 row; ★cite-rot repair 2026-08-02: this read `:448,67`, and BOTH were wrong-target — `:448` landed in the divergence map's *priority-order* block, `:67` on a bare "Test type: new experiment." line in §A2. Content-located, not bumped); [`epistemology-kill-switches.md`](../../vol4/falsification/ch11-experimental-bench/epistemology-kill-switches.md) (clm-pp3qwf) |
...
| **PPN /7 couplings** (1/7, 2/7, 9/7) | CONSISTENCY-ECHO (ν_vac=2/7 ← K=2G, GR-imported) | GR PPN with γ=β=1 | light/matter deflection ratios; Mach-Zehnder n_s=9/7 vs n_t=2/7 split | C11-MACH-ZEHNDER live-fire 249.64 rad (sim); ν_vac triangulation with C1+C12 | [`divergence-test-substrate-map.md`:259,:549](../../common/divergence-test-substrate-map.md) (C11 — §C11 heading + the Matrix-1 C11-MACH-ZEHNDER row; ★cite-rot repair 2026-08-02: this read `:469`, a blank line inside the priority block's superseded `<details>`. Content-located, not bumped); [`form-deriving-value-importing.md`:105,113](../../common/form-deriving-value-importing.md) |
