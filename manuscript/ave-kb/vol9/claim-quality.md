...
canonical longitudinal c_eff²=c₀²/S (⇒ C_eff/C₀=1/S) all to < 1e-12, with the cold limit 🔴 **[DEMOTED 2026-08-11 — R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]**
...
canonical Master-Equation scalar engine now carries the longitudinal grade). CHORD — **[TAG DEMOTED 2026-08-11 per R42 → engine-artifact-pending-constitutive-law; quality was *pending*, so no solidity moves]**
...
Figure: `research/figures/engine_acceptance/T3.1_debug.png`. 🔴 **[DEMOTED 2026-08-11 — R40-B1; dated demotion note at the end of this file]**
...
(`src/tests/engine_acceptance/test_l3_mass_cage.py:388`) confirms that the longitudinal-bulk 🔴 **[DEMOTED 2026-08-11 — R40-B2a: NEEDS RE-DERIVATION, not dead; dated note at the end of this file]**
...
- **`:144`** — stamped at `:144`. *(family: c_eff bulk speed law)*  ⚑ **BIAS-DEBT**
  ...
  ```text
  A4 constitutive gate (sup-2qja9z) verifies the longitudinal SPEED identity as canon; the compliance identity C_eff/C₀=1/S survives, the c_eff² speed reading needs the carve re-derivation.
  ```
...
- **`:599`** — stamped at `:599`. *(family: c_eff bulk speed law (register))*  ⚑ **BIAS-DEBT**
  ...
  Audited rationale, verbatim from the banked worklist:
  ```text
  sup-mz4t0p register entry: the kernel-manifestation content survives on the compliance (its own text: 'the bond stiffens C_eff=C₀/S→∞'); the speed mechanism consumes the phantom — register re-derivation owed alongside the suite row.
  ```
