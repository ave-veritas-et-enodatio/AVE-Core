...
| [`common/full-derivation-chain.md`](../../common/full-derivation-chain.md) Layer 8, `clm-sxn6eo` (2026-07-20 remap: `clm-9oazz0` was a phantom; the zero-parameter-closure content is `clm-sxn6eo`, a declared claim of this leaf) | "From Three Limits to Zero Parameters"; the honest 26→`{m_e, α, G}`+4-axiom reduction; `δ_strain` definitional residual; `G = ℏc/(7ξ m_e²)` Machian termination |
