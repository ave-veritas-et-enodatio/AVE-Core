...
- **Machian G is DERIVED** — gravity is the Machian boundary impedance derived from Ax 1 + Ax 4 SYM scaling, NOT a primitive axiom. (Used in cosmic-phase framing throughout; canonical at Vol 9 Ch 12.)
...
- **Ch 12 (Cosmological Characteristics)** carries the cosmic-genesis $\hat{\Omega}_{freeze}$ mechanism + lattice-genesis single-seed framing + BH-interior ruptured-plasma framing + Machian G derivation; Ch 14 catalogs the cosmic phase diagram with pointers to Ch 12 for the substrate-physics.
