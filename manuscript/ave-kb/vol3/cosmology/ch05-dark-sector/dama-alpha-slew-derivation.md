...
The α-slew derivation produces a second testable consequence: gravitationally-isolated stellar systems should equilibrate at $v_{substrate} = \alpha c/(2\pi) = 348.2$ km/s through CMB rest frame. Sun's observed 370 km/s = 348 base + ~22 km/s peculiar (LSR + galactic-orbital projection). Gaia DR3 thin-disk G/K dwarf test (29,466 stars) shows tight cluster at 375 km/s (σ = 11 km/s on tightest cut), with AVE prediction sitting at the 4%ile (close to lower envelope).
