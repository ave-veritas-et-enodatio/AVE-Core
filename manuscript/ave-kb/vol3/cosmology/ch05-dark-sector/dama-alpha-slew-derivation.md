...
The α-slew derivation produces a second testable consequence: gravitationally-isolated stellar systems should exhibit $|v_{CMB}| \geq v_{substrate} = \alpha c/(2\pi) = 348.2$ km/s through CMB rest frame, with αc/(2π) as the substrate-equilibrium FLOOR (not the cluster center). Gaia DR3 thin-disk G/K dwarf test (29,466 stars) shows tight cluster at 375 km/s (σ = 11 km/s on tightest cut), with AVE prediction sitting at the 4%ile (lower envelope). LSR-class stellar population exhibits ~27 km/s coherent bulk motion above floor (Sun is one instance of this population at 370 km/s, not specially peculiar). Floor interpretation is scale-invariance-forced: applying a center-matching $(1 + 1/(4\pi))$ correction at stellar scale would also have to apply at electron scale and break $a_e = \alpha/(2\pi)$ to <0.2%.
