...
**Cross-limb prediction B — Substrate-equilibrium velocity**:
$v_{substrate} = \alpha c/(2\pi) \approx 348$ km/s for gravitationally-isolated systems. Shares Hoop Stress 2π structure with limbs (i) + (iii). Gaia DR3 magnitude anchor at 375 km/s within 9%; FLOOR interpretation falsified 2026-05-17 late evening; extra-galactic test (globular clusters + halo stars) pending per matrix.
