...
| [Bulk Impedance at Saturation Boundary](bulk-impedance-at-saturation-boundary.md) | Astrophysical $Z_{bulk}$ at $r_{\text{sat}}$; $\Gamma_{bulk} = -1$; four-channel boundary table (row 4 = Cosserat micro-rotation, unwalled at $r_{\text{sat}}$) |
...
| [Hawking Temperature](hawking-temperature-nyquist-noise.md) | Nyquist noise leakage, spontaneous emission, evaporation cascade |
