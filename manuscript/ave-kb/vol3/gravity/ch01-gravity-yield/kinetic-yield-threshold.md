...
> **[Resultbox]** *The Kinetic Yield Threshold*
>
> $$
...
Evaluating this geometric identity yields $E_{k} \approx 43.65$ keV. This establishes the kinematic limit where localised dynamic point-stress exceeds the yield limit of the effective substrate medium. The kinetic yield threshold is $\sqrt{\alpha}$ times the rest mass of the electron.
