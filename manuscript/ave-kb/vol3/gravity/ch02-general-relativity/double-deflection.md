...
> **Provenance note (2026-07-04, srs elastic-tensor fallout, PR#506; deflection number UNCHANGED).** The **factor-of-2** here is the arithmetic **ratio** $(2/7):(1/7)=2$ and is robust; the deflection magnitude is a Class-C consistency check (calibrated independently at the deflection-integral level, `consistency-manifest.yaml` P10 `type: consistency_check`). What the srs arc touches is only the **provenance of the value $\nu=2/7$**: $\nu=2/7\iff K=2G$ is an algebraic identity that holds, but $K=2G$ is **GR-imported** (PR#261), re-confirmed at the ratified $z=3$ srs carrier by PR#506 (the crystalline srs Cauchy tensor is a one-parameter family; $\nu=2/7$ only at externally-supplied $\rho^*\approx9.77$, Zener $1.23$). So $\nu=2/7$ is **not** crystalline-lattice-forced — it is the GR-imported $K=2G$ value. (Stage-2 chiral-coupling question OPEN, `analysis/srs-chiral-micropolar`.) See [`research/2026-07-04_srs-elastic-tensor_result.md`](../../../../../research/2026-07-04_srs-elastic-tensor_result.md).
