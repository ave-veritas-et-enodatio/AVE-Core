...
- **Gravitational redshift**: The isotropic-coordinate redshift factor $z = W/U = (1 + r_h/r)/(1 - r_h/r)$ suppresses emission from the innermost disk annuli, producing the dark gap between the photon ring and the bright disk body. (**Scope correction 2026-05-17 Foundation Item 4** per `consistency-vs-emergence` discipline trigger 5: this is the Schwarzschild isotropic-coordinate redshift formula inherited from GR's metric structure via the Gordon optical-metric isomorphism documented at [`../ch03-macroscopic-relativity/refractive-index-of-gravity.md`](../ch03-macroscopic-relativity/refractive-index-of-gravity.md):14. The macroscopic redshift recovery is therefore a **consistency check** — AVE recovers GR's weak-field gravitational redshift via shared metric structure — NOT an emergence test. **The AVE-distinct redshift emergence claim** lives in the discrete sub-peak structure of iron Kα lines from quantized impedance bands per Vol 3 Ch 15 BH polar-axis predictions: that fine structure is a substrate-native signature absent from continuous GR redshift, and IS the genuine forward-prediction surface.)
