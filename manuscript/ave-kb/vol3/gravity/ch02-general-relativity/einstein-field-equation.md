...
In the AVE framework, a black hole corresponds to a localized region of maximum dielectric saturation where the LC grid reaches its **topological yield point** at the Event Horizon — the saturation onset at $r_s$ where the lattice loses topology-supporting capacity (the bulk Regime IV ruptured-topology interior begins deeper still, at $r_{sat} = 7GM/c^2 = 3.5\,r_s$; see the BH-interior entry in [`vol3/claims-boundaries.md`](../../claims-boundaries.md)). When two such massive topological stress-concentrations orbit each other, they act as macroscopic impellers driving transverse shear waves through the electro-mechanical condensate.
