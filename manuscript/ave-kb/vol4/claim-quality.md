...
> average). v1 and v2 are preserved verbatim in the 🔴/🔵 notes above; the OpenTimestamps anchor
> `claim-prereg-ots/claims_by_hash.md` carries the v2 $7.5\pi/\alpha^2$ value — **byte-identical, not re-stamped**.
