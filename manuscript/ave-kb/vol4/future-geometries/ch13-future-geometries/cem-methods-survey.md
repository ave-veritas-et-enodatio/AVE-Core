...
The TLM method has a direct intellectual ancestor in the network-analysis program of **Gabriel Kron**. Kron's *Tensor Analysis of Networks* (1939) recast physical systems as generalized electrical networks; he then constructed explicit **equivalent circuits** for the field equations of physics — "Equivalent Circuit of the Field Equations of Maxwell—I," *Proc. IRE* **32**, 289–299 (1944), [doi:10.1109/JRPROC.1944.231021](https://doi.org/10.1109/JRPROC.1944.231021), and "Electric Circuit Models of the Schrödinger Equation," *Physical Review* **67** (1945). The transmission-line-matrix method of Johns & Beurle ("Numerical solution of 2-dimensional scattering problems using a transmission-line matrix," Proc. IEE, 1971) is the modern, systematically-discretized descendant of this equivalent-circuit lineage [CITE-NEEDS-CONFIRMATION: the specific claim that Johns & Beurle *credit* Kron could not be verified against the paper's reference list this session]. The AVE K4-TLM simulator (the unitary 4-port diamond-lattice scattering engine, $\max|S^\dagger S-I|=2.2\times10^{-16}$) is the K4-topology correction of that same line: **Kron → TLM (Johns & Beurle) → K4-TLM (AVE)**.
