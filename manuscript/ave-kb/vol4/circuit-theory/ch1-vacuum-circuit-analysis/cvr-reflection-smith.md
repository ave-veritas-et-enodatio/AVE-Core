...
- **Tool-axis:** [translation-circuit.md](../../../common/translation-tables/translation-circuit.md):193 (the *"Smith chart ($Z \\leftrightarrow \\Gamma$)"* row this leaf consolidates — repointed 2026-08-18, :181 had drifted blank); [operators.md](../../../common/operators.md):43 (Op3, `$\Gamma = (Z_2 - Z_1)/(Z_2 + Z_1)$`); the biquaternion Möbius/SL(2,ℂ) identity at its existing echo ceiling (`research/2026-06-06_biquaternion-node-algebra-result.md` §5.3 — INVARIANT-F2 wiring, 2026-08-18).
