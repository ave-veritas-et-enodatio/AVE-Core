...
> 🔴 **QED-NORMALIZATION CORRECTION (2026-07-03; Rule-12 — body preserved below, git is the trail).**  <!-- rule12-freeze: base=46162d6589f063f1cbc90712e1a7d24d613ca098 region=below offset=6 lines=311 bytes=23251 sha256=32b5754357451a952618436b8e59186704153b6c1ee05049db19841e0429ce65 -->
> Every "$7.5/\alpha^3\approx1.93\times10^7$" birefringence-ratio below carries an understated QED denominator
...
> magnitude or falsifier verdict changes). The AVE leg $-\tfrac12 A^2$ and the
> MIXED chord-vs-echo grade are UNAFFECTED (the magnitude was and remains an $\alpha$-echo). Canonical:
...
| 6 | Birefringence COEFFICIENT $\delta n_{AVE}/\delta n_{QED}=$ **v3 $3.75\pi/\alpha^2\approx2.2\times10^5$** ~~$7.5/\alpha^3\approx1.93\times10^7$~~ (v3 stamp 2026-07-31; v1 struck-not-deleted per Rule 12 — canonical [`vacuum-birefringence-e4.md`](../../falsification/ch12-falsifiable-predictions/vacuum-birefringence-e4.md):104, v1/v2 named "convention history" at :106, chord-vs-echo split at :112; same content as this leaf's 🔴 header) | **MIXED** | CHORD = the vacuum saturates at all at tree-level $O(1)$ (vs QED's $\alpha^2$-loop); ECHO = the magnitude (v3 $3.75\pi/\alpha^2$; ~~v1 $7.5/\alpha^3$~~) is an $\alpha$-echo at the value level (claim-quality.md:399,405). Survives the macroscopic bridge intact (§3) |
...
| Birefringence-coefficient MAGNITUDE **v3 $2.2\times10^5=3.75\pi/\alpha^2$** ~~$1.93\times10^7=7.5/\alpha^3$~~ (v3 stamp 2026-07-31; [`vacuum-birefringence-e4.md`](../../falsification/ch12-falsifiable-predictions/vacuum-birefringence-e4.md):104-:112) | **$\alpha$-ECHO** (value) | claim-quality.md:399,405 self-adjudicated; existence/tree-level $O(1)$ = chord — the ECHO grade is unchanged by the re-freeze (the magnitude rides $\alpha^{-2}$ instead of $\alpha^{-3}$) |
