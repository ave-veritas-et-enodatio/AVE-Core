...
> **Grade-fork RESOLVED = T2 (Grant 2026-06-30; `def-vyvsn1` adjudicated, `research/2026-06-30_electron-portmap-derivation_result.md` §5).** The prior wording keyed this A1 varactor's saturation-completion voltage on $V_{yield}=\sqrt\alpha\,V_{snap}\approx43.65$ kV. That is **corrected**: $V_{yield}$ is the **transverse Cosserat ($T_2$) self-trap wall** ([`pair-production-axiom-derivation.md`](../../../vol2/particle-physics/ch01-topological-matter/pair-production-axiom-derivation.md):102), **not** the A1 compliance bound. The **longitudinal-A1** bond compliance below diverges at the higher $V_{snap}$ (a factor $1/\sqrt\alpha\approx11.7$ above $V_{yield}$). **Consequence:** a standing electron's A1 mass core operates at strain $A=V_{yield}/V_{snap}=\sqrt\alpha\approx0.085$ — deeply **sub-saturated** ($S(\sqrt\alpha)=\sqrt{1-\alpha}\approx0.996$), which is *why* it binds (the $S\to0$ varactor runaway never fires on the mass channel). Since $V_{yield}=\sqrt\alpha\,V_{snap}$ EXACTLY, $A=\sqrt\alpha$ is an $\alpha$-echo operating point (Class-C), not a free parameter. **ATTRIBUTION SPLIT (2026-09-07, provenance-only — no physics adjudicated, no status changed).** The rider *"the electron's confining $\Gamma=-1$"* rode inside the $T_2$ parenthesis above, under this banner's "(Grant 2026-06-30)" stamp. **The physical claim stands, unweakened, and is restated here carrying its own provenance:** the single-electron confining $\Gamma=-1$ TIR cavity self-creates at $V_{yield}$. It descends from **Property 3 of the canonical 4-property electron definition** — `electron-identification.md:32` §1.3, verbatim *"The lattice self-creates a perfect TIR mirror at the wave's location"*, stamped *"Property 3 STANDS"* — and reached canon through the **#416 / Grant 2026-06-24 sectoral correction**, NOT through the 2026-06-30 ruling. What 2026-06-30 settled is narrower: **which sector's constitutive law is keyed on 43.65 kV**. The frozen Grant-facing question is a *grade-attribution* fork (`2026-06-30_electron-portmap-derivation_prereg_FROZEN.md:173`, verbatim *"depends on an un-adjudicated grade-attribution of"*) and carries no confinement clause. **Which sector OWNS the cage is OPEN and routed to Grant** — see `def-vyvsn1` open-ambiguity-flag item (4) in `common/vocabulary-register.md`.
