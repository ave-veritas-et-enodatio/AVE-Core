...
> **🔴 DEMOTED — dated both-and note 2026-07-19 (Rule-12; the $P_{\text{phase5\_memristor\_loop\_area}}$ row above is preserved verbatim).** The peak-shift prediction (loop-area $f$ "peaks at $\omega \cdot \tau_{\text{relax}} \approx 0.9$", window $[0.85, 0.95]$) is demoted on **TWO independent grounds — both hold; neither collapses into the other** — per the yield-fork discriminator run (`research/2026-07-19_yield-fork-discriminators_result.md`, merged #735; Leg B / F-B1). Every number verbatim from that result doc:  <!-- rule12-freeze: base=96551e041d6c08c9dee36435dfe894f9007d8e0b region=above offset=0 lines=60 bytes=3560 sha256=40ed036dd99f5985ba86d2e374a1f323f04a4f5d513aac100d75e16a78b2030f -->
