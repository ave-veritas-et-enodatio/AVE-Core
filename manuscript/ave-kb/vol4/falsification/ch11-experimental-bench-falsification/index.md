...
> **🔴 SCOPE-CORRECTION (2026-06-15, keystone $\alpha$-verdict + zero-parameter register reconciliation; Rule 12 — the lead description below is PRESERVED unedited; this dated banner supersedes two of its scope claims and resolves the self-contradiction against the Key-Results ``$\sqrt{\alpha}$ yield limit'' row below).** Two corrections, both propagating already-merged `origin/main` rulings (the keystone $\alpha$-verdict and the 26→3 parameter register) to this lagging leaf:  <!-- rule12-freeze: base=417f1330187c0a6ee2105ccde26d410b80b45a47 region=below offset=35 lines=16 bytes=2421 sha256=0ee0184b06800f0c6c99d0b5c202e7f20fd24affaf8341dee25880c6be59c70d -->
