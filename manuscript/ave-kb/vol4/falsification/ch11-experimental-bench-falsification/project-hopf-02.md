...
>
> ↗ See also: [`_orchestration/exp-a1-hopf.md`](../../../../_orchestration/exp-a1-hopf.md) — AVE-Core orchestration sub-epic for HOPF-02a fab + measurement
>
...
### Outcome adjudication (Phase 3 of sub-epic [`exp-a1-hopf.md`](../../../../_orchestration/exp-a1-hopf.md))
