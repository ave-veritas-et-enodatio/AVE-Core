...
- **P1 (presence):** is there a non-zero charge floor at all from displacement of *uncharged* matter in clean vacuum? Standard EM predicts $0.0$ mV; AVE predicts the $\xi_{topo}\cdot x = 41.5$ mV/μm floor.
