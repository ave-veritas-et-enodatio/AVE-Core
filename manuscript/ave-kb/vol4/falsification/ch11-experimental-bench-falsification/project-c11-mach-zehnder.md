...
> ↗ See also: [`_orchestration/exp-c11-mach-zehnder.md`](../../../../_orchestration/exp-c11-mach-zehnder.md) — AVE-Core orchestration sub-epic for facility partnership search + measurement
>
> ↗ See also: [`_orchestration/exp-c11-mach-zehnder-sim-audit.md`](../../../../_orchestration/exp-c11-mach-zehnder-sim-audit.md) — sim drift audit (NO DRIFT verdict on ν_vac + ε_11 + cascade axes)
>
...
If C11 evolves to co-designed 1m interferometer + specific collaboration → application IP emerges → revisit per `ave-ip-divide-discipline` + [`promotion-workflow-template.md`](../../../../_orchestration/promotion-workflow-template.md).
...
- Sub-epic [`exp-c11-mach-zehnder.md`](../../../../_orchestration/exp-c11-mach-zehnder.md) + Sim audit [`exp-c11-mach-zehnder-sim-audit.md`](../../../../_orchestration/exp-c11-mach-zehnder-sim-audit.md)
