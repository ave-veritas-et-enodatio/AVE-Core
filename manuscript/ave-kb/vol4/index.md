...
| [Advanced Applications](advanced-applications/index.md) | Metric-catalyzed fusion ($n^* = 1.114$); topological quantum computing; native silicon design engine (geometric BJT $\beta$, `atopile` compilation). **Note (REPO-ARCH-1+2+3 2026-05-17)**: antimatter + SMES + optical caustic content migrated; Beltrami force-free substrate physics canonical at [`vol2/particle-physics/ch01-topological-matter/electron-unknot.md`](../vol2/particle-physics/ch01-topological-matter/electron-unknot.md) line 9; annihilation mechanism at [`chirality-and-antimatter.md`](../vol2/particle-physics/ch01-topological-matter/chirality-and-antimatter.md) + [`pair-production-axiom-derivation.md`](../vol2/particle-physics/ch01-topological-matter/pair-production-axiom-derivation.md); caustic / saturation-reflection mechanism at [`vacuum-impedance-mirror.md`](../vol4/falsification/ch11-experimental-bench-falsification/vacuum-impedance-mirror.md). |
...
| [Advanced Applications](advanced-applications/index.md) | Metric-catalyzed fusion ($n^* = 1.114$, resolves tokamak ignition paradox); topological quantum computing (Gauss linking immunity); active metamaterials (inorganic LLCP, room-temperature superconductivity pathway); native silicon design engine (doping as geometric perturbation, topological BJT gain, `atopile` compilation, SPICE bridge). |
