...
| [Advanced Applications](advanced-applications/index.md) | Metric-catalyzed fusion ($n^* = 1.114$, resolves tokamak ignition paradox); active metamaterials (inorganic LLCP, room-temperature superconductivity pathway); native silicon design engine (doping as geometric perturbation, topological BJT gain, `atopile` compilation, SPICE bridge). |
