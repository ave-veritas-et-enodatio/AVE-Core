...
| [Advanced Applications](advanced-applications/index.md) | Topological SMES (Beltrami force-free, 87.9% flux reduction); metric-catalyzed fusion ($n^* = 1.114$, resolves tokamak ignition paradox); topological quantum computing (Gauss linking immunity); active metamaterials (inorganic LLCP, room-temperature superconductivity pathway); native silicon design engine (doping as geometric perturbation, topological BJT gain, `atopile` compilation, SPICE bridge). |
