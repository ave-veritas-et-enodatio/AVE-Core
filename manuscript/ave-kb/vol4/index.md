...
| [Advanced Applications](advanced-applications/index.md) | Metric-catalyzed fusion ($n^* = 1.114$); topological quantum computing; native silicon design engine (geometric BJT $\beta$, `atopile` compilation); optical caustic singularity resolution. **Note (REPO-ARCH-1+2 2026-05-17)**: antimatter + SMES content migrated; Beltrami force-free substrate physics canonical at [`vol2/particle-physics/ch01-topological-matter/electron-unknot.md`](../vol2/particle-physics/ch01-topological-matter/electron-unknot.md) line 9; annihilation mechanism at [`chirality-and-antimatter.md`](../vol2/particle-physics/ch01-topological-matter/chirality-and-antimatter.md) + [`pair-production-axiom-derivation.md`](../vol2/particle-physics/ch01-topological-matter/pair-production-axiom-derivation.md). |
