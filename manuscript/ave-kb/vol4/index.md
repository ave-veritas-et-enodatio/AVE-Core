...
| [Hardware Programs](hardware-programs/index.md) | HOPF-01 $\Delta f/f = \alpha \cdot pq/(p+q)$ (zero free parameters); PONDER-05 469 $\mu$N predicted thrust; K4-TLM unitary to machine epsilon; Universal `AVE_VACUUM_CELL` SPICE subcircuit |
| [Advanced Applications](advanced-applications/index.md) | Metric-catalyzed fusion ($n^* = 1.114$); native silicon design engine (geometric BJT $\beta$, `atopile` compilation). **Note (REPO-ARCH-1+2+3+4+5 2026-05-17)**: antimatter + SMES + optical caustic + quantum computing + active metamaterials content migrated. Substrate-physics canonical destinations: Beltrami force-free at [`electron-unknot.md`](../vol2/particle-physics/ch01-topological-matter/electron-unknot.md) line 9; annihilation/pair production at [`chirality-and-antimatter.md`](../vol2/particle-physics/ch01-topological-matter/chirality-and-antimatter.md) + [`pair-production-axiom-derivation.md`](../vol2/particle-physics/ch01-topological-matter/pair-production-axiom-derivation.md); caustic/saturation-reflection at [`vacuum-impedance-mirror.md`](../vol4/falsification/ch11-experimental-bench-falsification/vacuum-impedance-mirror.md); transmon decoherence at [`transmon-decoherence.md`](../vol3/condensed-matter/ch11-thermodynamics/transmon-decoherence.md); Gauss linking number at [`mathematical-topology-of-mass.md`](../vol2/particle-physics/ch01-topological-matter/mathematical-topology-of-mass.md); Kuramoto phase-lock at [`kuramoto-phase-locking.md`](../vol3/condensed-matter/ch09-condensed-matter-superconductivity/kuramoto-phase-locking.md); LLCP / K=2G / Kepler-packing at [`water-anomaly-lc-partition.md`](../vol3/condensed-matter/ch11-thermodynamics/water-anomaly-lc-partition.md) + [`trace-reversal-mechanism.md`](../vol3/gravity/ch01-gravity-yield/trace-reversal-mechanism.md). |
...
| [Hardware Programs](hardware-programs/index.md) | HOPF-01 chiral antenna verification ($\Delta f/f = \alpha \cdot pq/(p+q)$, zero free parameters, \$251 total cost); ponderomotive program evolution (PONDER-01 thermal catastrophe to PONDER-05 DC-biased quartz, 469 $\mu$N predicted thrust); torsion metrology (eight-point artifact rejection, sub-$\mu$N sensitivity). |
| [Advanced Applications](advanced-applications/index.md) | Metric-catalyzed fusion ($n^* = 1.114$, resolves tokamak ignition paradox); native silicon design engine (doping as geometric perturbation, topological BJT gain, `atopile` compilation, SPICE bridge). |
| [Falsification](falsification/index.md) | Experimental falsification programme: Sagnac-RLVE ($\Delta\phi \approx 2.07\,\text{Rad}$, $\Psi = 7.15$); tabletop projects (CLEAVE-01, HOPF-02, ROENTGEN-03, ZENER-04, TORSION-05); $\sqrt{\alpha}$ yield limit ($V_{yield} = 43.65\,\text{kV}$, $m_{max} = 1.846\,\text{g}$); YBCO phased array (2.5 metric tons/m$^2$); vacuum impedance mirror; EE Bench dielectric plateau ($E_{yield} = 1.13 \times 10^{17}\,\text{V/m}$); PONDER-01 asymmetric thrust ($F \propto V^2 f^2$); torus knot baryon predictions; birefringence $E^4$ discriminator. |
