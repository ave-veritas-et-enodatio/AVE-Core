...
[ ] Any axiom-chain-anchored docstring (Ax 1/2/3/4 + Op-N derivation chain) that was modified or removed is replaced with an equivalent or stronger explicit axiom chain — NOT a hand-wave like "organically incorporates" or "natively bypasses" without a derivation. See [research/_archive/L3_electron_soliton/100_a47_v9_reframing_line_687_retraction.md §10](../research/_archive/L3_electron_soliton/100_a47_v9_reframing_line_687_retraction.md) for the worked-example pattern.
