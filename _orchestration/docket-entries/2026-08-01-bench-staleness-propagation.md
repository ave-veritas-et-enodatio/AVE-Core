...
> 🔴 **CORRECTION 2026-08-02 (Rule 12 — the original item-5 wording is preserved in the sentence above as struck below; git is the trail).** Item 5 originally read *"the remaining un-numbered BENCH-∅ rows **in the map's row order**"*. Both halves of that were inaccurate. Verified against `_orchestration/2026-07-15_hardware-ratings-map.md` §2 (real-machine column, rows R1-R13):  <!-- rule12-freeze: base=b79a2ce2c800558700d0eb28d204700e1aed857a region=above offset=0 lines=28 bytes=3603 sha256=ec029ebdb53f77e0b92187cd6a1ddb8a3194933c35748ce99b14d3321a76bfd2 -->  <!-- rule12-freeze: base=b79a2ce2c800558700d0eb28d204700e1aed857a region=below offset=0 lines=41 bytes=6275 sha256=3c2af2c0bd25fe4c127bf6e6806bf4fb0141c37c79a38c07e18b545a8d463dab -->
>
...
> 🔴 **CORRECTION 2026-08-02 (Rule 12 — the original enumeration is preserved verbatim in the paragraph above; git is the trail).** Two defects in that paragraph, both caught by the PR #823 audit:  <!-- rule12-freeze: base=b79a2ce2c800558700d0eb28d204700e1aed857a region=above offset=0 lines=41 bytes=6275 sha256=3c2af2c0bd25fe4c127bf6e6806bf4fb0141c37c79a38c07e18b545a8d463dab -->
>
...
> 🔴 **CORRECTION 2026-08-02 (Rule 12 — the original sentence is preserved verbatim immediately below; git is the trail).** The battery line above originally read: *"…, `src/deprecate-superseded-birefringence-ratio` (`src/repoint-pvlas-v3` does not exist locally or on origin)."* **That parenthetical was false.** `src/repoint-pvlas-v3` **does** exist on origin at **`a370eb93`** (8 commits ahead of `origin/main`), touching **2 files**: `_orchestration/docket-entries/2026-08-01-d7-repoint-pvlas.md` and `research/2026-08-01_pvlas-arbiter-v3-repoint_scoping.md`. The likely cause is a `git ls-remote` / branch-list check run before that branch was pushed, recorded as a permanent negative.  <!-- rule12-freeze: base=82750c6571b9610f383f6ec9d10cd7adde18f26e region=below offset=0 lines=5 bytes=994 sha256=2097be516390112d811cc42b13960187acd5096ca79139a1fa13e67e8c74260d -->
>
