...
| *"twist/microrotation ↔ couple-stress ↔ inductive/μ-sector"* | [`manuscript/ave-kb/common/translation-tables/translation-circuit.md`](../../manuscript/ave-kb/common/translation-tables/translation-circuit.md)`:99-104` — full path given because **three tracked files share the basename `translation-circuit.md`** (the other two are `manuscript/ave-kb/vol4/circuit-theory/ch1-vacuum-circuit-analysis/` and `manuscript/ave-kb/vol2/appendices/app-a-translation-matrix/`); the prereg's own bare form is preserved as-written inside the quoted block above, since a `FROZEN` file is quoted not corrected. Per merged [`2026-07-31-anisotropy-scoping.md`](2026-07-31-anisotropy-scoping.md)`:9`, verbatim: *"when two files share a basename, name the full path"* | `:100` *"**Microrotational B DOFs at node** \| **Inductive flywheel**"*; `:101` *"**Cosserat couple-stress $\gamma_c$** \| **Transformer mutual inductance gradient**"*; `:104` *"**Bond twisting (microrotational gradient)** \| Couple-stress / mutual-inductance gradient"* | ✅ **exactly on point** |
