...
>
> **🔴 RE-BANKED 2026-07-19 (PR #744 adversarial review `wf_58c5701a` — 2 CRITICAL + 7 MAJOR CONFIRMED; this banner GOVERNS the entry. Rule-12: the STAGE-1/STAGE-2/Disposition text below is preserved verbatim, NOT refilled).** The self-banked ruling below is RE-BANKED:
...
> **🔴 PR #776 REVIEW CORRECTION NOTE (2026-07-20 — CLEARED-WITH-REPAIRS; Rule-12, frozen text above preserved).** The adversarial review found the **★ headline τ characterization wrong** (finding 0, DOWNGRADED-MAJOR). The overall bin stays **MIXED**, but the corrections are:
