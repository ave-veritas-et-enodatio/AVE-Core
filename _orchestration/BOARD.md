...
Scanned tree **256515e0** (2026-08-26) · 468 index records · 331 claims · 1 PR open

> ⚑ **This board was generated from a tree that is not `origin/main`** (`a3f4fef7`). Every count below describes **256515e0**. Regenerate on main before reading these as program state.
...
**44 of 79 open items are owned by Grant.** Nothing fires on those without his word — including the PARKED ones, which need an explicit word to unpark.
...
| [Which channel's dispersion does a moving electron obey? — SWEPT, mostly answered by canon; three narrow residues remain](open-items/2026-08-26-electron-rest-energy-channel.md) | OPEN | lane | 2026-08-26 |
| [AUDIT REQUIRED — the wall-first reframe + trefoil-vs-photon propagation walk (WALK-GRADE, UNAUDITED)](open-items/2026-08-26-wall-first-reframe-audit.md) | OPEN | lane | 2026-08-26 |
