...
Scanned tree **f51c3a5a** (2026-08-27) · 468 index records · 331 claims · 5 PRs open

> ⚑ **This board was generated from a tree that is not `origin/main`** (`a3f4fef7`). Every count below describes **f51c3a5a**. Regenerate on main before reading these as program state.
...
| [ROUTED TO GRANT — move the electron row from boundary register 1 (AMPLITUDE LEVEL-SET) to register 4 (BALANCE LOCUS)?](open-items/2026-08-26-virtual-neutral-register-move.md) | ROUTED-TO-GRANT | grant | 2026-08-26 |
...
| [CORRECTION — device-circuit-models.md:165 ASSERTS the A1 wall; it does not prohibit it](open-items/2026-08-26-device-circuit-models-165-correction.md) | OPEN | lane | 2026-08-26 |
