...
Scanned tree **5bdd1c2b** (2026-08-24) · 461 index records · 330 claims · 3 PRs open

> ⚑ **This board was generated from a tree that is not `origin/main`** (`26a3ad37`). Every count below describes **5bdd1c2b**. Regenerate on main before reading these as program state.
...
**34 of 64 open items are owned by Grant.** Nothing fires on those without his word — including the PARKED ones, which need an explicit word to unpark.
