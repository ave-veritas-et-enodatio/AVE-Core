...
Scanned tree **087c049e** (2026-08-24) · 461 index records · 330 claims · 3 PRs open

> ⚑ **This board was generated from a tree that is not `origin/main`** (`26a3ad37`). Every count below describes **087c049e**. Regenerate on main before reading these as program state.
...
**38 of 69 open items are owned by Grant.** Nothing fires on those without his word — including the PARKED ones, which need an explicit word to unpark.
