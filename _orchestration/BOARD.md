...
Scanned tree **04b79bab** (2026-08-23) · 461 index records · 330 claims · 5 PRs open

> ⚑ **This board was generated from a tree that is not `origin/main`** (`ff0fde8b`). Every count below describes **04b79bab**. Regenerate on main before reading these as program state.
...
| #1001 | pending-review | [DO-NOT-MERGE][REVIEW: pending-orchestrator] research(theta-route3): balanced-po |
