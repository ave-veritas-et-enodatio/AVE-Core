...
Scanned tree **c80e598b** (2026-08-27) · 468 index records · 331 claims · 7 PRs open

> ⚑ **This board was generated from a tree that is not `origin/main`** (`a3f4fef7`). Every count below describes **c80e598b**. Regenerate on main before reading these as program state.
...
**44 of 78 open items are owned by Grant.** Nothing fires on those without his word — including the PARKED ones, which need an explicit word to unpark.
...
| [125 Rule-12 drift candidates are shipped with no owner — including one confirmed live violation at claim-quality.md:760](open-items/2026-08-27-rule12-drift-survey.md) | OPEN | unassigned | 2026-08-27 |
