...
Scanned tree **ad9cff27** (2026-08-27) · 468 index records · 331 claims · 7 PRs open

> ⚑ **This board was generated from a tree that is not `origin/main`** (`a3f4fef7`). Every count below describes **ad9cff27**. Regenerate on main before reading these as program state.
...
| [AUDIT REQUIRED — the cold-vacuum phase-space/real-space EE mapping walk (headline item already REFUTED)](open-items/2026-08-27-cold-vacuum-ee-mapping-audit.md) | OPEN | lane | 2026-08-27 |
