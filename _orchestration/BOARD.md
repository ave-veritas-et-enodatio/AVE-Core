...
Scanned tree **61a52ce5** (2026-08-27) · 468 index records · 331 claims · 7 PRs open

> ⚑ **This board was generated from a tree that is not `origin/main`** (`a3f4fef7`). Every count below describes **61a52ce5**. Regenerate on main before reading these as program state.
...
| [Does the cold empty-vacuum CONTROL carry a Termination? The frozen prereg is silent, and two artifact arms depend on the answer](open-items/2026-08-27-prereg-control-termination.md) | OPEN | grant | 2026-08-27 |
