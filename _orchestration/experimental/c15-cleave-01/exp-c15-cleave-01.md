...
| **Phase 1a-rev1 Stage B** | ⏳ LANDED ON BRANCH — NOT MERGED (`b44b1f7`) | (archived) Stage B scope in phase-1a-rev1 brief above | **Q-C15-12 merge path PENDING** — Path 1 (fix Stage A first, recommended) vs Path 2 (merge Stage B as-is + queue fix-branch in HWMOD) | 2026-05-20 EOD++++++++++++ entry below |
