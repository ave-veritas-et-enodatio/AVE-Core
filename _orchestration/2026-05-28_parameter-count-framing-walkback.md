...
- [ ] **Grant signs off on §1.5 canonical gating-clause wording** ← blocked here
- [ ] Phase 1 — constants.py contradiction + framing reconciliation + headline anchors (KB-first), gating-clause stamped
