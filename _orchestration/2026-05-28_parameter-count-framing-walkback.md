...
- [ ] **Q-EMBED-SEL-1 evaluation epic Phase 2+3** (cross-particle + cross-domain) — see [`2026-05-31_q-embed-sel-1-evaluation.md`](2026-05-31_q-embed-sel-1-evaluation.md) §11 status block
- [ ] **Corpus walk-back propagation** (evaluation epic Phase 4) — replace spinor-half-cover provenance across ch8 + theorem-3-1-q-factor.md + related leaves with the substrate-mechanism replacement from result doc §5. Gated on Phase 2+3 validation.
- [ ] **AVE-HOPF cross-repo reconciliation** — evaluation epic Phase 4 corpus walk-back, gated on Phase 2+3 outcomes.
