...
| R7 | **Thermal / noise floor** — the entropy sink | sink the thermometer/DE need; peer-label FD/Nyquist only after CHANNEL-BOUNDED | **REFUSED** as-built ✅ (#707) · rung-1 **CHANNEL-BOUNDED** ✅ · rung-2 **BIAS-MOVED** ✅ · Arm A event-gated **BIAS-MOVED** ✅ (mode-count LIVE; bias knife still kills) | BENCH-∅ | next hypothesis under mode-count discriminator (not Re(Z); not retune Arm A); thermometer **GATED** |
...
1. **F6 ε→T2 irreversible *field* channel** — Priority 1. Rung-1 ✅; rung-2 BIAS-MOVED; Arm A event-gated **BIAS-MOVED** (`2026-07-16_f6-mode-count-event-gated_prereg_FROZEN.md` — mode-count LIVE, bias knife kills). Next hypothesis under [`../research/2026-07-15_f6-mode-count-door_CHARTER.md`](../research/2026-07-15_f6-mode-count-door_CHARTER.md); **forbid** Re(Z) absorb / Arm A retune.
