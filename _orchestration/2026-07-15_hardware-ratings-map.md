...
| R7 | **Thermal / noise floor** — the entropy sink | sink the thermometer/DE need; peer-label FD/Nyquist only after CHANNEL-BOUNDED | **REFUSED** as-built ✅ (#707) · rung-1 **CHANNEL-BOUNDED** ✅ · rung-2 **BIAS-MOVED** ✅ · Arm A event-gated **BIAS-MOVED** (PR #711; mode-count LIVE) · frontier map chartered | BENCH-∅ | frontier map + Tier-0 **G0** exterior-leave (gated on Grant GO; not node mint; not assume orthogonal; **not** Re(Z)); thermometer **GATED** |
...
1. **F6 ε→T2 irreversible *field* channel** — Priority 1. Rung-1 ✅; rung-2 **BIAS-MOVED**; Arm A event-gated **BIAS-MOVED** (PR #711 — mode-count LIVE, bias knife kills; do not retune). Map: [`../research/2026-07-16_f6-frontier-map_CHARTER.md`](../research/2026-07-16_f6-frontier-map_CHARTER.md) (freeze releases; AM≠DE; orthogonal=conjecture; full `node_creation` mint = NO). Next door under [`../research/2026-07-15_f6-mode-count-door_CHARTER.md`](../research/2026-07-15_f6-mode-count-door_CHARTER.md): Tier-0 **G0** exterior-leave **only if Grant GO**; **forbid** Re(Z) absorb / Arm A retune / orthogonal bake-in.
