...
| R7 | **Thermal / noise floor** — the entropy sink | fluctuation-dissipation; loops; thermometer | **REFUSED** ✅ (map reading of PR #707 `ADDITIVE-ARTIFACT`: athermal as-built; bounded reversible dephasing; Ax3 line *measured*) — the missing spec page is **F6 ε→T2** | BENCH-∅ | **F6 field-channel build** — priority 1 (docket names DE + thermometer; map extends: loops/ℏ, hygiene, this row) |
