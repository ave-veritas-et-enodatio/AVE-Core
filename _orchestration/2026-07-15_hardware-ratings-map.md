...
| R7 | **Thermal / noise floor** — the entropy sink | sink the thermometer/DE need; peer-label FD/Nyquist only after CHANNEL-BOUNDED | **REFUSED** as-built ✅ (#707) · rung-1 **CHANNEL-BOUNDED** ✅ · rung-2 **BIAS-MOVED** ✅ · Arm A event-gated **BIAS-MOVED** ✅ (bias knife kills; ΔN_occ detector **VOID** — bookkeeping-only, #711 review) · Arm B G0 exterior-leave **BIAS-MOVED** + **WRONG-OBJECT** ✅ (siphon ≠ wall; #714 review) · circuit-first map + **§5b fill PROTOCOL** | BENCH-∅ | next arm only after §5b filled per [`../research/2026-07-16_f6-circuit-map-fill-PROTOCOL.md`](../research/2026-07-16_f6-circuit-map-fill-PROTOCOL.md); no siphon/retune/Re(Z)/fake mint; **detector-rebuild GATE** owed before any CHANNEL-BOUNDED (see §7); thermometer **GATED** |
