...
| R7 | **Thermal / noise floor** — the entropy sink | sink the thermometer/DE need; peer-label FD/Nyquist only after CHANNEL-BOUNDED | **REFUSED** as-built ✅ (#707) · rung-2/A/B **BIAS-MOVED** · Arm B **WRONG-OBJECT** · circuit-first map + **§5b fill PROTOCOL** | BENCH-∅ | next arm only after §5b filled per [`../research/2026-07-16_f6-circuit-map-fill-PROTOCOL.md`](../research/2026-07-16_f6-circuit-map-fill-PROTOCOL.md); no siphon/retune/Re(Z)/fake mint; thermometer **GATED** |
...
1. **F6 ε→T2 irreversible *field* channel** — Priority 1. Rung-2/A/B **BIAS-MOVED**; Arm B **WRONG-OBJECT**. Circuit-first + **§5b fill PROTOCOL**: [`../research/2026-07-16_f6-circuit-map-fill-PROTOCOL.md`](../research/2026-07-16_f6-circuit-map-fill-PROTOCOL.md) (claim\|cite\|observable; entailment knife). Maps: [`../research/2026-07-16_f6-circuit-first-door-map_CHARTER.md`](../research/2026-07-16_f6-circuit-first-door-map_CHARTER.md), [`../research/2026-07-16_f6-frontier-map_CHARTER.md`](../research/2026-07-16_f6-frontier-map_CHARTER.md). **Forbid** Re(Z) / siphon retune / orthogonal bake-in / fake node mint / door-before-table.
