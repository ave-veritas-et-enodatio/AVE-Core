...
| R7 | **Thermal / noise floor** — the entropy sink | sink the thermometer/DE need; peer-label FD/Nyquist only after CHANNEL-BOUNDED | **REFUSED** as-built ✅ (#707) · rung-1 **CHANNEL-BOUNDED** ✅ · rung-2/A/B **BIAS-MOVED** · Arm B also **WRONG-OBJECT** (siphon ≠ wall) · circuit-first door map chartered | BENCH-∅ | next arm only after mode-count **§5b circuit-map gate**; no siphon/retune/Re(Z)/fake mint; thermometer **GATED** |
...
1. **F6 ε→T2 irreversible *field* channel** — Priority 1. Rung-1 ✅; rung-2/A/B **BIAS-MOVED**; Arm B **WRONG-OBJECT** (unsaturated face siphon ≠ saturated-port wall). Circuit-first: [`../research/2026-07-16_f6-circuit-first-door-map_CHARTER.md`](../research/2026-07-16_f6-circuit-first-door-map_CHARTER.md); mode-count **§5b** gate mandatory before any arm. Frontier map: [`../research/2026-07-16_f6-frontier-map_CHARTER.md`](../research/2026-07-16_f6-frontier-map_CHARTER.md). **Forbid** Re(Z) / Arm A·B·C siphon retune / orthogonal bake-in / fake node mint.
