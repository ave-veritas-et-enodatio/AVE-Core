...
**Last updated**: 2026-05-19 EOD+++ — temporal-regime walk-back per external review (Item 1 → PROVISIONAL) + NEW Experimental Arc epic established at [`experimental-arc.md`](experimental-arc.md) owning experimental KB hygiene + execution prioritization + driver readiness + cross-repo coordination + canonical-structure tie-back.
...
| **Experimental Arc** (NEW) | [`experimental-arc.md`](experimental-arc.md) | ACTIVE — established 2026-05-19 EOD+++. Owns experimental KB hygiene + execution prioritization + driver readiness + cross-repo coordination + canonical-structure tie-back. 26 of 36 experimental KB leaves (72%) last touched 2026-04-13 (>1 month stale); 15+ canonical updates landed since (A-034 21→26, FI-13 (2,5), C8 PDG anchor, C1 Phase 5, SPARC 135-galaxy, Class E projection, temporal classifier, +). Phase 1 (surgical walk-back of HIGH-severity leaves like `torus-knot-baryon-predictions.md`) pending. | Epic established this session (no implementor session yet) | (a) Phase 1 surgical walk-back ~30-45 min; (b) Phase 2 execution prioritization ~1-2 hr audit + Grant adjudication; (c) Phase 3 driver readiness audit; (d) Phase 4 cross-repo coordination on-demand; (e) Phase 5 continuous canonical tie-back. EXP-1: A1-HOPF fab Grant decision; EXP-3: B4-PROTEIN RMSD; EXP-4: C2-T-PAIR RHIC scaffold |
