...
**Last updated**: 2026-05-20 — Experimental Arc Phase 2 audit complete; 3 sub-epics spawned per cascade-emphasis ranking (A1-HOPF / C15-CLEAVE-01 / C11-MACH-ZEHNDER); Phase 1 surgical walk-back of 4-5 stale leaves bundled this commit.
...
| ↳ EXP-A1-HOPF (cascade × executability) | [`exp-a1-hopf.md`](exp-a1-hopf.md) | PHASE 0 — Grant fab decision pending. Hardware fab-ready ($123 BOM); HOPF-02a Gerbers + BOM + assembly guide + test procedure all at AVE-HOPF/hardware/. M-severity, U-D 60-400× NEC2 SNR, A1 cascade (C8 + C3 + C10 (2,q) family) | Sub-epic doc established 2026-05-20 | Grant submits to JLCPCB → 2-week fab → assembly → VNA measurement |
