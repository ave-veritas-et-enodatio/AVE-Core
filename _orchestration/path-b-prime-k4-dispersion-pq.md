...
## Open Q's pending Grant adjudication (BEFORE prereg commit)

**Q-PBP-1** (foundational): Does the chiral $I4_132$ space group actually carry the $S^3 \to S^2$ Hopf-bundle structure that the framing requires? If you read this as "no" or "almost certainly no," **the prereg is abandoned without running** and Path B-prime is dead.
