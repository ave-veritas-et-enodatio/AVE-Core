...
| **C15-CLEAVE-01** (femto-Coulomb electrometer) | [`exp-c15-cleave-01.md`](exp-c15-cleave-01.md) + [Framework-readiness audit](exp-c15-cleave-01-sim-audit.md) + [Phase 0 scaffold brief](exp-c15-cleave-01-phase-0-scaffolding.md) + [Q-C15-01 chamber scoping](exp-c15-cleave-01-q-c15-01-chamber-scoping.md) + [Phase 1 KiCad brief](exp-c15-cleave-01-phase-1-kicad-brief.md) + **sibling repo `AVE-Bench-FemtoElectrometer` LIVE on GitHub** | Cascade **SIZE** winner (ξ_topo family 6+ rows) — F-severity; **Phase 0 ✓ COMPLETE** (scaffold + Q-C15-01 dedicated chamber + Q-C15-05 scope narrowed + framework-readiness audit NO DRIFT); **Phase 1 ACTIVE** — Grant promoted Phase 0→1 + GitHub remote live; Phase 1a implementor dispatched (schematic + finalized BOM + reference-design notes + TEST_PROCEDURE update + procurement SKU population) | Phase 1a implementor return → orchestrator review → Phase 1b PCB layout (Grant manual or specialized) → Phase 1c Gerbers + DRC (Grant `kicad-cli`) → Phase 2 fab + assembly |
