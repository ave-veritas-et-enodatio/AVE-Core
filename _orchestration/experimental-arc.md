...
| **C15-CLEAVE-01** (femto-Coulomb electrometer) | [`exp-c15-cleave-01.md`](exp-c15-cleave-01.md) + [Framework-readiness audit](exp-c15-cleave-01-sim-audit.md) + [Phase 0 scaffold brief](exp-c15-cleave-01-phase-0-scaffolding.md) + [Q-C15-01 chamber scoping](exp-c15-cleave-01-q-c15-01-chamber-scoping.md) + **NEW sibling repo `AVE-Bench-FemtoElectrometer`** | Cascade **SIZE** winner (ξ_topo family 6+ rows) — F-severity; **framework-readiness audit ✓ NO DRIFT** + **Phase 0 SCAFFOLD ✓ LANDED** + **Q-C15-01 ✓ RESOLVED dedicated chamber** (Grant adjudicated 2026-05-20 EOD+++++; bell-jar/4''-6'' CF refurb, ≤10⁻⁶ Torr, no HV feedthroughs, ~$4-5k full subsystem-A) | (i) Grant GitHub remote setup `gh repo create ave-veritas-et-enodatio/AVE-Bench-FemtoElectrometer --private`; (ii) Phase 0→1 promotion adjudication (Q-C15-01 ✓ resolved; Phase 1 KiCad design entry now unblocked on theoretical + logistical axes) |
