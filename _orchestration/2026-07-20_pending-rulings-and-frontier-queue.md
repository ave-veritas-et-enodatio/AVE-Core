...
4. **`master-equation.md:20` sector-ownership wording tightening** (Grant-level, routed from #761 result §6.2-2): the canon line's dual phrasing (name + physical content of the ONE A1-breather object) invited the gauge misreading the #761 review had to close at corpus level; a one-sentence tightening prevents re-litigation.
