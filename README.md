...
**Status: awaiting co-author review before submission.** The venue, working model name, and author/affiliation lines are open decisions carried in [`papers/2026_birefringence_letter/provenance.md`](papers/2026_birefringence_letter/provenance.md) (an internal audit trail, not part of the paper).
