...
> 🔴 **CORRECTION (2026-06-20, Rule 12 — preserve body above, scope it below).** The line above OVERCLAIMS "conserves … the energize-LOCK" for the trilinear `H_couple` as written. The **CONTINUUM** cancellation is exact, **BUT the DISCRETE dynamics do not deliver a conserved-AND-transferring lock**: the trilinear potential is INDEFINITE (linear in each of `V, w, ω` ⇒ unbounded below), so its conserve-and-transfer arm (`photon_deplete=True`) **PUMPS / DETONATES** (`H_bel −4107`, graft-v4 §6) and its bounded arm DOES NOT TRANSFER (~2 %, inert). The genuine **conserved-AND-transferring LOCK is the PARTIAL circulator result** ([`2026-06-20_node-circulator-coupling.md`](2026-06-20_node-circulator-coupling.md), PR #321): a **skew-Hermitian 2-port** GENERATOR conserves (norm to `1.1e-12`/40k steps) AND transfers (100 %) — but it is **RECIPROCAL** (forward == reverse, RH == LH; it IS the optical-activity gyrator). Genuine non-reciprocity needs the **3-PORT loop** (EM↔shear↔bulk), and its magnitude is IMPOSED (the chiral-crystal engine averages chirality out, `device-circuit-models.md:163`) — an echo at the magnitude level. So: continuum-exact ✓; trilinear-discrete pump-or-inert; the lock is the skew-circulator PARTIAL (conserve+transfer ✓, reciprocal, magnitude-echo). Grounds: PR #321 + `research/2026-06-20_node-circulator-coupling.md`.  <!-- rule12-freeze: base=efa15dd1a126540161706a205969da71737d917d region=above offset=0 lines=18 bytes=1536 sha256=3e0630abd368b303285aaa9adf8a7768018f1ed2537dd381f03fa5b9c5efc0c4 -->  <!-- rule12-freeze: base=efa15dd1a126540161706a205969da71737d917d region=below offset=0 lines=35 bytes=3380 sha256=22163ecf9e6634ae462814e57ab3104ba1d9d3dd2e4cf3fa6e132aaed03219d8 -->
