> **SURFACE-NOTE — landed 2026-08-19 from tag `archive/analysis/2026-06-15-passive-eigenmode-solve` (Wave-2 **D15a**, `_orchestration/docket-entries/2026-08-18-wave2-adjudication-sitting.md`); FROZEN at tag state, body below unedited. Current adjudicated state: `manuscript/ave-kb/common/program-arc-map.md` ARC-08 = **"NEGATIVE (leans-falsified)"**.**
