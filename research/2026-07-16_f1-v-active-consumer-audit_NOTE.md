...
> **🔴 STALE-CITE REFRESH (2026-07-20, #759 — Rule 12; the genesis-24 row above preserved verbatim).** The genesis-24 row's `V-active (runaway →1e4)` descriptor (echoed at `:120–121` "the runaway/pumped regime (genesis-24, 1e4 V-growth)") is the **superseded `+2`-bug** reading. The current banked receipt (`genesis_24_saturated_seed_results.json`, regenerated 2026-06-21 by the Lenz-sign correction `5a8b16e3`) is the **bounded `−2` C1** — `verdict = C1`, `max_V_inc ≈ 0.37`, no runaway (per `research/2026-07-20_f1-verification-rerun_result.md` §Contradictions C1, merged #759). The materiality classification is unaffected in direction (a bounded C1 is *less* spatially flip-prone than the assumed runaway); only the descriptor is stale. Receipt-refresh of the genesis-24 JSON is a **GRANT CALL**, not actioned here — flag-don't-fix.  <!-- rule12-freeze: base=1a34f1d5cc1c8cb20342dcfdfe96bf6f321ec9e4 region=above offset=0 lines=185 bytes=12514 sha256=5c2005cdaca570c850c7068326856f8542148f96be05495406a0ed588abdebfb -->
