...
9. **CERTIFICATION PLAN:** bins and gates frozen here, before any characterization prose exists beyond H1. **UNRUN ≠ PASSED.** This freeze has **no engine numbers** and **no driver**. Negative control named at §5: a model that places static \(\nabla V\) on Object 3, or identifies Object 1 with Object 2’s capacitor. Positive control: Object 1 and Object 2/3 remain exhibitable as distinct 2-ports (A1 terminals \(\neq\) T2 terminals) from the cited leaves. Object 2 vs Object 3 may share the photon-port line (lumped vs distributed).
...
**Positive control (Step 3.8(a)):** the characterization can point at Object 1 as a distinct 2-port from Object 2/3 in the cited leaves (Object 1 capacitor holds DC; Object 2 TL carries \((V_{\mathrm{inc}},V_{\mathrm{ref}})\); Object 3 is that line’s lumped \(L\), \(V_A=V_B\) at DC) **without identifying Object 1’s terminals with Object 2/3**. Identifying Object 2 with Object 3 as lumped/distributed is **not** a fail. H1 already ran this exhibit; the characterization must **preserve** it.
