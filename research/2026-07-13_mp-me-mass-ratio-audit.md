...
| **A3** | Archive `deba5edb` (2026-02-25): δ_th=1/(28π) INTRODUCED; comment *"proton ratio ≈ 1872 (2% above empirical 1836.15)"* names the residual it closes | `Applied-Vacuum-Engineering` `git show deba5edb` | git forensics |
