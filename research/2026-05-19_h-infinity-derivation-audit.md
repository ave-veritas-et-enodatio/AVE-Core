...
- Predictions registry: [`consistency-manifest.yaml` P23](../manuscript/consistency-manifest.yaml) — P23, type `derived_prediction`, axioms_used `[1, 3, 4]`, headline `"a priori prediction that Hubble tension is a regime artifact"`
...
| [`consistency-manifest.yaml` P23](../manuscript/consistency-manifest.yaml) | **"a priori prediction"** |
...
- 912dd88's edit makes the four chosen files internally consistent ("Geometric consistency"). It does NOT touch [`consistency-manifest.yaml` P23](../manuscript/consistency-manifest.yaml) (P23 still labeled `derived_prediction` with notes claiming "a priori prediction") or [`hubble-tension.md`](../manuscript/ave-kb/vol2/nuclear-field/ch10-open-problems/hubble-tension.md) (Vol 2 Ch 10 still labeled "prediction... not a fit") or the `axioms_used: [1, 3, 4]` field in P23. If 912dd88's framing is correct, these are downstream walk-back surfaces.
