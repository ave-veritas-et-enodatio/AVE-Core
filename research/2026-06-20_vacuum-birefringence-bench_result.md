...
> 🔵 **SUPERSEDED HEADLINE NUMBER (Grant FLAG-A ruling, 2026-06-21, Rule 12 — body below PRESERVED verbatim).**
> This doc's bankable number and the per-row $4.14\times10^6$ in §0 / the table below were computed as
...
> leaf `clm-pp3qwf`. Chord-vs-echo unchanged (CHORD = saturation exists; MAGNITUDE = $\alpha$-echo).
