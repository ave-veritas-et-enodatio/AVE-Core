...
**Honest read:** Geometry explains **why δ_strain is O(α³)** and **why the factor is ~½ not ~1**, but the last **~10%** (or f_b = 0.455 vs 0.500) is still **unclosed**. Promote as **bracket + calibrated input**, not independent chord.
