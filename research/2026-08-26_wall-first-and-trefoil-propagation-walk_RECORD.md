...
- It **does not adjudicate** any of the forks it surfaces: the three-surfaces /
  ...
  rest-energy-channel disagreement (W4-6 — a collision only if §5.3 R-2 resolves
  the two labels onto one object), or the R40-B2a bulk re-derivation debt
  (§1.3, §5.2).
