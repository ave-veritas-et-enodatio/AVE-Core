...
| P3 | **Saturation engaged (Γ→−1 onset)** | `A² = (V_local/V_snap)²` at trap reaches the Op14 onset `√(2α) ≈ 0.1208` (amplitude threshold `A = √(2α)`; equivalently `A² = 2α ≈ 0.0146`) — *0.1208 corrected from 0.117, 2026-07-14 Wall-A hygiene*; ideally the local `c_eff` collapses toward 0 | [`pair-production-axiom-derivation.md`](../manuscript/ave-kb/vol2/particle-physics/ch01-topological-matter/pair-production-axiom-derivation.md) step 6; `√(2α)` is R_I boundary | YES |
