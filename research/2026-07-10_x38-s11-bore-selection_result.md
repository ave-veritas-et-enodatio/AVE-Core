...
4. **Correction-PR candidate (C4/R4):** X37's MERGED Correction-Log C2 names the same now-dead evanescent-stub escape (any lossless+reciprocal+C₃ network obeys the theorem). Surfaced for the orchestrator; NOT edited here.
...
**No leaf edit from this lane.** These are ledger rows + Grant-anchor questions + one correction-PR candidate, surfaced for the auditor.
