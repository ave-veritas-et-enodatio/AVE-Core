...
- **CONSISTENCY-class throughout.** Both negatives are α-free on the verdict path; the channel-impedance-mismatch Q target stays EMPTY (cold-cage Q≈30.8 ≠ 137, `resonant-lc-solitons.md:131`); the negatives do NOT refill that slot.
...
> *(2026-07-22: propagation LANDED in this same PR #793 continuation, commit `bd587ef5` — see `_orchestration/docket-entries/2026-07-22-testnum-propagation-landing.md`; the "routed to auditor lane" routing above is superseded.)*
