...
- **[E-101] Three substrate invariants $\mathcal{M}, \mathcal{Q}, \mathcal{J}$ — engine-side observable computation**
  ...
  - **Status:** queued (new — substrate-observability rule operationalization)
  - **Cross-refs:** E-094 (manuscript-side substrate-vocab discipline), E-095 (Master Equation FDTD engine), E-096 (boundary-envelope reformulation), A-026, A-028
