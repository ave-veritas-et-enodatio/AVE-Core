...
| 17 | `vol_3/chapters/08_gravitational_waves.tex:11` + `:372` | "~28 orders of magnitude below snap" while the same chapter's resultbox at `:363` prints $2\times10^{-25}$ and `:365` says twenty-five. ★ch08 was *passed over*, not gated — its only ringdown commit is a figure regen. |
