...
- **CROSS-LINK (2026-07-02): the k→0 OPEN + the :105 conversion ambiguity are now COUPLED to the Cleave-01 slope.** The Cleave registry-pump adjudication (`research/2026-07-02_cleave-coupling-derivation_adjudication.md`) found the plate-displacement pump slope rides the same lattice g₀ / z-unit↔physical-length convention as this leaf; the dual-reading Chern driver returned **NULL-DERIVED**, and its anchor cross-check surfaced the same bare-pitch-vs-writhe-operator **sign-channel split** as the :105 `2√2`/rad-m ambiguity — **still OPEN** (a real convention ambiguity, not an arithmetic bug; a one-hour check did not settle it). If the k→0 continuum extraction washes g₀ out, the same wash-out plausibly kills the lattice-scale Cleave slope.
