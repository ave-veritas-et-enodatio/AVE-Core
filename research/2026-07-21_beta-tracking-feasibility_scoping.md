...
1. **No mass-energy equivalence.** Node mass uniform and fixed (`v += F·dt`, implicit m=1); trapped elastic energy carries zero inertia → `β_massload ≡ 0` analytically. (The RVE prereg already disclosed: "the cages are stiffness grades, they add NO inertia.")
