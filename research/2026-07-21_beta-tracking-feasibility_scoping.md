...
> **★SCOPE CARVE (2026-07-28, leak-audit fold — Grant [sic]: "fold"; the sentence above is preserved per Rule 12; this dated note supersedes its term-(i) sign claim.)** Per the 2026-07-28 adversarial reproduction (C2, confirmed): a bubble's ρ_eff drop is a **mass-density-contrast** dipole mechanism; this engine's cage grades **stiffness over uniform node mass** (`cage_bond_stiffness` touches `k_a`/`k_s` only), so the density-contrast dipole **vanishes identically** — and the one route that CAN move ρ_eff here (mass-in-mass resonance) trends **UP** below resonance, never down. The "bubble-like DOWN" clause is imported fluid intuition the substrate's constitutive grading cannot host. Term (i) is therefore **≡ 0 at k→0 on this engine** (and a ρ_eff(k→0)=Σm/V mass-conservation identity holds regardless — the 2026-07-26 ρ-scoping §0); the two-term "net sign" competition as stated does not exist on the lattice. The trapped-energy term (ii) is untouched (it was always the tagged E=mc² import, `clm-m5swh9` OPEN).  <!-- rule12-freeze: base=eb1e5a5cc61263b68cd6d6d1f436eab9b177c218 region=above offset=0 lines=36 bytes=4854 sha256=41b02a158511b544644e41a8fd1be4a9acc18a8530b25b770f8d9448c1d27224 -->
