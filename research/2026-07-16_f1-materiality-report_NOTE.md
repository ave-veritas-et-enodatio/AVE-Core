...
> **🔴 STALE-CITE REFRESH (2026-07-20, #759 — Rule 12; the genesis-24 row above preserved verbatim).** The genesis-24 row (`2026-06-09_genesis-24-saturated-seed_result.md`) cites the **superseded `+2`-bug runaway** — `max|V_inc| → 1.08e4`, source-channel-FIRES / VERDICT B, "pumped runaway (converter on → E_V not conserved)". That regime was replaced **2026-06-21** (Lenz-sign correction `5a8b16e3`, 25 days *before* this report) by the **bounded, power-conserving `−2` C1**: `verdict = C1`, `dE_V` all-negative, **`max_V_inc ≈ 0.37`** (not `1.08e4`). The F1 reproduction refire (`research/2026-07-20_f1-verification-rerun_result.md` §Contradictions C1, merged #759) surfaced this and re-ran against the live banked `−2` C1 JSON. **Direction of the error:** the report *over-states* genesis-24's F1 flip-risk — a bounded C1 is the §3b `E_V`-invariant power-conserving regime, i.e.\ LESS spatially flip-prone than the runaway assumed here — so the report's *conclusion* (genesis-24 qualitative verdict robust to F1) is **unharmed**; only the cited receipt is stale. The genesis-24 JSON receipt-refresh itself is a **GRANT CALL** (a receipt-refresh decision), NOT actioned here — flag-don't-fix.  <!-- rule12-freeze: base=1a34f1d5cc1c8cb20342dcfdfe96bf6f321ec9e4 region=above offset=0 lines=29 bytes=3221 sha256=2f6e2f5b76a376a34b3cc30223bcc464e95ea5c898b31a7d848586643335bd10 -->
