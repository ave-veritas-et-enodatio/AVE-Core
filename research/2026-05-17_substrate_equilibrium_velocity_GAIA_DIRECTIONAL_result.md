...
> ★ SURFACE NOTE 2026-08-17 — currentness only, no verdict changed: *"ACTIVE RESEARCH"* has had **no content-bearing commit since 2026-05-17**. This file's entire history is two infrastructure commits — `e753e40b` (2026-05-21, L3 file migration) and `131bba89` (2026-05-24, output-directory path unification); no line of physics has moved. Separately, the promotion path the demotion note below names (*"extra-galactic test (globular clusters / halo stars …)"*) **was run and did not confirm**: `research/2026-05-17_substrate_equilibrium_velocity_GLOBULAR_CLUSTER_result.md:3` — *"GC median |v_CMB| = 563.88 km/s … substrate-velocity prediction at αc/(2π) = 348 km/s **does NOT extend to GC-class populations**. Walk-back required: substrate-velocity prediction narrows to LSR-class-only scope."* Body unchanged (Rule 12) — flagged by the 2026-08-17 repo-cleanup census, Wave 1.
