...
| **G-NUM** | two runs byte-identical; number-check green; mutation receipt fires; `make verify` green | sha256 `de439794…` ×2; 24 checks green; mutation fires (`f_chain` detector); verify at commit | **PASS** |
