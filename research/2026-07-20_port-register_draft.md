...
> **✅ PROMOTED 2026-07-20 (KEEP-BOTH; this draft preserved).** Promoted to the canonical KB leaf [`manuscript/ave-kb/common/port-register.md`](../manuscript/ave-kb/common/port-register.md) under the Grant canon-promotion gate (*"lets do it"* `[sic]`; branch `docs/port-register-promotion`, docket ENTRY 33). The canonical leaf carries the **current-main currency** (re-verified against origin/main `1003661c` = #751 merge): **#751 has since MERGED**, so the leaf's **P6 + P8** rows are now `[canon]` (this draft still tags them `[branch:#751]`), and the leaf carries the merged **P8 RE-BANK** (bin (iii) DEGENERATE — the "70–95% / 0–10% unambiguous scope-split" wording in §2 P8 below was the branch state and is superseded by the merged #751 result). **Q1 (#750) remains OPEN / `[canon, #750 merged 2026-07-20]`.** For the current canonical state, read the leaf; this draft is the frozen provenance record.
