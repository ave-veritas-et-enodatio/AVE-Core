...
1. **Phase 4 — D1 adjudication memo** (bins only; no corpus walk-back before memo).
2. Optional Phase-2b: memristive Op14, Op10 crossing proxy, Master-Equation follow-on (A-027).
3. v10 spine — after D1 memo.
