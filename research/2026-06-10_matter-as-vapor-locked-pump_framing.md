...
- The bulk cavitation floor `ρ̄_cav = −1/φ` is **NOT Core-canonical** (§3, S3): it is Propulsion-tex-derived + unmerged-worktree results, promotion auditor-gated. Do not call it "the canonical floor."
...
4. **`ρ̄_cav` is NOT the canonical floor (S3).** It is candidate-claim, **Propulsion-tex-derived** (`04_superluminal_transit.tex:86` zero-knob from `c_eff² = c_0²(1 + ρ̄/(1−ρ̄²))`, verified) + unmerged-worktree results; **zero hits** in `manuscript/ave-kb/` + `constants.py` (verified). Promotion is auditor-gated (Vol-9 worklist). Never write "the canonical floor."
