...
- **ROUTED TO GRANT:** the framing flag (rotation-wording vs canonical load-response, `-derivation.md` §9 Flag 1); the forward discriminator (§4) as the real reactive-vs-memristive test; **[🔴 R-4] the executed FLAG (§3 item 2): the frozen Resonant chirality-flip sub-criterion measured FALSE — ratify replacing it with the 180° phase-inversion criterion, or direct a re-run.**
