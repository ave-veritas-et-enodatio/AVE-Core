...
> ⚠️ **SUPERSEDED BY [doc 77_](77_lattice_to_axiom4_bridge.md) — 2026-04-27.** This doc's framing is built on **Scheme B** of the corpus axiom numbering (per [`manuscript/ave-kb/common/axiom-homologation.md`](../../manuscript/ave-kb/common/axiom-homologation.md), `eq_axiom_3.tex`'s pre-supersession "Axiom 3 — Gravity"). Per cross-repo audit (520 axiom occurrences across 9 repos, 469 in Scheme A), **Scheme A is canonical**: Ax 3 = Effective Action Principle ($\mathcal{L}_{node}$), NOT Gravity. The gravitational refractive index $n(r)$ and $c_{eff} = c_0\sqrt{S}$ relations are **derived consequences** of Ax 1 (LC network) + Ax 4 (saturation kernel) under symmetric $\mu/\varepsilon$ scaling — they are not primitive Ax 3 content. This doc therefore mis-numbers the bridge: the substrate-level statement is "lattice Op14 IS the substrate realization of **Ax 4** (per Vol 3 Ch 3 + Vol 3 Ch 20 derivation chain)," not "Ax 3 + Ax 4."
>
> **For canonical Scheme A reframe of this doc's substantive content, see [doc 77_](77_lattice_to_axiom4_bridge.md).** Doc 77_ preserves the empirical reinterpretations (Move 5/7/10/11 Ax 4 readings, Diag A engine partial-realization, R7+R8 universal Mode III as expected behavior, E-072 observer gap, R_phase ≠ R_real per doc 28_) under correct axiom attribution; closes [doc 10_ §8 open item (a)](10_chirality_accounting_narrative.md) on chirality-from-strain via standard chiral-EM EE-translation; and introduces the SU(2)→SO(3) half-cover identification for substrate-vs-observable frequency scaling.
>
> **This doc 76_ is preserved per [Rule 12 retraction-preserves-body](../../.agents/handoffs/COLLABORATION_NOTES.md) discipline as audit trail.** Body content below remains accessible for future agents but is NOT authoritative for Scheme A framing. Do not cite doc 76_ for new work; cite doc 77_.

---

## ORIGINAL DOC 76_ BODY (preserved per Rule 12 — Scheme B framing throughout)
